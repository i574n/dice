...
and method6 () : std_pin_Pin<Box<Dyn<std_future_Future<rexie_Rexie>>>> =
    let v0 : string = "true; let __result = Box::pin(async move { //"
    ...
    let v8 : string = "true; let __result = Box::pin(async { //"
    let v9 : bool = Fable.Core.RustInterop.emitRustExpr () v8 
    let v10 : string = "Box::pin(rexie::Rexie::builder(\"database\").version(1).add_object_store(rexie::ObjectStore::new(\"store\")).build())"
    let v11 : std_pin_Pin<Box<Dyn<std_future_Future<Result<rexie_Rexie, rexie_Error>>>>> = Fable.Core.RustInterop.emitRustExpr () v10 
    let v12 : string = "v11.await"
    let v13 : Result<rexie_Rexie, rexie_Error> = Fable.Core.RustInterop.emitRustExpr () v12 
    let v14 : (rexie_Rexie -> US3) = closure8()
    let v15 : (rexie_Error -> US3) = closure9()
    let v16 : US3 = match v13 with Ok x -> v14 x | Error x -> v15 x
    let v17 : US3 = method7(v16)
    let v18 : string = ""
    let v19 : string = "}"
    let v20 : string = v18 + v19 
    let v21 : string = "true; v17 " + v20 + "); " + v18 + " // rust.fix_closure'"
    let v22 : bool = Fable.Core.RustInterop.emitRustExpr () v21 
    let v23 : string = "__result"
    let v24 : _ = Fable.Core.RustInterop.emitRustExpr () v23 
    let v25 : string = "v24"
    let v26 : std_pin_Pin<Box<Dyn<std_future_Future<US3>>>> = Fable.Core.RustInterop.emitRustExpr () v25 
    let v27 : string = "v26.await"
    let v28 : US3 = Fable.Core.RustInterop.emitRustExpr () v27 
    let v34 : rexie_Rexie =
        match v28 with
        | US3_1(v30) -> (* Error *)
            let v31 : string = $"resultm.get / Result value was Error: {v30}"
            failwith<rexie_Rexie> v31
        | US3_0(v29) -> (* Ok *)
            v29
    let v35 : string = $"%A{v34}"
    let v38 : string = "state_core.use_database (3) / database create_local_resource / result: " + string v35 + ""
    let v39 : int64 = 200L
    ...
    let v43 : rexie_Rexie = method9(v34)
    let v44 : string = v18 + v19 
    let v45 : string = "true; v43 " + v44 + "); " + v18 + " // rust.fix_closure'"
    let v46 : bool = Fable.Core.RustInterop.emitRustExpr () v45 
    let v47 : string = "__result"
    let v48 : _ = Fable.Core.RustInterop.emitRustExpr () v47 
    let v49 : string = "v48"
    let v50 : std_pin_Pin<Box<Dyn<std_future_Future<rexie_Rexie>>>> = Fable.Core.RustInterop.emitRustExpr () v49 
    v50
...
and method5 () : leptos_Resource<US2, rexie_Rexie> =
    ...
    let v14 : string = "true; v7 " + v11 + "); " + v13 + " // rust.fix_closure'"
    let v15 : bool = Fable.Core.RustInterop.emitRustExpr () v14 
    let v16 : string = "__result"
    let v17 : leptos_Resource<US2, rexie_Rexie> = Fable.Core.RustInterop.emitRustExpr () v16 
    v17
and closure10 (v0 : leptos_Resource<US2, rexie_Rexie>) () : rexie_Rexie option =
    ...
    v2
and closure11 (v0 : US5 option ref) (v1 : US5 option) : US5 option ref =
    v0.Value <- v1 
    v0
and closure12 (v0 : rexie_Rexie option, v1 : (US5 option -> US5 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : rexie_Rexie = x
    let v3 : US5 = US5_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
...
and method22 () : (serde_wasm_bindgen_Error -> std_string_String) =
    closure17()
and closure18 (v0 : US7 option ref) (v1 : US7 option) : US7 option ref =
    v0.Value <- v1 
    v0
and closure19 (v0 : serde_json_Value option, v1 : (US7 option -> US7 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and method23 (v0 : serde_json_Value) : serde_json_Value =
    v0
and closure20 () (v0 : serde_json_Error) : std_string_String =
    let v1 : unit = ()
...
and method24 () : (serde_json_Error -> std_string_String) =
    closure20()
and closure21 () (v0 : borsh_io_Error) : std_string_String =
    let v1 : unit = ()
...
and method14 (v0 : string, v1 : rexie_Rexie) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap3 option option, std_string_String>>>>> =
    ...
    let v3 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v4 : bool = Fable.Core.RustInterop.emitRustExpr v2 v3 
    let v5 : string = "true; let __result = Box::pin(async { //"
    let v6 : bool = Fable.Core.RustInterop.emitRustExpr () v5 
    let v7 : string = "store"
    let v8 : (string []) = [|v7|]
    let v9 : string = "$0.to_vec()"
    let v10 : Vec<string> = Fable.Core.RustInterop.emitRustExpr v8 v9 
    let v11 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v12 : (string -> std_string_String) = closure13()
    let v13 : Vec<std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v10, v12) v11 
    let v14 : rexie_Rexie = method15(v1)
    ...
    let v17 : (rexie_Error -> std_string_String) = method16()
    let v18 : string = "$0.map_err(|x| $1(x))"
    let v19 : Result<rexie_Transaction, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v16, v17) v18 
    let v20 : string = "$0?"
    let v21 : rexie_Transaction = Fable.Core.RustInterop.emitRustExpr v19 v20 
    let v22 : string = method17()
    let v23 : string = "&*$0"
    let v24 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v22 v23 
    let v25 : string = "v21.store(v24)"
    let v26 : Result<rexie_Store, rexie_Error> = Fable.Core.RustInterop.emitRustExpr () v25 
    let v27 : (rexie_Error -> std_string_String) = method18()
    let v28 : string = "$0.map_err(|x| $1(x))"
    let v29 : Result<rexie_Store, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v26, v27) v28 
    let v30 : string = "$0?"
    let v31 : rexie_Store = Fable.Core.RustInterop.emitRustExpr v29 v30 
    let v32 : string = method19(v0)
    let v33 : string = "&*$0"
    let v34 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v32 v33 
    let v35 : string = "wasm_bindgen::JsValue::from_str(v34)"
    let v36 : wasm_bindgen_JsValue = Fable.Core.RustInterop.emitRustExpr () v35 
    let v37 : string = $"Box::pin(rexie::Store::get(&v31, &v36))"
    let v38 : std_pin_Pin<Box<Dyn<std_future_Future<Result<wasm_bindgen_JsValue, rexie_Error>>>>> = Fable.Core.RustInterop.emitRustExpr () v37 
    let v39 : string = "v38.await"
    let v40 : Result<wasm_bindgen_JsValue, rexie_Error> = Fable.Core.RustInterop.emitRustExpr () v39 
    let v41 : (rexie_Error -> std_string_String) = method20()
    let v42 : string = "$0.map_err(|x| $1(x))"
    let v43 : Result<wasm_bindgen_JsValue, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v40, v41) v42 
    let v44 : string = "$0?"
    let v45 : wasm_bindgen_JsValue = Fable.Core.RustInterop.emitRustExpr v43 v44 
    let v46 : wasm_bindgen_JsValue = method21(v45)
    let v47 : string = "serde_wasm_bindgen::from_value(v46)"
    let v48 : Result<serde_json_Value option, serde_wasm_bindgen_Error> = Fable.Core.RustInterop.emitRustExpr () v47 
    let v49 : (serde_wasm_bindgen_Error -> std_string_String) = method22()
    let v50 : string = "$0.map_err(|x| $1(x))"
    let v51 : Result<serde_json_Value option, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v48, v49) v50 
    let v52 : string = "$0?"
    let v53 : serde_json_Value option = Fable.Core.RustInterop.emitRustExpr v51 v52 
    let v54 : US7 option = None
    let _v54 = ref v54 
    let v55 : US7 option ref = _v54 
    let v56 : (US7 option -> US7 option ref) = closure18(v55)
    let v57 : unit = ()
    let v58 : (unit -> unit) = closure19(v53, v56)
    let v59 : unit = (fun () -> v58 (); v57) ()
    let v62 : US7 option = _v54.Value 
    let v73 : US7 = US7_1
    ...
    let v109 : US6 =
        ...
        | US7_1 -> (* None *)
            US6_1
        | US7_0(v78) -> (* Some *)
            let v79 : serde_json_Value = method23(v78)
            let v80 : string = "serde_json::from_value(v79)"
            let v81 : Result<Vec<uint8>, serde_json_Error> = Fable.Core.RustInterop.emitRustExpr () v80 
            let v82 : (serde_json_Error -> std_string_String) = method24()
            let v83 : string = "$0.map_err(|x| $1(x))"
            let v84 : Result<Vec<uint8>, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v81, v82) v83 
            let v85 : string = "$0?"
            let v86 : Vec<uint8> = Fable.Core.RustInterop.emitRustExpr v84 v85 
            let v87 : string = "fable_library_rust::NativeArray_::array_from($0)"
            let v88 : (uint8 []) = Fable.Core.RustInterop.emitRustExpr v86 v87 
            let v89 : int32 = v88.Length
            let v90 : string = "state_core.get_data () / data_len: " + string v89 + ""
            let v91 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
            let v92 : bool = Fable.Core.RustInterop.emitRustExpr v90 v91 
            let v93 : string = "$0.to_vec()"
            let v94 : Vec<uint8> = Fable.Core.RustInterop.emitRustExpr v88 v93 
            let v95 : string = "v94.as_slice()"
            let v96 : Ref<Slice<uint8>> = Fable.Core.RustInterop.emitRustExpr () v95 
            let v97 : string = "true; let mut v96 = v96"
            let v98 : bool = Fable.Core.RustInterop.emitRustExpr () v97 
            let v99 : string = "borsh::BorshDeserialize::deserialize(&mut v96)"
            let v100 : Result<Heap3 option, borsh_io_Error> = Fable.Core.RustInterop.emitRustExpr () v99 
            let v101 : (borsh_io_Error -> std_string_String) = method25()
            let v102 : string = "$0.map_err(|x| $1(x))"
            let v103 : Result<Heap3 option, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v100, v101) v102 
            let v104 : string = "$0?"
            let v105 : Heap3 option = Fable.Core.RustInterop.emitRustExpr v103 v104 
            US6_0(v105)
    let v116 : Heap3 option option =
        match v109 with
        | US6_1 -> (* None *)
            let v114 : Heap3 option option = None
            v114
        | US6_0(v110) -> (* Some *)
            let v111 : Heap3 option option = Some v110 
            v111
    let v117 : Result<Heap3 option option, std_string_String> = Ok v116 
    let v118 : Result<Heap3 option option, std_string_String> = method26(v117)
    let v119 : string = ""
    let v120 : string = "}"
    let v121 : string = v119 + v120 
    let v122 : string = "true; v118 " + v121 + "); " + v119 + " // rust.fix_closure'"
    let v123 : bool = Fable.Core.RustInterop.emitRustExpr () v122 
    let v124 : string = "__result"
    let v125 : _ = Fable.Core.RustInterop.emitRustExpr () v124 
    let v126 : string = "v125"
    let v127 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap3 option option, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v126 
    v127
and method13 (v0 : string, v1 : rexie_Rexie) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap3 option option, std_string_String>>>>> =
    method14(v0, v1)
and closure22 () (v0 : Heap3 option option) : US8 =
    US8_0(v0)
and closure23 () (v0 : std_string_String) : US8 =
    US8_1(v0)
and closure24 (v0 : US6 option ref) (v1 : US6 option) : US6 option ref =
    v0.Value <- v1 
    v0
and closure25 (v0 : Heap3 option option, v1 : (US6 option -> US6 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    |> v1 |> ignore
    ()
and closure26 (v0 : US4 option ref) (v1 : US4 option) : US4 option ref =
    v0.Value <- v1 
    v0
and closure27 (v0 : Heap3 option, v1 : (US4 option -> US4 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and method12 (v0 : rexie_Rexie option) : std_pin_Pin<Box<Dyn<std_future_Future<US4>>>> =
    ...
    let v3 : string = $"%A{v0}"
    let v6 : string = "state_core.use_core_database (2) / core_state_heap create_local_resource / database: " + v3 + ""
    let v7 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v8 : bool = Fable.Core.RustInterop.emitRustExpr v6 v7 
    let v9 : US5 option = None
    let _v9 = ref v9 
    let v10 : US5 option ref = _v9 
    let v11 : (US5 option -> US5 option ref) = closure11(v10)
    let v12 : unit = ()
    let v13 : (unit -> unit) = closure12(v0, v11)
    let v14 : unit = (fun () -> v13 (); v12) ()
    let v17 : US5 option = _v9.Value 
    let v28 : US5 = US5_1
    let v29 : US5 = v17 |> Option.defaultValue v28 
    let v75 : US6 =
        match v29 with
        | US5_1 -> (* None *)
            US6_1
        | US5_0(v33) -> (* Some *)
            let v34 : string = "core-state-heap"
            let v35 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap3 option option, std_string_String>>>>> = method13(v34, v33)
            let v36 : string = "v35.await"
            let v37 : Result<Heap3 option option, std_string_String> = Fable.Core.RustInterop.emitRustExpr () v36 
            let v38 : (Heap3 option option -> US8) = closure22()
            let v39 : (std_string_String -> US8) = closure23()
            let v40 : US8 = match v37 with Ok x -> v38 x | Error x -> v39 x
            match v40 with
            | US8_1(v66) -> (* Error *)
                let v67 : string = "state_core.use_core_database (3) / error: " + string v66 + ""
                let v68 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
                let v69 : bool = Fable.Core.RustInterop.emitRustExpr v67 v68 
                US6_1
            | US8_0(v41) -> (* Ok *)
                let v42 : US6 option = None
                let _v42 = ref v42 
                let v43 : US6 option ref = _v42 
                let v44 : (US6 option -> US6 option ref) = closure24(v43)
                let v45 : unit = ()
                let v46 : (unit -> unit) = closure25(v41, v44)
                let v47 : unit = (fun () -> v46 (); v45) ()
                let v50 : US6 option = _v42.Value 
                let v61 : US6 = US6_1
                let v62 : US6 = v50 |> Option.defaultValue v61 
                v62
    let v104 : US9 =
        match v75 with
        | US6_1 -> (* None *)
            US9_1
        | US6_0(v76) -> (* Some *)
            let v77 : US4 option = None
            let _v77 = ref v77 
            let v78 : US4 option ref = _v77 
            let v79 : (US4 option -> US4 option ref) = closure26(v78)
            let v80 : unit = ()
            let v81 : (unit -> unit) = closure27(v76, v79)
            let v82 : unit = (fun () -> v81 (); v80) ()
            let v85 : US4 option = _v77.Value 
            let v96 : US4 = US4_1
            let v97 : US4 = v85 |> Option.defaultValue v96 
            US9_0(v97)
    let v111 : US4 =
        match v104 with
        | US9_0(v105) -> (* Some *)
        ...
        | _ ->
            US4_1
    let v112 : US4 = method27(v111)
    let v113 : string = ""
    let v114 : string = "}"
    let v115 : string = v113 + v114 
    let v116 : string = "true; v112 " + v115 + "); " + v113 + " // rust.fix_closure'"
    let v117 : bool = Fable.Core.RustInterop.emitRustExpr () v116 
    let v118 : string = "__result"
    let v119 : _ = Fable.Core.RustInterop.emitRustExpr () v118 
    let v120 : string = "v119"
    let v121 : std_pin_Pin<Box<Dyn<std_future_Future<US4>>>> = Fable.Core.RustInterop.emitRustExpr () v120 
    v121
...
and method11 (v0 : leptos_Resource<US2, rexie_Rexie>) : leptos_Resource<rexie_Rexie option, US4> =
    ...
    let v2 : (unit -> rexie_Rexie option) = closure10(v0)
    ...
    let v15 : string = "true; v8 " + v12 + "); " + v14 + " // rust.fix_closure'"
    let v16 : bool = Fable.Core.RustInterop.emitRustExpr () v15 
    let v17 : string = "__result"
    let v18 : leptos_Resource<rexie_Rexie option, US4> = Fable.Core.RustInterop.emitRustExpr () v17 
    v18
...
and method30 (v0 : web_sys_Window) : Result<web_sys_Storage option, wasm_bindgen_JsValue> =
    ...
    v2
and closure29 () (v0 : web_sys_Storage option) : US10 =
    US10_0(v0)
and closure30 () (v0 : wasm_bindgen_JsValue) : US10 =
    US10_1(v0)
and closure31 (v0 : US12 option ref) (v1 : US12 option) : US12 option ref =
    v0.Value <- v1 
    v0
and closure32 (v0 : web_sys_Storage option, v1 : (US12 option -> US12 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    |> v1 |> ignore
    ()
and closure33 (v0 : US9 option ref) (v1 : US9 option) : US9 option ref =
    v0.Value <- v1 
    v0
and closure34 (v0 : US4 option, v1 : (US9 option -> US9 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and method32 () : string =
    ...
    v0
and closure35 () (v0 : std_string_String option) : US13 =
    US13_0(v0)
and closure36 () (v0 : wasm_bindgen_JsValue) : US13 =
    US13_1(v0)
and method33 (v0 : std_string_String option) : std_string_String option =
    v0
and closure37 (v0 : US15 option ref) (v1 : US15 option) : US15 option ref =
    v0.Value <- v1 
    v0
and closure38 (v0 : std_string_String option, v1 : (US15 option -> US15 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and method34 (v0 : string) : string =
    v0
and closure40 () (v0 : serde_json_Error) : std_string_String =
    let v1 : unit = ()
...
and method35 () : (serde_json_Error -> std_string_String) =
    closure40()
and closure39 (v0 : std_string_String option, v1 : (US4 option -> US4 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    let v10 : (serde_json_Error -> std_string_String) = method35()
    ...
    let v15 : US4 option = None
    let _v15 = ref v15 
    let v16 : US4 option ref = _v15 
    let v17 : (US4 option -> US4 option ref) = closure26(v16)
    let v18 : unit = ()
    let v19 : (unit -> unit) = closure27(v14, v17)
    let v20 : unit = (fun () -> v19 (); v18) ()
    let v23 : US4 option = _v15.Value 
    let v34 : US4 = US4_1
    let v35 : US4 = v23 |> Option.defaultValue v34 
    v35 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
...
and closure41 (v0 : Heap2, v1 : Heap3) () : unit =
    ...
    let v13 : (bool -> bool) = closure43(v1)
    ...
    let v19 : (std_string_String -> std_string_String) = closure44(v1)
    ...
    let v25 : (Heap0 -> Heap0) = closure45(v1)
    let v26 : bool = Fable.Core.RustInterop.emitRustExpr struct (v23, v25) v24 
    ()
and closure28 (v0 : Heap2, v1 : leptos_Resource<rexie_Rexie option, US4>) () : unit =
    ...
    let v7 : (web_sys_Storage option -> US10) = closure29()
    let v8 : (wasm_bindgen_JsValue -> US10) = closure30()
    ...
    let v39 : US11 =
        ...
        | US10_0(v10) -> (* Ok *)
            ...
            let v13 : (US12 option -> US12 option ref) = closure31(v12)
            let v14 : unit = ()
            let v15 : (unit -> unit) = closure32(v10, v13)
    ...
    | US11_0(v40) -> (* Ok *)
        ...
        | US12_0(v41) -> (* Some *)
            ...
            let v43 : US4 option = Fable.Core.RustInterop.emitRustExpr v1 v42 
            let v44 : US9 option = None
            let _v44 = ref v44 
            let v45 : US9 option ref = _v44 
            let v46 : (US9 option -> US9 option ref) = closure33(v45)
            let v47 : unit = ()
            let v48 : (unit -> unit) = closure34(v43, v46)
            ...
            let v442 : US4 =
                ...
                | US9_0(v74) -> (* Some *)
                    ...
                    | US4_0(v75) -> (* Some *)
                        US4_0(v75)
                    | _ ->
                        let v77 : web_sys_Storage = method31(v41)
                        let v78 : string = method32()
                        let v79 : string = "&*$0"
                        ...
                        let v83 : (std_string_String option -> US13) = closure35()
                        let v84 : (wasm_bindgen_JsValue -> US13) = closure36()
                        ...
                        let v118 : US14 =
                            ...
                            | US13_1(v115) -> (* Error *)
                                US14_1(v115)
                            | US13_0(v86) -> (* Ok *)
                                let v87 : std_string_String option = method33(v86)
                                ...
                                let v92 : (US15 option -> US15 option ref) = closure37(v91)
                                let v93 : unit = ()
                                let v94 : (unit -> unit) = closure38(v89, v92)
                        ...
                        let v138 : std_string_String option =
                            ...
                            | US15_0(v132) -> (* Some *)
                                ...
                                v133
                        let v139 : US4 option = None
                        let _v139 = ref v139 
                        let v140 : US4 option ref = _v139 
                        let v141 : (US4 option -> US4 option ref) = closure26(v140)
                        let v142 : unit = ()
                        let v143 : (unit -> unit) = closure39(v138, v141)
                        let v144 : unit = (fun () -> v143 (); v142) ()
                        let v182 : US4 option = _v139.Value 
                        let v228 : US9 option = None
                        let _v228 = ref v228 
                        let v229 : US9 option ref = _v228 
                        let v230 : (US9 option -> US9 option ref) = closure33(v229)
                        let v231 : unit = ()
                        let v232 : (unit -> unit) = closure34(v182, v230)
                        ...
                        | _ ->
                            US4_1
                | _ ->
                    let v260 : web_sys_Storage = method31(v41)
                    let v261 : string = method32()
                    let v262 : string = "&*$0"
                    ...
                    let v266 : (std_string_String option -> US13) = closure35()
                    let v267 : (wasm_bindgen_JsValue -> US13) = closure36()
                    ...
                    let v301 : US14 =
                        ...
                        | US13_1(v298) -> (* Error *)
                            US14_1(v298)
                        | US13_0(v269) -> (* Ok *)
                            let v270 : std_string_String option = method33(v269)
                            ...
                            let v275 : (US15 option -> US15 option ref) = closure37(v274)
                            let v276 : unit = ()
                            let v277 : (unit -> unit) = closure38(v272, v275)
                    ...
                    let v321 : std_string_String option =
                        ...
                        | US15_0(v315) -> (* Some *)
                            ...
                            v316
                    let v322 : US4 option = None
                    let _v322 = ref v322 
                    let v323 : US4 option ref = _v322 
                    let v324 : (US4 option -> US4 option ref) = closure26(v323)
                    let v325 : unit = ()
                    let v326 : (unit -> unit) = closure39(v321, v324)
                    let v327 : unit = (fun () -> v326 (); v325) ()
                    let v365 : US4 option = _v322.Value 
                    let v411 : US9 option = None
                    let _v411 = ref v411 
                    let v412 : US9 option ref = _v411 
                    let v413 : (US9 option -> US9 option ref) = closure33(v412)
                    let v414 : unit = ()
                    let v415 : (unit -> unit) = closure34(v365, v413)
            ...
            | US4_0(v449) -> (* Some *)
                ...
                let v451 : (unit -> unit) = closure41(v0, v449)
    ...
    | _ ->
        ()
and closure46 (v0 : Heap2) () : std_collections_HashMap<std_string_String, leptos_RwSignal<bool>> =
...
and closure48 () () : US17 =
    US17_0
and closure49 () (v0 : rexie_Error) : US17 =
    US17_1(v0)
and method38 () : unit =
    ()
and closure47 (v0 : leptos_Resource<US2, rexie_Rexie>) (v1 : Heap3) : std_pin_Pin<Box<Dyn<std_future_Future<unit>>>> =
    let v2 : string = $"%A{v1}"
    let v5 : string = $"leptos::SignalGet::get(&$0)"
    let v6 : rexie_Rexie option = Fable.Core.RustInterop.emitRustExpr v0 v5 
    let v7 : US5 option = None
    let _v7 = ref v7 
    let v8 : US5 option ref = _v7 
    let v9 : (US5 option -> US5 option ref) = closure11(v8)
    let v10 : unit = ()
    let v11 : (unit -> unit) = closure12(v6, v9)
    let v12 : unit = (fun () -> v11 (); v10) ()
    let v15 : US5 option = _v7.Value 
    let v26 : US5 = US5_1
    let v27 : US5 = v15 |> Option.defaultValue v26 
    let v31 : string = "true; let __result = Box::pin(async move { //"
    let v32 : bool = Fable.Core.RustInterop.emitRustExpr () v31 
    match v27 with
    | US5_1 -> (* None *)
        let v83 : string = "state_core.use_core_database (13) / set_core_state_heap_action / database=None"
    ...
    | US5_0(v33) -> (* Some *)
        ...
        let v44 : string = "true; let __result = Box::pin(async move { //"
        ...
        let v66 : Result<unit, rexie_Error> = method37(v65)
        let v67 : string = ""
        let v68 : string = "}"
        ...
        let v78 : (unit -> US17) = closure48()
        let v79 : (rexie_Error -> US17) = closure49()
        let v80 : US17 = match v77 with Ok () -> v78 () | Error x -> v79 x
        match v80 with
        | US17_1(v81) -> (* Error *)
            let v82 : string = $"resultm.get / Result value was Error: {v81}"
            failwith<unit> v82
        | US17_0 -> (* Ok *)
            ()
    method38()
    ...
    let v90 : string = "{"
    let v91 : string = v86 + v90 
    let v92 : string = "true; () " + v89 + "); " + v91 + " // rust.fix_closure'"
    let v93 : bool = Fable.Core.RustInterop.emitRustExpr () v92 
    let v94 : string = "__result"
    let v95 : _ = Fable.Core.RustInterop.emitRustExpr () v94 
    let v96 : string = "v95"
    let v97 : std_pin_Pin<Box<Dyn<std_future_Future<unit>>>> = Fable.Core.RustInterop.emitRustExpr () v96 
    v97
and method39 (v0 : std_string_String) : std_string_String =
    v0
and closure51 (v0 : US18 option ref) (v1 : US18 option) : US18 option ref =
    v0.Value <- v1 
    v0
and closure52 (v0 : leptos_RwSignal<bool> option, v1 : (US18 option -> US18 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : leptos_RwSignal<bool> = x
    let v3 : US18 = US18_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
...
and closure50 (v0 : Heap2, v1 : leptos_Memo<std_collections_HashMap<std_string_String, leptos_RwSignal<bool>>>, v2 : leptos_WriteSignal<bool>, v3 : leptos_ReadSignal<bool>, v4 : leptos_Action<Heap3, unit>) () : unit =
    ...
    let v45 : std_string_String = method39(v44)
    ...
    let v48 : US18 option = None
    let _v48 = ref v48 
    let v49 : US18 option ref = _v48 
    let v50 : (US18 option -> US18 option ref) = closure51(v49)
    let v51 : unit = ()
    let v52 : (unit -> unit) = closure52(v47, v50)
    let v53 : unit = (fun () -> v52 (); v51) ()
    let v56 : US18 option = _v48.Value 
    let v67 : US18 = US18_1
    let v68 : US18 = v56 |> Option.defaultValue v67 
    let v78 : US19 =
        match v68 with
        | US18_1 -> (* None *)
            US19_1
    ...
    if v85 then
        ...
        if v86 then
            ...
            let v91 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
            let v92 : bool = Fable.Core.RustInterop.emitRustExpr v90 v91 
            let v93 : web_sys_Window = method29()
            let v94 : Result<web_sys_Storage option, wasm_bindgen_JsValue> = method30(v93)
            let v95 : (web_sys_Storage option -> US10) = closure29()
            let v96 : (wasm_bindgen_JsValue -> US10) = closure30()
            ...
            let v127 : US11 =
                ...
                | US10_0(v98) -> (* Ok *)
                    ...
                    let v101 : (US12 option -> US12 option ref) = closure31(v100)
                    let v102 : unit = ()
                    let v103 : (unit -> unit) = closure32(v98, v101)
            ...
            | US11_0(v128) -> (* Ok *)
                ...
                | US12_0(v129) -> (* Some *)
                    ...
                    let v132 : web_sys_Storage = method40(v129)
                    let v133 : string = method41()
                    let v134 : string = "&*$0"
                    let v135 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v133 v134 
                    let v136 : Heap3 = method42(v31)
...
and method46 (v0 : std_string_String) : std_string_String =
    v0
and closure59 () (v0 : leptos_router_Url) : US22 =
    US22_0(v0)
and closure60 () (v0 : std_string_String) : US22 =
    US22_1(v0)
and method47 (v0 : int32, v1 : Mut0) : bool =
    let v2 : int32 = v1.l0
    let v3 : bool = v2 < v0
    v3
and closure58 (v0 : leptos_router_Location, v1 : leptos_WriteSignal<US20>) () : unit =
    ...
    let v16 : (leptos_router_Url -> US22) = closure59()
    let v17 : (std_string_String -> US22) = closure60()
    ...
    | US22_0(v49) -> (* Ok *)
        ...
        let v94 : std_string_String = Fable.Core.RustInterop.emitRustExpr v91 v93 
        ...
        let v98 : std_string_String = Fable.Core.RustInterop.emitRustExpr v91 v97 
        ...
        let v102 : std_string_String = Fable.Core.RustInterop.emitRustExpr v91 v101 
        ...
        #endif
#if FABLE_COMPILER_PYTHON
        let v108 : string = $"%A{v91}"
        let _v92 = v108 
        #endif
#else
        let v111 : string = $"%A{v91}"
        let _v92 = v111 
        #endif
        let v114 : string = _v92 
        let v119 : string = "content.render () / effect 2 / new_tab: " + v114 + ""
        let v120 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
        let v121 : bool = Fable.Core.RustInterop.emitRustExpr v119 v120 
        let v122 : string = $"true; leptos::SignalSet::set(&$0, $1);"
        let v123 : bool = Fable.Core.RustInterop.emitRustExpr struct (v1, v91) v122 
        ()
...
and closure64 (v0 : Heap2) () : Vec<string> =
    ...
    v20
and closure70 () (v0 : string) : struct (string * US25 * string * bool * bool) =
    let v1 : string = "https://api3.nearblocks.io/v1/account/" + v0 + ""
    let v2 : US25 = US25_0
    let v3 : string = ""
    struct (v1, v2, v3, false, true)
and closure69 (v0 : leptos_Memo<Vec<string>>) () : (struct (string * US25 * string * bool * bool) []) =
    let v1 : string = $"$0()"
    let v2 : Vec<string> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v4 : (string -> struct (string * US25 * string * bool * bool)) = closure70()
...
and method53 (v0 : int32, v1 : Mut1) : bool =
    ...
    let v3 : bool = v2 < v0
    v3
and closure73 (v0 : string) (v1 : int32) : struct (string * US25 * string * bool * bool) =
    let v2 : int32 = v1 + 1
...
and closure72 (v0 : Heap0) (v1 : string) : struct (string * Vec<struct (string * US25 * string * bool * bool)>) =
    let v2 : int32 = v0.l3
    ...
    let v11 : (int32 -> struct (string * US25 * string * bool * bool)) = closure73(v1)
    let v12 : Vec<struct (string * US25 * string * bool * bool)> = Fable.Core.RustInterop.emitRustExpr struct (v9, v11) v10 
    struct (v1, v12)
and closure71 (v0 : Heap2, v1 : leptos_Memo<Vec<string>>) () : Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)> =
    let v2 : leptos_RwSignal<Heap1> = v0.l0
    let v3 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v4 : Heap1 = Fable.Core.RustInterop.emitRustExpr v2 v3 
    ...
    let v10 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v11 : (string -> struct (string * Vec<struct (string * US25 * string * bool * bool)>)) = closure72(v7)
    ...
    let v20 : bool = Fable.Core.RustInterop.emitRustExpr v18 v19 
    v12
and closure75 () struct (v0 : string, v1 : Vec<struct (string * US25 * string * bool * bool)>) : Vec<struct (string * US25 * string * bool * bool)> =
    v1
...
and method56 (v0 : Vec<struct (string * US25 * string * bool * bool)>) : Vec<struct (string * US25 * string * bool * bool)> =
    v0
and closure74 (v0 : leptos_Memo<Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>>) () : Vec<struct (string * US25 * string * bool * bool)> =
    let v1 : string = $"$0()"
    let v2 : Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v4 : (struct (string * Vec<struct (string * US25 * string * bool * bool)>) -> Vec<struct (string * US25 * string * bool * bool)>) = closure75()
    ...
    v26
and closure78 (v0 : string) struct (v1 : string, v2 : US25, v3 : string, v4 : bool, v5 : bool) : string =
    v0
and closure77 () struct (v0 : string, v1 : Vec<struct (string * US25 * string * bool * bool)>) : Vec<string> =
    let v2 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v3 : (struct (string * US25 * string * bool * bool) -> string) = closure78(v0)
...
and method59 (v0 : Vec<string>) : Vec<string> =
    v0
and closure76 (v0 : leptos_Memo<Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>>) () : (string []) =
    let v1 : string = $"$0()"
    let v2 : Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v4 : (struct (string * Vec<struct (string * US25 * string * bool * bool)>) -> Vec<string>) = closure77()
...
and closure79 () (v0 : crate_model_near_nearblocks_Root) : (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) =
    ...
    v8
and closure84 (v0 : leptos_Resource<US2, rexie_Rexie>) () : rexie_Rexie option =
    ...
    v5
and closure85 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Resource<US2, rexie_Rexie>) () : struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>) =
...
and method66 (v0 : string, v1 : rexie_Rexie) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>> =
    ...
    let v109 : US27 =
        ...
        | US7_0(v78) -> (* Some *)
            ...
            let v98 : bool = Fable.Core.RustInterop.emitRustExpr () v97 
            let v99 : string = "borsh::BorshDeserialize::deserialize(&mut v96)"
            let v100 : Result<Heap4, borsh_io_Error> = Fable.Core.RustInterop.emitRustExpr () v99 
            let v101 : (borsh_io_Error -> std_string_String) = method25()
            let v102 : string = "$0.map_err(|x| $1(x))"
            let v103 : Result<Heap4, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v100, v101) v102 
            let v104 : string = "$0?"
            let v105 : Heap4 = Fable.Core.RustInterop.emitRustExpr v103 v104 
            US27_0(v105)
    let v116 : Heap4 option =
        match v109 with
        | US27_1 -> (* None *)
            let v114 : Heap4 option = None
            v114
        | US27_0(v110) -> (* Some *)
            let v111 : Heap4 option = Some v110 
            v111
    let v117 : Result<Heap4 option, std_string_String> = Ok v116 
    let v118 : Result<Heap4 option, std_string_String> = method67(v117)
    let v119 : string = ""
    let v120 : string = "}"
    let v121 : string = v119 + v120 
    let v122 : string = "true; v118 " + v121 + "); " + v119 + " // rust.fix_closure'"
    ...
    let v125 : _ = Fable.Core.RustInterop.emitRustExpr () v124 
    let v126 : string = "v125"
    let v127 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v126 
    v127
and method65 (v0 : string, v1 : rexie_Rexie) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>> =
    method66(v0, v1)
and closure87 () (v0 : Heap4 option) : US26 =
    US26_0(v0)
and closure88 () (v0 : std_string_String) : US26 =
    US26_1(v0)
and closure86 (v0 : rexie_Rexie option) struct (v1 : string, v2 : US25, v3 : string, v4 : bool, v5 : bool) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>> =
    let v6 : string = "true; let __result = Box::pin(async move { //"
    let v7 : bool = Fable.Core.RustInterop.emitRustExpr () v6 
    let v8 : US5 option = None
    let _v8 = ref v8 
    let v9 : US5 option ref = _v8 
    let v10 : (US5 option -> US5 option ref) = closure11(v9)
    let v11 : unit = ()
    let v12 : (unit -> unit) = closure12(v0, v10)
    let v13 : unit = (fun () -> v12 (); v11) ()
    let v16 : US5 option = _v8.Value 
    let v27 : US5 = US5_1
    let v28 : US5 = v16 |> Option.defaultValue v27 
    let v46 : US26 =
        match v28 with
        | US5_0(v32) -> (* Some *)
            let v33 : string = "url[" + v1 + "](" + $"%A{v3}" + ")"
            let v34 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>> = method65(v33, v32)
            let v35 : string = "v34.await"
            let v36 : Result<Heap4 option, std_string_String> = Fable.Core.RustInterop.emitRustExpr () v35 
            let v37 : (Heap4 option -> US26) = closure87()
            let v38 : (std_string_String -> US26) = closure88()
            let v39 : US26 = match v36 with Ok x -> v37 x | Error x -> v38 x
            v39
        | _ ->
            let v40 : string = "&*$0"
            let v41 : string = "database=None"
            let v42 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v41 v40 
            let v43 : string = "String::from($0)"
            let v44 : std_string_String = Fable.Core.RustInterop.emitRustExpr v42 v43 
            US26_1(v44)
    let v52 : Result<Heap4 option, std_string_String> =
        match v46 with
        | US26_1(v49) -> (* Error *)
            let v50 : Result<Heap4 option, std_string_String> = Error v49 
            v50
        | US26_0(v47) -> (* Ok *)
            let v48 : Result<Heap4 option, std_string_String> = Ok v47 
            v48
    let v53 : Result<Heap4 option, std_string_String> = method67(v52)
    let v54 : string = ""
    let v55 : string = "}"
    let v56 : string = v54 + v55 
    let v57 : string = "true; v53 " + v56 + "); " + v54 + " // rust.fix_closure'"
    let v58 : bool = Fable.Core.RustInterop.emitRustExpr () v57 
    let v59 : string = "__result"
    let v60 : _ = Fable.Core.RustInterop.emitRustExpr () v59 
    let v61 : string = "v60"
    let v62 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v61 
    v62
...
and method64 (v0 : Vec<struct (string * US25 * string * bool * bool)>, v1 : rexie_Rexie option) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<Heap4 option>, std_string_String>>>>> =
    ...
    let v12 : string = "state_core.use_requests (3) / state_data_resource create_local_resource / request : " + string v11 + " / database: " + string v4 + ""
    let v13 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v14 : bool = Fable.Core.RustInterop.emitRustExpr v12 v13 
    let v15 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v16 : (struct (string * US25 * string * bool * bool) -> std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>>) = closure86(v1)
    let v17 : Vec<std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>>> = Fable.Core.RustInterop.emitRustExpr struct (v0, v16) v15 
    let v18 : Vec<std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>>> = method68(v17)
    let v19 : string = "futures::future::try_join_all(v18)"
    let v20 : futures_future_TryJoinAll<std_pin_Pin<Box<Dyn<std_future_Future<Result<Heap4 option, std_string_String>>>>>> = Fable.Core.RustInterop.emitRustExpr () v19 
    let v21 : string = "v20.await"
    let v22 : Result<Vec<Heap4 option>, std_string_String> = Fable.Core.RustInterop.emitRustExpr () v21 
    let v23 : string = "$0?"
    let v24 : Vec<Heap4 option> = Fable.Core.RustInterop.emitRustExpr v22 v23 
    let v25 : Result<Vec<Heap4 option>, std_string_String> = Ok v24 
    let v26 : string = $"%A{v25}"
    let v29 : string = "state_core.use_requests (4) / state_data_resource create_local_resource / result: " + string v26 + ""
    let v30 : int64 = 200L
    let v31 : string = method8(v30, v29)
    let v32 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v33 : bool = Fable.Core.RustInterop.emitRustExpr v31 v32 
    let v34 : Result<Vec<Heap4 option>, std_string_String> = method69(v25)
    let v35 : string = ""
    let v36 : string = "}"
    let v37 : string = v35 + v36 
    let v38 : string = "true; v34 " + v37 + "); " + v35 + " // rust.fix_closure'"
    let v39 : bool = Fable.Core.RustInterop.emitRustExpr () v38 
    let v40 : string = "__result"
    let v41 : _ = Fable.Core.RustInterop.emitRustExpr () v40 
    let v42 : string = "v41"
    let v43 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<Heap4 option>, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v42 
    v43
...
and method63 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Resource<US2, rexie_Rexie>) : leptos_Resource<struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>), Result<Vec<Heap4 option>, std_string_String>> =
    ...
    let v3 : (unit -> struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>)) = closure85(v0, v1)
    ...
    let v17 : string = "true; v10 " + v14 + "); " + v16 + " // rust.fix_closure'"
    let v18 : bool = Fable.Core.RustInterop.emitRustExpr () v17 
    let v19 : string = "__result"
    let v20 : leptos_Resource<struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>), Result<Vec<Heap4 option>, std_string_String>> = Fable.Core.RustInterop.emitRustExpr () v19 
    v20
and closure89 (v0 : leptos_Resource<struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>), Result<Vec<Heap4 option>, std_string_String>>) () : Result<Vec<Heap4 option>, std_string_String> option =
    ...
    let v6 : (web_sys_Storage option -> US10) = closure29()
    let v7 : (wasm_bindgen_JsValue -> US10) = closure30()
    ...
    let v38 : US11 =
        ...
        | US10_0(v9) -> (* Ok *)
            ...
            let v12 : (US12 option -> US12 option ref) = closure31(v11)
            let v13 : unit = ()
            let v14 : (unit -> unit) = closure32(v9, v12)
    ...
    v46
and closure90 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Memo<Result<Vec<Heap4 option>, std_string_String> option>) () : struct (Vec<struct (string * US25 * string * bool * bool)> * Result<Vec<Heap4 option>, std_string_String> option) =
    let v2 : string = $"$0()"
    ...
    struct (v3, v5)
and closure91 (v0 : US28 option ref) (v1 : US28 option) : US28 option ref =
    v0.Value <- v1 
    v0
and closure92 (v0 : Result<Vec<Heap4 option>, std_string_String> option, v1 : (US28 option -> US28 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    |> v1 |> ignore
    ()
and closure93 () (v0 : Vec<Heap4 option>) : US31 =
    US31_0(v0)
and closure94 () (v0 : std_string_String) : US31 =
    US31_1(v0)
and closure96 (v0 : US27 option ref) (v1 : US27 option) : US27 option ref =
    v0.Value <- v1 
    v0
and closure97 (v0 : Heap4 option, v1 : (US27 option -> US27 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    |> v1 |> ignore
    ()
and closure95 () (v0 : Heap4 option) : US27 =
    let v1 : US27 option = None
    let _v1 = ref v1 
    let v2 : US27 option ref = _v1 
    let v3 : (US27 option -> US27 option ref) = closure96(v2)
    let v4 : unit = ()
    let v5 : (unit -> unit) = closure97(v0, v3)
    let v6 : unit = (fun () -> v5 (); v4) ()
    let v9 : US27 option = _v1.Value 
    let v20 : US27 = US27_1
    let v21 : US27 = v9 |> Option.defaultValue v20 
    v21
and closure100 (v0 : US35 option ref) (v1 : US35 option) : US35 option ref =
    v0.Value <- v1 
    v0
and closure101 (v0 : US27 option, v1 : (US35 option -> US35 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and method80 (v0 : reqwest_RequestBuilder) : reqwest_RequestBuilder =
    v0
and closure102 () (v0 : reqwest_Error) : std_string_String =
    let v1 : unit = ()
...
and method82 (v0 : Result<string option, std_string_String>) : Result<string option, std_string_String> =
    v0
and closure99 (v0 : US29, v1 : int32) struct (v2 : string, v3 : US25, v4 : string, v5 : bool, v6 : bool) : std_pin_Pin<Box<Dyn<std_future_Future<Result<string option, std_string_String>>>>> =
    let v7 : string = "true; let __result = Box::pin(async move { //"
        ...
        | US29_0(v9) -> (* Some *)
            let v57 : US33 =
                ...
                | US30_0(v10) -> (* Ok *)
                    ...
                    let v12 : (US27 []) = Fable.Core.RustInterop.emitRustExpr v10 v11 
                    let v13 : US27 option = v12 |> Array.tryItem v1 
                    let v14 : US35 option = None
                    let _v14 = ref v14 
                    let v15 : US35 option ref = _v14 
                    let v16 : (US35 option -> US35 option ref) = closure100(v15)
                    let v17 : unit = ()
                    let v18 : (unit -> unit) = closure101(v13, v16)
                    let v19 : unit = (fun () -> v18 (); v17) ()
                    let v22 : US35 option = _v14.Value 
                    let v33 : US35 = US35_1
                    let v34 : US35 = v22 |> Option.defaultValue v33 
                    let v44 : US27 =
                        match v34 with
                        | US35_0(v38) -> (* Some *)
                            match v38 with
        ...
        if v6 then
            ...
            | US29_0(v77) -> (* Some *)
                ...
                | US30_0(v78) -> (* Ok *)
                    ...
                    let v80 : (US27 []) = Fable.Core.RustInterop.emitRustExpr v78 v79 
    ...
    let v178 : US36 =
        if v105 then
            ...
            let v108 : US25 = method74(v3)
            let v126 : reqwest_RequestBuilder =
                match v108 with
                | US25_0 -> (* Get *)
                    let v109 : string = method75(v2)
                    let v110 : string = "&*$0"
                    ...
                    let v114 : std_string_String = method76(v113)
                ...
                | US25_1 -> (* Post *)
                    ...
                    let v122 : std_string_String = method78(v121)
            ...
            let v152 : reqwest_RequestBuilder =
                if v133 then
                    ...
                    let v140 : reqwest_RequestBuilder = method79(v132)
                    let v141 : string = "&*$0"
                    ...
                    v151
            let v153 : reqwest_RequestBuilder = method80(v152)
            ...
            let v158 : (reqwest_Error -> std_string_String) = method81()
            ...
            let v167 : (reqwest_Error -> std_string_String) = method81()
    ...
    let v184 : Result<string option, std_string_String> =
        ...
        | US36_0(v179) -> (* Ok *)
            ...
            v180
    let v185 : Result<string option, std_string_String> = method82(v184)
    let v186 : string = ""
    let v187 : string = "}"
    ...
    v194
and closure98 (v0 : US29) (v1 : int32) : (struct (string * US25 * string * bool * bool) -> std_pin_Pin<Box<Dyn<std_future_Future<Result<string option, std_string_String>>>>>) =
    closure99(v0, v1)
...
and method72 (v0 : Result<Vec<Heap4 option>, std_string_String> option, v1 : Vec<struct (string * US25 * string * bool * bool)>) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<string option>, std_string_String>>>>> =
    let v2 : string = $"%A{v1}"
    let v5 : int64 = 400L
    let v6 : string = method8(v5, v2)
    let v7 : string = "state_core.use_requests (7) / json create_local_resource / requests: " + string v6 + ""
    let v8 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v9 : bool = Fable.Core.RustInterop.emitRustExpr v7 v8 
    let v10 : string = "true; let __result = Box::pin(async move { //"
    let v11 : bool = Fable.Core.RustInterop.emitRustExpr () v10 
    let v12 : US28 option = None
    let _v12 = ref v12 
    let v13 : US28 option ref = _v12 
    let v14 : (US28 option -> US28 option ref) = closure91(v13)
    let v15 : unit = ()
    let v16 : (unit -> unit) = closure92(v0, v14)
    let v17 : unit = (fun () -> v16 (); v15) ()
    let v20 : US28 option = _v12.Value 
    let v31 : US28 = US28_1
    let v32 : US28 = v20 |> Option.defaultValue v31 
    let v52 : US29 =
        match v32 with
        | US28_1 -> (* None *)
            US29_1
        | US28_0(v36) -> (* Some *)
            let v37 : (Vec<Heap4 option> -> US31) = closure93()
            let v38 : (std_string_String -> US31) = closure94()
            let v39 : US31 = match v36 with Ok x -> v37 x | Error x -> v38 x
            let v48 : US30 =
                match v39 with
                | US31_1(v45) -> (* Error *)
                    US30_1(v45)
                | US31_0(v40) -> (* Ok *)
                    ...
                    let v42 : (Heap4 option -> US27) = closure95()
                    let v43 : Vec<US27> = Fable.Core.RustInterop.emitRustExpr struct (v40, v42) v41 
                    US30_0(v43)
            US29_0(v48)
    let v53 : string = $"%A{v52}"
    let v56 : int64 = 400L
    let v57 : string = method8(v56, v53)
    let v58 : string = "state_core.use_requests (8) / result_memo / state_data: " + string v57 + ""
    let v59 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v60 : bool = Fable.Core.RustInterop.emitRustExpr v58 v59 
    let v61 : (int32 -> (struct (string * US25 * string * bool * bool) -> std_pin_Pin<Box<Dyn<std_future_Future<Result<string option, std_string_String>>>>>)) = method73(v52)
    let v62 : Vec<struct (string * US25 * string * bool * bool)> = method83(v1)
    let v63 : string = "v62.iter().enumerate().map(|(i, x)| v61(i.try_into().unwrap())(x.clone())).collect::<Vec<_>>()"
    let v64 : Vec<std_pin_Pin<Box<Dyn<std_future_Future<Result<string option, std_string_String>>>>>> = Fable.Core.RustInterop.emitRustExpr () v63 
    let v65 : Vec<std_pin_Pin<Box<Dyn<std_future_Future<Result<string option, std_string_String>>>>>> = method84(v64)
    let v66 : string = "futures::future::try_join_all(v65)"
    let v67 : futures_future_TryJoinAll<std_pin_Pin<Box<Dyn<std_future_Future<Result<string option, std_string_String>>>>>> = Fable.Core.RustInterop.emitRustExpr () v66 
    let v68 : string = "v67.await"
    let v69 : Result<Vec<string option>, std_string_String> = Fable.Core.RustInterop.emitRustExpr () v68 
    let v70 : string = "$0?"
    let v71 : Vec<string option> = Fable.Core.RustInterop.emitRustExpr v69 v70 
    let v72 : Result<Vec<string option>, std_string_String> = Ok v71 
    let v73 : Result<Vec<string option>, std_string_String> = method85(v72)
    let v74 : string = ""
    let v75 : string = "}"
    let v76 : string = v74 + v75 
    let v77 : string = "true; v73 " + v76 + "); " + v74 + " // rust.fix_closure'"
    let v78 : bool = Fable.Core.RustInterop.emitRustExpr () v77 
    let v79 : string = "__result"
    let v80 : _ = Fable.Core.RustInterop.emitRustExpr () v79 
    let v81 : string = "v80"
    let v82 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<string option>, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v81 
    v82
...
and method71 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Memo<Result<Vec<Heap4 option>, std_string_String> option>) : leptos_Resource<struct (Vec<struct (string * US25 * string * bool * bool)> * Result<Vec<Heap4 option>, std_string_String> option), Result<Vec<string option>, std_string_String>> =
    let v2 : string = "let __result = leptos::create_local_resource(move || $0(), |x| async move { //"
    let v3 : (unit -> struct (Vec<struct (string * US25 * string * bool * bool)> * Result<Vec<Heap4 option>, std_string_String> option)) = closure90(v0, v1)
    Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v4 : string = "x"
    ...
    let v18 : bool = Fable.Core.RustInterop.emitRustExpr () v17 
    let v19 : string = "__result"
    let v20 : leptos_Resource<struct (Vec<struct (string * US25 * string * bool * bool)> * Result<Vec<Heap4 option>, std_string_String> option), Result<Vec<string option>, std_string_String>> = Fable.Core.RustInterop.emitRustExpr () v19 
    v20
and method87 (v0 : string) : string =
    v0
and closure105 () (v0 : rexie_Error) : std_string_String =
    let v1 : unit = ()
...
and method89 (v0 : Result<unit, std_string_String>) : Result<unit, std_string_String> =
    v0
and closure104 (v0 : Heap4, v1 : US5) struct (v2 : string, v3 : US25, v4 : string, v5 : bool, v6 : bool) : std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, std_string_String>>>>> =
    let v7 : string = "true; let __result = Box::pin(async move { //"
    let v8 : bool = Fable.Core.RustInterop.emitRustExpr () v7 
    let v64 : US37 =
        match v1 with
        | US5_0(v9) -> (* Some *)
            let v10 : string = "state_core.use_requests (11) / set_state_data_action / database=Some(_) / url: " + v2 + ""
            let v11 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
            let v12 : bool = Fable.Core.RustInterop.emitRustExpr v10 v11 
            let v13 : string = "url[" + v2 + "](" + $"%A{v4}" + ")"
            let v14 : string = $"%A{v0}"
            let v17 : int64 = System.Convert.ToInt64 v14.Length
            let v18 : string = "state_core.set_data () / data_len: " + string v17 + ""
            let v19 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
            let v20 : bool = Fable.Core.RustInterop.emitRustExpr v18 v19 
            let v21 : string = "true; let __result = Box::pin(async move { //"
            let v22 : bool = Fable.Core.RustInterop.emitRustExpr () v21 
            let v23 : string = "$0.transaction(&[\"store\"], rexie::TransactionMode::ReadWrite)?"
            let v24 : rexie_Transaction = Fable.Core.RustInterop.emitRustExpr v9 v23 
            let v25 : string = "v24.store(\"store\")?"
            let v26 : rexie_Store = Fable.Core.RustInterop.emitRustExpr () v25 
            let v27 : string = "true; let mut data = Vec::new()"
            let v28 : bool = Fable.Core.RustInterop.emitRustExpr () v27 
            let v29 : string = "true; borsh::BorshSerialize::serialize(&$0, &mut data).unwrap()"
            let v30 : bool = Fable.Core.RustInterop.emitRustExpr v0 v29 
            let v31 : string = "data"
            let v32 : Vec<uint8> = Fable.Core.RustInterop.emitRustExpr () v31 
            let v33 : string = "serde_wasm_bindgen::to_value(&v32).unwrap()"
            let v34 : wasm_bindgen_JsValue = Fable.Core.RustInterop.emitRustExpr () v33 
            let v35 : string = method87(v13)
            let v36 : string = "&*$0"
            let v37 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v35 v36 
            let v38 : string = "true; v26.put(&v34, Some(&v37.into())).await?"
            let v39 : bool = Fable.Core.RustInterop.emitRustExpr () v38 
            let v40 : string = "true; v24.done().await?"
            let v41 : bool = Fable.Core.RustInterop.emitRustExpr () v40 
            let v42 : Result<unit, rexie_Error> = Ok () 
            let v43 : Result<unit, rexie_Error> = method37(v42)
            let v44 : string = ""
            let v45 : string = "}"
            let v46 : string = v44 + v45 
            let v47 : string = "true; v43 " + v46 + "); " + v44 + " // rust.fix_closure'"
            ...
            let v51 : string = "v50"
            let v52 : std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, rexie_Error>>>>> = Fable.Core.RustInterop.emitRustExpr () v51 
            let v53 : string = "v52.await"
            let v54 : Result<unit, rexie_Error> = Fable.Core.RustInterop.emitRustExpr () v53 
            let v55 : (rexie_Error -> std_string_String) = method88()
            let v56 : string = "$0.map_err(|x| $1(x))"
            let v57 : Result<unit, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v54, v55) v56 
            let v58 : string = "$0?"
            Fable.Core.RustInterop.emitRustExpr v57 v58 
            US37_0
        | _ ->
            let v60 : string = "state_core.use_requests (12) / set_state_data_action / database,request=None"
            let v61 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
            let v62 : bool = Fable.Core.RustInterop.emitRustExpr v60 v61 
            US37_0
    let v69 : Result<unit, std_string_String> =
        match v64 with
        | US37_1(v66) -> (* Error *)
            let v67 : Result<unit, std_string_String> = Error v66 
            v67
        | US37_0 -> (* Ok *)
            let v65 : Result<unit, std_string_String> = Ok () 
            v65
    let v70 : Result<unit, std_string_String> = method89(v69)
    let v71 : string = ""
    let v72 : string = "}"
    let v73 : string = v71 + v72 
    let v74 : string = "true; v70 " + v73 + "); " + v71 + " // rust.fix_closure'"
    let v75 : bool = Fable.Core.RustInterop.emitRustExpr () v74 
    let v76 : string = "__result"
    let v77 : _ = Fable.Core.RustInterop.emitRustExpr () v76 
    let v78 : string = "v77"
    let v79 : std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v78 
    v79
...
and method91 (v0 : Result<Vec<unit>, std_string_String>) : Result<Vec<unit>, std_string_String> =
    v0
and closure103 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Memo<rexie_Rexie option>) (v2 : Heap4) : std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<unit>, std_string_String>>>>> =
    let v3 : string = $"%A{v2}"
    ...
    let _v14 = ref v14 
    let v15 : US5 option ref = _v14 
    let v16 : (US5 option -> US5 option ref) = closure11(v15)
    let v17 : unit = ()
    let v18 : (unit -> unit) = closure12(v13, v16)
    let v19 : unit = (fun () -> v18 (); v17) ()
    let v22 : US5 option = _v14.Value 
    let v33 : US5 = US5_1
    let v34 : US5 = v22 |> Option.defaultValue v33 
    let v38 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v39 : Vec<struct (string * US25 * string * bool * bool)> = Fable.Core.RustInterop.emitRustExpr v0 v38 
    let v40 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v41 : (struct (string * US25 * string * bool * bool) -> std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, std_string_String>>>>>) = closure104(v2, v34)
    let v42 : Vec<std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, std_string_String>>>>>> = Fable.Core.RustInterop.emitRustExpr struct (v39, v41) v40 
    let v43 : Vec<std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, std_string_String>>>>>> = method90(v42)
    let v44 : string = "futures::future::try_join_all(v43)"
    let v45 : futures_future_TryJoinAll<std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, std_string_String>>>>>> = Fable.Core.RustInterop.emitRustExpr () v44 
    let v46 : string = "v45.await"
    let v47 : Result<Vec<unit>, std_string_String> = Fable.Core.RustInterop.emitRustExpr () v46 
    let v48 : string = "$0?"
    let v49 : Vec<unit> = Fable.Core.RustInterop.emitRustExpr v47 v48 
    let v50 : Result<Vec<unit>, std_string_String> = Ok v49 
    let v51 : Result<Vec<unit>, std_string_String> = method91(v50)
    let v52 : string = ""
    let v53 : string = "}"
    let v54 : string = v52 + v53 
    let v55 : string = "true; v51 " + v54 + "); " + v52 + " // rust.fix_closure'"
    ...
    let v59 : string = "v58"
    let v60 : std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<unit>, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v59 
    v60
and closure107 (v0 : US40 option ref) (v1 : US40 option) : US40 option ref =
    v0.Value <- v1 
    v0
and closure108 (v0 : Result<Vec<string option>, std_string_String> option, v1 : (US40 option -> US40 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : Result<Vec<string option>, std_string_String> = x
    let v3 : US40 = US40_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
    |> v1 |> ignore
    ()
and closure109 () (v0 : Vec<string option>) : US42 =
    US42_0(v0)
and closure110 () (v0 : std_string_String) : US42 =
    US42_1(v0)
and closure112 (v0 : US34 option ref) (v1 : US34 option) : US34 option ref =
    v0.Value <- v1 
    v0
and closure113 (v0 : string option, v1 : (US34 option -> US34 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    |> v1 |> ignore
    ()
and closure111 () (v0 : string option) : US34 =
    let v1 : US34 option = None
    let _v1 = ref v1 
    let v2 : US34 option ref = _v1 
    let v3 : (US34 option -> US34 option ref) = closure112(v2)
    let v4 : unit = ()
    let v5 : (unit -> unit) = closure113(v0, v3)
    let v6 : unit = (fun () -> v5 (); v4) ()
    let v9 : US34 option = _v1.Value 
    let v20 : US34 = US34_1
    let v21 : US34 = v9 |> Option.defaultValue v20 
    v21
and closure114 (v0 : leptos_Action<Heap4, Result<Vec<unit>, std_string_String>>) (v1 : US34) : unit =
    match v1 with
    | US34_0(v2) -> (* Some *)
        let v3 : string = "&*$0"
    ...
    | _ ->
        ()
and closure117 (v0 : US45 option ref) (v1 : US45 option) : US45 option ref =
    v0.Value <- v1 
    v0
and closure118 (v0 : US34 option, v1 : (US45 option -> US45 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : US34 = x
    let v3 : US45 = US45_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
    |> v1 |> ignore
    ()
and closure119 () (v0 : crate_model_near_nearblocks_Root) : crate_model_near_nearblocks_Root option =
...
and method94 (v0 : Result<crate_model_near_nearblocks_Root, std_string_String>) : Result<crate_model_near_nearblocks_Root, std_string_String> =
    v0
and closure116 (v0 : US38, v1 : US44, v2 : int32) struct (v3 : string, v4 : US25, v5 : string, v6 : bool, v7 : bool) : Result<crate_model_near_nearblocks_Root option, std_string_String> =
    let v58 : US32 =
        match v0 with
        | US38_1 -> (* None *)
            US32_1
        | US38_0(v8) -> (* Some *)
            let v54 : US33 =
                ...
                | US39_0(v9) -> (* Ok *)
                    ...
                    let v11 : US35 option = None
                    let _v11 = ref v11 
                    let v12 : US35 option ref = _v11 
                    let v13 : (US35 option -> US35 option ref) = closure100(v12)
                    let v14 : unit = ()
                    let v15 : (unit -> unit) = closure101(v10, v13)
                    let v16 : unit = (fun () -> v15 (); v14) ()
                    let v19 : US35 option = _v11.Value 
                    let v30 : US35 = US35_1
                    let v31 : US35 = v19 |> Option.defaultValue v30 
                    let v41 : US27 =
                        match v31 with
                        | US35_0(v35) -> (* Some *)
                            match v35 with
    ...
    let v118 : US34 =
        ...
        | US44_0(v80) -> (* Ok *)
            ...
            let v82 : (US34 []) = Fable.Core.RustInterop.emitRustExpr v80 v81 
            let v83 : US34 option = v82 |> Array.tryItem v2 
            let v84 : US45 option = None
            let _v84 = ref v84 
            let v85 : US45 option ref = _v84 
            let v86 : (US45 option -> US45 option ref) = closure117(v85)
            let v87 : unit = ()
            let v88 : (unit -> unit) = closure118(v83, v86)
            let v89 : unit = (fun () -> v88 (); v87) ()
            let v92 : US45 option = _v84.Value 
            let v103 : US45 = US45_1
            let v104 : US45 = v92 |> Option.defaultValue v103 
            match v104 with
            | US45_0(v108) -> (* Some *)
                match v108 with
                | US34_0(v109) -> (* Some *)
    ...
    | US34_0(v119) -> (* Some *)
        ...
        let v125 : (serde_json_Error -> std_string_String) = method35()
        ...
        let v128 : (crate_model_near_nearblocks_Root -> crate_model_near_nearblocks_Root option) = method93()
        let v129 : Result<crate_model_near_nearblocks_Root, std_string_String> = method94(v127)
    ...
    | _ ->
        ...
        | US32_0(v132) -> (* Some *)
            ...
            | US33_0(v133) -> (* Ok *)
                ...
                | US34_0(v134) -> (* Some *)
                    ...
                    let v140 : (serde_json_Error -> std_string_String) = method35()
                    ...
                    let v143 : (crate_model_near_nearblocks_Root -> crate_model_near_nearblocks_Root option) = method93()
                    let v144 : Result<crate_model_near_nearblocks_Root, std_string_String> = method94(v142)
        ...
        | _ ->
            ...
            v172
and closure115 (v0 : US38, v1 : US44) (v2 : int32) : (struct (string * US25 * string * bool * bool) -> Result<crate_model_near_nearblocks_Root option, std_string_String>) =
    closure116(v0, v1, v2)
and method92 (v0 : US38, v1 : US44) : (int32 -> (struct (string * US25 * string * bool * bool) -> Result<crate_model_near_nearblocks_Root option, std_string_String>)) =
    closure115(v0, v1)
and closure106 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Memo<Result<Vec<Heap4 option>, std_string_String> option>, v2 : leptos_Resource<struct (Vec<struct (string * US25 * string * bool * bool)> * Result<Vec<Heap4 option>, std_string_String> option), Result<Vec<string option>, std_string_String>>, v3 : leptos_Action<Heap4, Result<Vec<unit>, std_string_String>>) () : (Result<crate_model_near_nearblocks_Root option, std_string_String> []) =
    let v4 : string = $"$0()"
    let v5 : Vec<struct (string * US25 * string * bool * bool)> = Fable.Core.RustInterop.emitRustExpr v0 v4 
    let v6 : string = $"%A{v5}"
    ...
    let v14 : US28 option = None
    let _v14 = ref v14 
    let v15 : US28 option ref = _v14 
    let v16 : (US28 option -> US28 option ref) = closure91(v15)
    let v17 : unit = ()
    let v18 : (unit -> unit) = closure92(v13, v16)
    let v19 : unit = (fun () -> v18 (); v17) ()
    let v22 : US28 option = _v14.Value 
    let v33 : US28 = US28_1
    let v34 : US28 = v22 |> Option.defaultValue v33 
    let v56 : US38 =
        match v34 with
        | US28_1 -> (* None *)
            US38_1
        | US28_0(v38) -> (* Some *)
            let v39 : (Vec<Heap4 option> -> US31) = closure93()
            let v40 : (std_string_String -> US31) = closure94()
            let v41 : US31 = match v38 with Ok x -> v39 x | Error x -> v40 x
            let v52 : US39 =
                match v41 with
                | US31_1(v49) -> (* Error *)
                    US39_1(v49)
                | US31_0(v42) -> (* Ok *)
                    ...
                    let v44 : (Heap4 option -> US27) = closure95()
                    let v45 : Vec<US27> = Fable.Core.RustInterop.emitRustExpr struct (v42, v44) v43 
                    let v46 : string = "fable_library_rust::NativeArray_::array_from($0)"
                    let v47 : (US27 []) = Fable.Core.RustInterop.emitRustExpr v45 v46 
                    US39_0(v47)
            US38_0(v52)
    let v57 : string = $"%A{v56}"
    let v60 : int64 = 400L
    let v61 : string = method8(v60, v57)
    let v62 : string = "state_core.use_request (14) / result_memo / state_data: " + string v61 + ""
    let v63 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v64 : bool = Fable.Core.RustInterop.emitRustExpr v62 v63 
    let v65 : string = $"leptos::SignalGet::get(&$0)"
    let v66 : Result<Vec<string option>, std_string_String> option = Fable.Core.RustInterop.emitRustExpr v2 v65 
    let v67 : US40 option = None
    let _v67 = ref v67 
    let v68 : US40 option ref = _v67 
    let v69 : (US40 option -> US40 option ref) = closure107(v68)
    let v70 : unit = ()
    let v71 : (unit -> unit) = closure108(v66, v69)
    let v72 : unit = (fun () -> v71 (); v70) ()
    let v75 : US40 option = _v67.Value 
    let v86 : US40 = US40_1
    let v87 : US40 = v75 |> Option.defaultValue v86 
    let v98 : US41 =
        match v87 with
        | US40_1 -> (* None *)
            US41_1
        | US40_0(v91) -> (* Some *)
            let v92 : (Vec<string option> -> US42) = closure109()
            let v93 : (std_string_String -> US42) = closure110()
            let v94 : US42 = match v91 with Ok x -> v92 x | Error x -> v93 x
            US41_0(v94)
    let v112 : US43 =
        match v98 with
        | US41_1 -> (* None *)
        ...
        | US41_0(v99) -> (* Some *)
            let v108 : US44 =
                ...
                | US42_1(v105) -> (* Error *)
                    US44_1(v105)
                | US42_0(v100) -> (* Ok *)
                    let v101 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
                    let v102 : (string option -> US34) = closure111()
                    let v103 : Vec<US34> = Fable.Core.RustInterop.emitRustExpr struct (v100, v102) v101 
                    US44_0(v103)
            US43_0(v108)
    let v113 : (US34 []) = [||]
    let v114 : string = "$0.to_vec()"
    let v115 : Vec<US34> = Fable.Core.RustInterop.emitRustExpr v113 v114 
    let v119 : US44 =
        match v112 with
        | US43_1 -> (* None *)
            US44_0(v115)
    ...
    | US44_1(v124) -> (* Error *)
        ()
    | US44_0(v120) -> (* Ok *)
        let v121 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
        let v122 : (US34 -> unit) = closure114(v3)
        let v123 : Vec<unit> = Fable.Core.RustInterop.emitRustExpr struct (v120, v122) v121 
        ()
    let v125 : (int32 -> (struct (string * US25 * string * bool * bool) -> Result<crate_model_near_nearblocks_Root option, std_string_String>)) = method92(v56, v119)
    let v126 : Vec<struct (string * US25 * string * bool * bool)> = method83(v5)
    let v127 : string = "v126.iter().enumerate().map(|(i, x)| v125(i.try_into().unwrap())(x.clone())).collect::<Vec<_>>()"
    let v128 : Vec<Result<crate_model_near_nearblocks_Root option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr () v127 
    let v129 : string = "fable_library_rust::NativeArray_::array_from($0)"
    let v130 : (Result<crate_model_near_nearblocks_Root option, std_string_String> []) = Fable.Core.RustInterop.emitRustExpr v128 v129 
    let v131 : string = $"%A{v130}"
    let v134 : string = "state_core.use_requests (18) / result_func func0 / result: " + string v131 + ""
    let v135 : int64 = 200L
...
and closure124 (v0 : (crate_model_near_nearblocks_Root -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) [])), v1 : crate_model_near_nearblocks_Root option, v2 : ((struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option ref)) () : unit =
    ...
    |> v2 |> ignore
    ()
and closure122 (v0 : (crate_model_near_nearblocks_Root -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []))) (v1 : crate_model_near_nearblocks_Root option) : (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option =
    ...
    let v4 : ((struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option ref) = closure123(v3)
    let v5 : unit = ()
    let v6 : (unit -> unit) = closure124(v0, v1, v4)
...
and method96 (v0 : Result<crate_model_near_nearblocks_Root option, std_string_String>) : Result<crate_model_near_nearblocks_Root option, std_string_String> =
    v0
and closure121 (v0 : (crate_model_near_nearblocks_Root -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []))) (v1 : Result<crate_model_near_nearblocks_Root option, std_string_String>) : Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String> =
    ...
    v5
and closure120 (v0 : (crate_model_near_nearblocks_Root -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) [])), v1 : leptos_Resource<US2, rexie_Rexie>, v2 : leptos_Resource<struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>), Result<Vec<Heap4 option>, std_string_String>>, v3 : leptos_Memo<(Result<crate_model_near_nearblocks_Root option, std_string_String> [])>) () : Vec<Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>> =
    ...
    let v40 : US28 option = None
    let _v40 = ref v40 
    let v41 : US28 option ref = _v40 
    let v42 : (US28 option -> US28 option ref) = closure91(v41)
    let v43 : unit = ()
    let v44 : (unit -> unit) = closure92(v39, v42)
    let v45 : unit = (fun () -> v44 (); v43) ()
    let v48 : US28 option = _v40.Value 
    let v59 : US28 = US28_1
    let v60 : US28 = v48 |> Option.defaultValue v59 
    let v82 : US38 =
        match v60 with
        | US28_1 -> (* None *)
            US38_1
        | US28_0(v64) -> (* Some *)
            let v65 : (Vec<Heap4 option> -> US31) = closure93()
            let v66 : (std_string_String -> US31) = closure94()
            let v67 : US31 = match v64 with Ok x -> v65 x | Error x -> v66 x
            let v78 : US39 =
                match v67 with
                | US31_1(v75) -> (* Error *)
                    US39_1(v75)
                | US31_0(v68) -> (* Ok *)
                    let v69 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
                    let v70 : (Heap4 option -> US27) = closure95()
                    let v71 : Vec<US27> = Fable.Core.RustInterop.emitRustExpr struct (v68, v70) v69 
                    let v72 : string = "fable_library_rust::NativeArray_::array_from($0)"
                    let v73 : (US27 []) = Fable.Core.RustInterop.emitRustExpr v71 v72 
                    US39_0(v73)
            US38_0(v78)
    let v83 : string = $"%A{v34}"
    let v86 : int64 = 400L
    let v87 : string = method8(v86, v83)
    let v88 : string = $"%A{v82}"
    let v91 : int64 = 400L
    let v92 : string = method8(v91, v88)
    let v93 : string = "state_core.use_request (19) / result move / database: " + string v87 + " / database_loading: " + string v7 + " / state_data: " + string v92 + " / state_data_loading: " + string v11 + ""
    let v94 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v95 : bool = Fable.Core.RustInterop.emitRustExpr v93 v94 
    let v96 : string = $"$0()"
    let v97 : (Result<crate_model_near_nearblocks_Root option, std_string_String> []) = Fable.Core.RustInterop.emitRustExpr v3 v96 
    let v98 : string = "$0.to_vec()"
    let v99 : Vec<Result<crate_model_near_nearblocks_Root option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr v97 v98 
    let v100 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v101 : (Result<crate_model_near_nearblocks_Root option, std_string_String> -> Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>) = closure121(v0)
    let v102 : Vec<Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr struct (v99, v101) v100 
    let v103 : string = $"%A{v102}"
    let v106 : string = "state_core.use_requests (20) / result func0 / result: " + string v103 + ""
    let v107 : int64 = 200L
    let v108 : string = method8(v107, v106)
...
and method62 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : (crate_model_near_nearblocks_Root -> (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []))) : leptos_Memo<Vec<Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>>> =
    ...
    let v9 : string = "$0"
    let v10 : (unit -> rexie_Rexie option) = closure84(v8)
    ...
    let v15 : string = "$0"
    let v16 : (unit -> Result<Vec<Heap4 option>, std_string_String> option) = closure89(v14)
    ...
    let v22 : (Heap4 -> std_pin_Pin<Box<Dyn<std_future_Future<Result<Vec<unit>, std_string_String>>>>>) = closure103(v0, v13)
    let v23 : leptos_Action<Heap4, Result<Vec<unit>, std_string_String>> = Fable.Core.RustInterop.emitRustExpr v22 v21 
    let v24 : string = "$0"
    let v25 : (unit -> (Result<crate_model_near_nearblocks_Root option, std_string_String> [])) = closure106(v0, v19, v20, v23)
    ...
    let v29 : string = "$0"
    let v30 : (unit -> Vec<Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>>) = closure120(v1, v8, v14, v28)
    ...
    v33
and closure127 () (v0 : (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option) : US46 =
    US46_0(v0)
and closure128 () (v0 : std_string_String) : US46 =
    US46_1(v0)
and closure126 () (v0 : Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>) : US46 =
    let v1 : ((struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option -> US46) = closure127()
    let v2 : (std_string_String -> US46) = closure128()
    let v3 : US46 = match v0 with Ok x -> v1 x | Error x -> v2 x
    v3
and closure130 (v0 : US48 option ref) (v1 : US48 option) : US48 option ref =
    v0.Value <- v1 
    v0
and closure131 (v0 : (struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, v1 : (US48 option -> US48 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and closure129 () (v0 : US46) : US47 =
    ...
    | US46_0(v1) -> (* Ok *)
        ...
        let _v2 = ref v2 
        let v3 : US48 option ref = _v2 
        let v4 : (US48 option -> US48 option ref) = closure130(v3)
        let v5 : unit = ()
        let v6 : (unit -> unit) = closure131(v1, v4)
        let v7 : unit = (fun () -> v6 (); v5) ()
        let v10 : US48 option = _v2.Value 
        let v21 : US48 = US48_1
        let v22 : US48 = v10 |> Option.defaultValue v21 
        US47_0(v22)
and closure132 () (v0 : US47) : bool =
    match v0 with
    | US47_0(v1) -> (* Ok *)
        match v1 with
        | US48_1 -> (* None *)
...
and method98 (v0 : Vec<US47>) : Vec<US47> =
    v0
and closure135 () (v0 : (unativeint * struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])))) : struct (unativeint * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) =
    let (a, b) = v0 
    let v1 : unativeint = a
...
and closure136 (v0 : int32, v1 : string) struct (v2 : unativeint, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : std_string_String, v7 : std_string_String, v8 : std_string_String, v9 : uint32, v10 : (struct (std_string_String * std_string_String option) []), v11 : float, v12 : bool, v13 : float, v14 : (std_string_String [])) : struct (string * unativeint * Heap5) =
    ...
    struct (v1, v15, v18)
and closure134 (v0 : (string []), v1 : int32) (v2 : US47) : US51 =
    ...
    | US47_0(v4) -> (* Ok *)
        let v27 : US52 =
            ...
            | US48_0(v5) -> (* Some *)
                ...
                let v15 : ((unativeint * struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String []))) -> struct (unativeint * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String []))) = closure135()
                ...
                let v22 : (struct (unativeint * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) -> struct (string * unativeint * Heap5)) = closure136(v1, v3)
                let v23 : Vec<struct (string * unativeint * Heap5)> = Fable.Core.RustInterop.emitRustExpr struct (v20, v22) v21 
                US52_0(v23)
        US51_0(v27)
and closure133 (v0 : (string [])) (v1 : int32) : (US47 -> US51) =
    closure134(v0, v1)
and method99 (v0 : (string [])) : (int32 -> (US47 -> US51)) =
    closure133(v0)
and method100 (v0 : Vec<US47>) : Vec<US47> =
    v0
and closure137 () (v0 : US51) : US53 =
    match v0 with
    | US51_1(v10) -> (* Error *)
        US53_1(v10)
    | US51_0(v1) -> (* Ok *)
        let v8 : Vec<struct (string * unativeint * Heap5)> option =
            ...
            | US52_0(v2) -> (* Some *)
                ...
                v3
        US53_0(v8)
and closure138 () (v0 : US53) : Result<Vec<struct (string * unativeint * Heap5)> option, std_string_String> =
    match v0 with
    | US53_1(v3) -> (* Error *)
...
and method101 (v0 : int32, v1 : Mut4) : bool =
    ...
    let v3 : bool = v2 < v0
    v3
and closure139 () (v0 : Vec<struct (string * unativeint * Heap5)> option) : US53 =
    US53_0(v0)
and closure140 () (v0 : std_string_String) : US53 =
    US53_1(v0)
and closure141 (v0 : US52 option ref) (v1 : US52 option) : US52 option ref =
    v0.Value <- v1 
    v0
and closure142 (v0 : Vec<struct (string * unativeint * Heap5)> option, v1 : (US52 option -> US52 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : Vec<struct (string * unativeint * Heap5)> = x
    let v3 : US52 = US52_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
...
and method104 (v0 : Vec<struct (string * unativeint * Heap5)>) : Vec<struct (string * unativeint * Heap5)> =
    v0
and closure143 () struct (v0 : string, v1 : unativeint, v2 : Heap5) : std_string_String =
...
and closure125 (v0 : leptos_Memo<(string [])>, v1 : leptos_Memo<Vec<Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>>>) () : Result<(struct (string * unativeint * Heap5) []) option, std_string_String> =
    ...
    let v5 : (Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String> -> US46) = closure126()
    ...
    let v16 : string = @$"true; leptos::logging::log!(""{{}}"", $0)"
    let v17 : bool = Fable.Core.RustInterop.emitRustExpr v15 v16 
    let v18 : (US47 -> bool) = method97()
    let v19 : Vec<US47> = method98(v9)
    ...
    let v26 : (US47 []) = Fable.Core.RustInterop.emitRustExpr v9 v25 
    ...
    let v147 : US49 =
        if v28 then
            ...
            let v33 : (int32 -> (US47 -> US51)) = method99(v32)
            let v34 : Vec<US47> = method100(v9)
            ...
            let v38 : (US51 -> US53) = closure137()
            let v39 : Vec<US53> = Fable.Core.RustInterop.emitRustExpr struct (v36, v38) v37 
            let v40 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
            let v41 : (US53 -> Result<Vec<struct (string * unativeint * Heap5)> option, std_string_String>) = closure138()
            ...
            while method101(v48, v50) do
                let v52 : int32 = v50.l0
                let v53 : US54 = v50.l1
                let v54 : Result<Vec<struct (string * unativeint * Heap5)> option, std_string_String> = v47.[int v52]
                let v55 : (Vec<struct (string * unativeint * Heap5)> option -> US53) = closure139()
                let v56 : (std_string_String -> US53) = closure140()
                ...
                let v87 : US51 =
                    ...
                    | US53_0(v58) -> (* Ok *)
                        ...
                        let _v59 = ref v59 
                        let v60 : US52 option ref = _v59 
                        let v61 : (US52 option -> US52 option ref) = closure141(v60)
                        let v62 : unit = ()
                        let v63 : (unit -> unit) = closure142(v58, v61)
                        let v64 : unit = (fun () -> v63 (); v62) ()
                        let v67 : US52 option = _v59.Value 
                        let v78 : US52 = US52_1
                        let v79 : US52 = v67 |> Option.defaultValue v78 
                        US51_0(v79)
                let v108 : US54 =
                    match v53 with
                    | US54_0(v88) -> (* Ok *)
                        ...
                        | US51_0(v89) -> (* Ok *)
                            match v89 with
                            | US52_0(v90) -> (* Some *)
                                let v91 : Vec<struct (string * unativeint * Heap5)> = method102(v90)
                                let v92 : Vec<struct (string * unativeint * Heap5)> = method103(v88)
                ...
                v50.l1 <- v108
                ()
            let v110 : US54 = v50.l1
            let v124 : US54 =
                match v110 with
                | US54_1(v121) -> (* Error *)
                    US54_1(v121)
                | US54_0(v111) -> (* Ok *)
                    let v112 : Vec<struct (string * unativeint * Heap5)> = method104(v111)
                    let v113 : (struct (string * unativeint * Heap5) -> std_string_String) = method105()
            ...
            let v139 : US55 =
                ...
                | US54_1(v136) -> (* Error *)
                    US55_1(v136)
                | US54_0(v125) -> (* Ok *)
                    let v126 : Vec<struct (string * unativeint * Heap5)> = method106(v125)
    ...
    v166
and closure145 () (v0 : (struct (string * unativeint * Heap5) []) option) : US56 =
    US56_0(v0)
and closure146 () (v0 : std_string_String) : US56 =
    US56_1(v0)
and closure147 (v0 : US50 option ref) (v1 : US50 option) : US50 option ref =
    v0.Value <- v1 
    v0
and closure148 (v0 : (struct (string * unativeint * Heap5) []) option, v1 : (US50 option -> US50 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    |> v1 |> ignore
    ()
and closure150 () (v0 : serde_json_Error) : std_string_String =
    let v1 : unit = ()
...
and method109 (v0 : Result<std_string_String, std_string_String>) : Result<std_string_String, std_string_String> =
    v0
and closure151 () (v0 : string) : struct (string * US25 * string * bool * bool) =
...
and method111 (v0 : Result<string, std_string_String>) : Result<string, std_string_String> =
    v0
and closure149 () struct (v0 : string, v1 : unativeint, v2 : Heap5) : Result<struct (string * US25 * string * bool * bool), std_string_String> =
    let v3 : string = "&*$0"
    let v4 : string = "2.0"
    ...
    v41
and closure144 (v0 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>) () : Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String> =
    let v1 : string = $"$0()"
    let v2 : Result<(struct (string * unativeint * Heap5) []) option, std_string_String> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : ((struct (string * unativeint * Heap5) []) option -> US56) = closure145()
    let v4 : (std_string_String -> US56) = closure146()
    ...
    let v35 : US49 =
        ...
        | US56_0(v6) -> (* Ok *)
            ...
            let _v7 = ref v7 
            let v8 : US50 option ref = _v7 
            let v9 : (US50 option -> US50 option ref) = closure147(v8)
            let v10 : unit = ()
            let v11 : (unit -> unit) = closure148(v6, v9)
            let v12 : unit = (fun () -> v11 (); v10) ()
            let v15 : US50 option = _v7.Value 
            let v26 : US50 = US50_1
            let v27 : US50 = v15 |> Option.defaultValue v26 
            US49_0(v27)
    let v57 : US57 =
        match v35 with
        | US49_1(v54) -> (* Error *)
        ...
        | US49_0(v36) -> (* Ok *)
            ...
            | US50_0(v37) -> (* Some *)
                ...
                let v40 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
                let v41 : (struct (string * unativeint * Heap5) -> Result<struct (string * US25 * string * bool * bool), std_string_String>) = closure149()
                let v42 : Vec<Result<struct (string * US25 * string * bool * bool), std_string_String>> = Fable.Core.RustInterop.emitRustExpr struct (v39, v41) v40 
                let v43 : string = "v42.into_iter().collect()"
                let v44 : Result<Vec<struct (string * US25 * string * bool * bool)>, std_string_String> = Fable.Core.RustInterop.emitRustExpr () v43 
                let v45 : string = "$0?"
                let v46 : Vec<struct (string * US25 * string * bool * bool)> = Fable.Core.RustInterop.emitRustExpr v44 v45 
                let v47 : string = "fable_library_rust::NativeArray_::array_from($0)"
                let v48 : (struct (string * US25 * string * bool * bool) []) = Fable.Core.RustInterop.emitRustExpr v46 v47 
                let v49 : US58 = US58_0(v48)
                US57_0(v49)
            | _ ->
                let v51 : US58 = US58_1
                US57_0(v51)
    let v70 : US59 =
        ...
        | US57_1(v67) -> (* Error *)
            US59_1(v67)
        | US57_0(v58) -> (* Ok *)
            let v65 : (struct (string * US25 * string * bool * bool) []) option =
                match v58 with
                | US58_1 -> (* None *)
                    let v63 : (struct (string * US25 * string * bool * bool) []) option = None
                    v63
                | US58_0(v59) -> (* Some *)
                    let v60 : (struct (string * US25 * string * bool * bool) []) option = Some v59 
                    v60
            US59_0(v65)
    let v76 : Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String> =
        match v70 with
        | US59_1(v73) -> (* Error *)
            let v74 : Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String> = Error v73 
            v74
        | US59_0(v71) -> (* Ok *)
            let v72 : Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String> = Ok v71 
            v72
    ...
    let v84 : bool = Fable.Core.RustInterop.emitRustExpr v82 v83 
    v76
and closure153 () (v0 : (struct (string * US25 * string * bool * bool) []) option) : US59 =
    US59_0(v0)
and closure154 () (v0 : std_string_String) : US59 =
    US59_1(v0)
and closure155 (v0 : US58 option ref) (v1 : US58 option) : US58 option ref =
    v0.Value <- v1 
    v0
and closure156 (v0 : (struct (string * US25 * string * bool * bool) []) option, v1 : (US58 option -> US58 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : (struct (string * US25 * string * bool * bool) []) = x
    let v3 : US58 = US58_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
    |> v1 |> ignore
    ()
and closure152 (v0 : leptos_Memo<Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String>>) () : Vec<struct (string * US25 * string * bool * bool)> =
    let v1 : string = $"$0()"
    let v2 : Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : ((struct (string * US25 * string * bool * bool) []) option -> US59) = closure153()
    let v4 : (std_string_String -> US59) = closure154()
    ...
    let v35 : US57 =
        ...
        | US59_0(v6) -> (* Ok *)
            ...
            let v9 : (US58 option -> US58 option ref) = closure155(v8)
            let v10 : unit = ()
            let v11 : (unit -> unit) = closure156(v6, v9)
            let v12 : unit = (fun () -> v11 (); v10) ()
            let v15 : US58 option = _v7.Value 
            let v26 : US58 = US58_1
            let v27 : US58 = v15 |> Option.defaultValue v26 
            US57_0(v27)
    let v41 : (struct (string * US25 * string * bool * bool) []) =
        match v35 with
        | US57_0(v36) -> (* Ok *)
            match v36 with
            | US58_0(v37) -> (* Some *)
    ...
    let v43 : Vec<struct (string * US25 * string * bool * bool)> = Fable.Core.RustInterop.emitRustExpr v41 v42 
    ...
    v43
and closure161 () (v0 : crate_model_near_rpc_TransferDetail) : struct (std_string_String * std_string_String option * float option * std_string_String option) =
    ...
    struct (v2, v4, v6, v8)
and closure160 () (v0 : std_collections_HashMap<std_string_String, crate_model_near_rpc_TransferDetail>) : std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> =
    let v1 : string = "$0.into_iter().map(|(k, v)| (k, $1(v))).collect()"
    let v2 : (crate_model_near_rpc_TransferDetail -> struct (std_string_String * std_string_String option * float option * std_string_String option)) = closure161()
    ...
    v3
and closure159 () (v0 : crate_model_near_rpc_Receipt) : struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) =
    ...
    let v10 : (std_collections_HashMap<std_string_String, crate_model_near_rpc_TransferDetail> -> std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)>) = closure160()
...
and closure163 () (v0 : crate_model_near_rpc_GasProfile) : struct (std_string_String * std_string_String * std_string_String) =
    ...
    let v6 : std_string_String = Fable.Core.RustInterop.emitRustExpr v0 v5 
    struct (v2, v4, v6)
and closure165 () (v0 : crate_model_near_rpc_Proof) : struct (std_string_String * std_string_String) =
    let v1 : string = "$0.direction"
    let v2 : std_string_String = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "$0.hash"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v0 v3 
    struct (v2, v4)
and closure164 () (v0 : Vec<crate_model_near_rpc_Proof>) : (struct (std_string_String * std_string_String) []) =
    let v1 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v2 : (crate_model_near_rpc_Proof -> struct (std_string_String * std_string_String)) = closure165()
    ...
    v5
and closure162 () (v0 : crate_model_near_rpc_ReceiptsOutcome) : struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) =
    ...
    let v19 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v20 : (crate_model_near_rpc_GasProfile -> struct (std_string_String * std_string_String * std_string_String)) = closure163()
    ...
    let v36 : (Vec<crate_model_near_rpc_Proof> -> (struct (std_string_String * std_string_String) [])) = closure164()
...
and closure158 () (v0 : crate_model_near_rpc_TransactionStatus) : struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) =
    let v1 : string = "$0.receipts"
    let v2 : Vec<crate_model_near_rpc_Receipt> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v4 : (crate_model_near_rpc_Receipt -> struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String)) = closure159()
    ...
    let v10 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v11 : (crate_model_near_rpc_ReceiptsOutcome -> struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) []))) = closure162()
    ...
    struct (v7, v14)
and closure167 () (v0 : crate_model_near_rpc_ErrorCauseInfo) : struct (std_string_String option * std_string_String option) =
    ...
    let v4 : std_string_String option = Fable.Core.RustInterop.emitRustExpr v0 v3 
    struct (v2, v4)
and closure166 () (v0 : crate_model_near_rpc_RpcError) : struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) =
    ...
    let v9 : (crate_model_near_rpc_ErrorCauseInfo -> struct (std_string_String option * std_string_String option)) = closure167()
...
and closure157 () (v0 : crate_model_near_rpc_RpcResponse) : struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) =
    ...
    let v5 : (crate_model_near_rpc_TransactionStatus -> struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) []))) = closure158()
    ...
    let v55 : (crate_model_near_rpc_RpcError -> struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String)) = closure166()
...
and closure171 () (v0 : crate_model_near_rpc_RpcResponse) : crate_model_near_rpc_RpcResponse option =
...
and method115 (v0 : Result<crate_model_near_rpc_RpcResponse, std_string_String>) : Result<crate_model_near_rpc_RpcResponse, std_string_String> =
    v0
and closure170 (v0 : US38, v1 : US44, v2 : int32) struct (v3 : string, v4 : US25, v5 : string, v6 : bool, v7 : bool) : Result<crate_model_near_rpc_RpcResponse option, std_string_String> =
    let v58 : US32 =
        match v0 with
        | US38_1 -> (* None *)
            US32_1
    ...
    | US34_0(v119) -> (* Some *)
        ...
        let v128 : (crate_model_near_rpc_RpcResponse -> crate_model_near_rpc_RpcResponse option) = method114()
        let v129 : Result<crate_model_near_rpc_RpcResponse, std_string_String> = method115(v127)
        let v130 : string = "v129.map(|x| v128(x))"
    ...
    | _ ->
        ...
        | US32_0(v132) -> (* Some *)
            ...
            | US33_0(v133) -> (* Ok *)
                ...
                | US34_0(v134) -> (* Some *)
                    ...
                    let v143 : (crate_model_near_rpc_RpcResponse -> crate_model_near_rpc_RpcResponse option) = method114()
                    let v144 : Result<crate_model_near_rpc_RpcResponse, std_string_String> = method115(v142)
                    let v145 : string = "v144.map(|x| v143(x))"
        ...
        | _ ->
            ...
            v172
and closure169 (v0 : US38, v1 : US44) (v2 : int32) : (struct (string * US25 * string * bool * bool) -> Result<crate_model_near_rpc_RpcResponse option, std_string_String>) =
    closure170(v0, v1, v2)
and method113 (v0 : US38, v1 : US44) : (int32 -> (struct (string * US25 * string * bool * bool) -> Result<crate_model_near_rpc_RpcResponse option, std_string_String>)) =
    closure169(v0, v1)
and closure168 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : leptos_Memo<Result<Vec<Heap4 option>, std_string_String> option>, v2 : leptos_Resource<struct (Vec<struct (string * US25 * string * bool * bool)> * Result<Vec<Heap4 option>, std_string_String> option), Result<Vec<string option>, std_string_String>>, v3 : leptos_Action<Heap4, Result<Vec<unit>, std_string_String>>) () : (Result<crate_model_near_rpc_RpcResponse option, std_string_String> []) =
    let v4 : string = $"$0()"
    let v5 : Vec<struct (string * US25 * string * bool * bool)> = Fable.Core.RustInterop.emitRustExpr v0 v4 
    let v6 : string = $"%A{v5}"
    let v9 : string = "state_core.use_requests (13) / result memo / requests: " + string v6 + ""
    ...
    | US44_0(v120) -> (* Ok *)
        ...
        let v123 : Vec<unit> = Fable.Core.RustInterop.emitRustExpr struct (v120, v122) v121 
        ()
    let v125 : (int32 -> (struct (string * US25 * string * bool * bool) -> Result<crate_model_near_rpc_RpcResponse option, std_string_String>)) = method113(v56, v119)
    let v126 : Vec<struct (string * US25 * string * bool * bool)> = method83(v5)
    let v127 : string = "v126.iter().enumerate().map(|(i, x)| v125(i.try_into().unwrap())(x.clone())).collect::<Vec<_>>()"
    let v128 : Vec<Result<crate_model_near_rpc_RpcResponse option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr () v127 
    let v129 : string = "fable_library_rust::NativeArray_::array_from($0)"
    let v130 : (Result<crate_model_near_rpc_RpcResponse option, std_string_String> []) = Fable.Core.RustInterop.emitRustExpr v128 v129 
    let v131 : string = $"%A{v130}"
    let v134 : string = "state_core.use_requests (18) / result_func func0 / result: " + string v131 + ""
    let v135 : int64 = 200L
    let v136 : string = method8(v135, v134)
...
and closure172 (v0 : (crate_model_near_rpc_RpcResponse -> struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option)), v1 : leptos_Resource<US2, rexie_Rexie>, v2 : leptos_Resource<struct (rexie_Rexie option * Vec<struct (string * US25 * string * bool * bool)>), Result<Vec<Heap4 option>, std_string_String>>, v3 : leptos_Memo<(Result<crate_model_near_rpc_RpcResponse option, std_string_String> [])>) () : Vec<Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>> =
    ...
    let v95 : bool = Fable.Core.RustInterop.emitRustExpr v93 v94 
    let v96 : string = $"$0()"
    let v97 : (Result<crate_model_near_rpc_RpcResponse option, std_string_String> []) = Fable.Core.RustInterop.emitRustExpr v3 v96 
    let v98 : string = "$0.to_vec()"
    let v99 : Vec<Result<crate_model_near_rpc_RpcResponse option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr v97 v98 
    let v100 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v101 : (Result<crate_model_near_rpc_RpcResponse option, std_string_String> -> Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>) = closure173(v0)
    let v102 : Vec<Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr struct (v99, v101) v100 
    let v103 : string = $"%A{v102}"
    let v106 : string = "state_core.use_requests (20) / result func0 / result: " + string v103 + ""
    let v107 : int64 = 200L
    let v108 : string = method8(v107, v106)
...
and method112 (v0 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>>, v1 : (crate_model_near_rpc_RpcResponse -> struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option))) : leptos_Memo<Vec<Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>>> =
    ...
    let v23 : leptos_Action<Heap4, Result<Vec<unit>, std_string_String>> = Fable.Core.RustInterop.emitRustExpr v22 v21 
    let v24 : string = "$0"
    let v25 : (unit -> (Result<crate_model_near_rpc_RpcResponse option, std_string_String> [])) = closure168(v0, v19, v20, v23)
...
and method118 () : string =
    ...
    v0
and closure178 () (v0 : US15) : US61 =
    US61_0(v0)
and closure179 () (v0 : std_string_String) : US61 =
    US61_1(v0)
and closure180 () (v0 : crate_model_near_rpc_RpcResponse) : US63 =
    US63_0(v0)
and closure181 () (v0 : std_string_String) : US63 =
    US63_1(v0)
and method119 (v0 : Result<US60, std_string_String>) : Result<US60, std_string_String> =
    v0
and closure177 () (v0 : Heap6) : std_pin_Pin<Box<Dyn<std_future_Future<Result<US60, std_string_String>>>>> =
    let v1 : string = $"%A{v0}"
    ...
    let v44 : std_string_String = method78(v43)
    ...
    let v49 : reqwest_RequestBuilder = method80(v48)
    ...
    let v54 : (reqwest_Error -> std_string_String) = method81()
    ...
    let v63 : (reqwest_Error -> std_string_String) = method81()
    ...
    let v78 : (US15 -> US61) = closure178()
    let v79 : (std_string_String -> US61) = closure179()
    let v80 : US61 = match v69 with Ok x -> v78 x | Error x -> v79 x
    let v277 : US62 =
        match v80 with
        | US61_0(v81) -> (* Ok *)
            match v81 with
            | US15_0(v82) -> (* Some *)
                ...
                let v90 : (serde_json_Error -> std_string_String) = method35()
                ...
                let v93 : (crate_model_near_rpc_RpcResponse -> US63) = closure180()
                let v94 : (std_string_String -> US63) = closure181()
                let v95 : US63 = match v92 with Ok x -> v93 x | Error x -> v94 x
                let v261 : US64 =
                    match v95 with
                    | US63_1(v258) -> (* Error *)
                        US64_1(v258)
                    | US63_0(v96) -> (* Ok *)
                        ...
                        let v101 : (crate_model_near_rpc_TransactionStatus -> struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) []))) = closure158()
                        ...
                        let v151 : (crate_model_near_rpc_RpcError -> struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String)) = closure166()
                        ...
                        US64_0(v98, v102, v152, v256)
                match v261 with
                | US64_1(v268) -> (* Error *)
                    US62_1(v268)
                | US64_0(v262, v263, v264, v265) -> (* Ok *)
                    let v266 : US60 = US60_0(v262, v263, v264, v265)
                    US62_0(v266)
            | _ ->
                let v272 : US60 = US60_1
                US62_0(v272)
        | _ ->
            let v275 : US60 = US60_1
            US62_0(v275)
    let v283 : Result<US60, std_string_String> =
        match v277 with
        | US62_1(v280) -> (* Error *)
            let v281 : Result<US60, std_string_String> = Error v280 
            v281
        | US62_0(v278) -> (* Ok *)
            let v279 : Result<US60, std_string_String> = Ok v278 
            v279
    ...
    let v292 : Result<US60, std_string_String> = method119(v283)
    let v293 : string = ""
    let v294 : string = "}"
    ...
    let v298 : string = "__result"
    let v299 : _ = Fable.Core.RustInterop.emitRustExpr () v298 
    let v300 : string = "v299"
    let v301 : std_pin_Pin<Box<Dyn<std_future_Future<Result<US60, std_string_String>>>>> = Fable.Core.RustInterop.emitRustExpr () v300 
    v301
and closure184 () (v0 : US60) : US62 =
    US62_0(v0)
and closure185 () (v0 : std_string_String) : US62 =
    US62_1(v0)
and closure183 () (v0 : Result<US60, std_string_String>) : US62 =
    let v1 : (US60 -> US62) = closure184()
    let v2 : (std_string_String -> US62) = closure185()
    let v3 : US62 = match v0 with Ok x -> v1 x | Error x -> v2 x
    v3
and closure186 (v0 : US65 option ref) (v1 : US65 option) : US65 option ref =
    v0.Value <- v1 
    v0
and closure187 (v0 : US62 option, v1 : (US65 option -> US65 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : US62 = x
    let v3 : US65 = US65_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
    |> v1 |> ignore
    ()
and closure182 (v0 : leptos_Action<Heap6, Result<US60, std_string_String>>) () : Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String> =
    ...
    let v5 : (Result<US60, std_string_String> -> US62) = closure183()
    let v6 : US62 option = v4 |> Option.map v5 
    let v31 : US65 option = None
    let _v31 = ref v31 
    let v32 : US65 option ref = _v31 
    let v33 : (US65 option -> US65 option ref) = closure186(v32)
    let v34 : unit = ()
    let v35 : (unit -> unit) = closure187(v6, v33)
    let v36 : unit = (fun () -> v35 (); v34) ()
    let v39 : US65 option = _v31.Value 
    let v50 : US65 = US65_1
    let v51 : US65 = v39 |> Option.defaultValue v50 
    let v72 : US62 =
        match v51 with
        | US65_0(v55) -> (* Some *)
            match v55 with
            ...
            | US62_0(v58) -> (* Ok *)
                ...
                | US60_0(v59, v60, v61, v62) -> (* Some *)
                    let v63 : US60 = US60_0(v59, v60, v61, v62)
                    US62_0(v63)
                | _ ->
                    let v65 : US60 = US60_1
                    US62_0(v65)
...
and closure189 () (v0 : struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option) : US66 =
    US66_0(v0)
and closure190 () (v0 : std_string_String) : US66 =
    US66_1(v0)
and closure191 (v0 : US60 option ref) (v1 : US60 option) : US60 option ref =
    v0.Value <- v1 
    v0
and closure192 (v0 : struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, v1 : (US60 option -> US60 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    let v6 : US60 = US60_0(v2, v3, v4, v5)
    v6 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
    |> v1 |> ignore
    ()
and closure193 (v0 : US67 option ref) (v1 : US67 option) : US67 option ref =
    v0.Value <- v1 
    v0
and closure194 (v0 : struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option, v1 : (US67 option -> US67 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    ...
    let v8 : US67 = US67_0(v2, v3, v4, v5, v6, v7)
    v8 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
    |> v1 |> ignore
    ()
and closure188 (v0 : leptos_Memo<Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>>) () : string option =
    let v1 : string = $"$0()"
    ...
    let v3 : (struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option -> US66) = closure189()
    let v4 : (std_string_String -> US66) = closure190()
    ...
    let v41 : US62 =
        ...
        | US66_0(v6) -> (* Ok *)
            ...
            let _v7 = ref v7 
            let v8 : US60 option ref = _v7 
            let v9 : (US60 option -> US60 option ref) = closure191(v8)
            let v10 : unit = ()
            let v11 : (unit -> unit) = closure192(v6, v9)
            let v12 : unit = (fun () -> v11 (); v10) ()
            let v18 : US60 option = _v7.Value 
            let v32 : US60 = US60_1
            let v33 : US60 = v18 |> Option.defaultValue v32 
            US62_0(v33)
    let v94 : US34 =
        match v41 with
        | US62_0(v42) -> (* Ok *)
            match v42 with
            | US60_0(v43, v44, v45, v46) -> (* Some *)
                let v47 : US67 option = None
                let _v47 = ref v47 
                let v48 : US67 option ref = _v47 
                let v49 : (US67 option -> US67 option ref) = closure193(v48)
                let v50 : unit = ()
                let v51 : (unit -> unit) = closure194(v45, v49)
                let v52 : unit = (fun () -> v51 (); v50) ()
                let v60 : US67 option = _v47.Value 
                let v76 : US67 = US67_1
                let v77 : US67 = v60 |> Option.defaultValue v76 
                match v77 with
                | US67_0(v81, v82, v83, v84, v85, v86) -> (* Some *)
...
and closure195 (v0 : Heap2) () : US34 =
    ...
    let v10 : (US15 option -> US15 option ref) = closure37(v9)
    let v11 : unit = ()
    let v12 : (unit -> unit) = closure38(v7, v10)
    let v13 : unit = (fun () -> v12 (); v11) ()
    ...
    | US15_0(v32) -> (* Some *)
        ...
        US34_0(v34)
and closure198 (v0 : int32) (v1 : std_string_String) : (int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>)) =
    ...
    v5
and closure197 () (v0 : int32) : (std_string_String -> (int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>))) =
    closure198(v0)
...
and method121 (v0 : Vec<std_string_String>) : Vec<std_string_String> =
    v0
and closure196 (v0 : Heap2) () : Vec<(int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>))> =
    let v1 : leptos_RwSignal<Heap1> = v0.l0
    let v2 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v3 : Heap1 = Fable.Core.RustInterop.emitRustExpr v1 v2 
    let v4 : leptos_RwSignal<Heap0> = v3.l3
    ...
    v21
and closure200 () (v0 : (int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>))) : struct (int32 * leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>) =
    let (a, b) = v0 
    let v1 : int32 = a
    let struct (v2 : leptos_ReadSignal<std_string_String>, v3 : leptos_WriteSignal<std_string_String>) = b
    struct (v1, v2, v3)
and closure201 () struct (v0 : int32, v1 : leptos_ReadSignal<std_string_String>, v2 : leptos_WriteSignal<std_string_String>) : struct (int32 * leptos_ReadSignal<std_string_String>) =
    struct (v0, v1)
and closure199 (v0 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>))>>) () : Vec<struct (int32 * leptos_ReadSignal<std_string_String>)> =
    let v1 : string = $"$0()"
    ...
    let v3 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v4 : ((int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>)) -> struct (int32 * leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>)) = closure200()
    ...
    let v7 : (struct (int32 * leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>) -> struct (int32 * leptos_ReadSignal<std_string_String>)) = closure201()
...
and method122 (v0 : (leptos_View [])) : (leptos_View []) =
    v0
and closure207 (v0 : US68 option ref) (v1 : US68 option) : US68 option ref =
    v0.Value <- v1 
    v0
and closure208 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : (US68 option -> US68 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and method132 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    v0
and closure213 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
...
and method133 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure213(v0)
and closure214 () (v0 : leptos_HtmlElement<leptos_svg_Path>) : leptos_View =
...
and closure211 () () : leptos_Fragment =
    ...
    let v18 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v19 : (leptos_HtmlElement<leptos_svg_Path> -> leptos_View) = closure214()
...
and method135 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>>) : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> =
    v0
and closure216 () struct (v0 : int32, v1 : leptos_ReadSignal<std_string_String>) : int32 =
    v0
and method136 () : (struct (int32 * leptos_ReadSignal<std_string_String>) -> int32) =
    closure216()
and method138 (v0 : std_string_String) : std_string_String =
    v0
and closure218 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2, v3 : int32, v4 : std_string_String) () : unit =
    let v5 : string = "fable_library_rust::String_::fromString($0)"
    let v6 : string = Fable.Core.RustInterop.emitRustExpr v4 v5 
    ...
    ()
and closure220 (v0 : US70 option ref) (v1 : US70 option) : US70 option ref =
    v0.Value <- v1 
    v0
and closure221 (v0 : leptos_Memo<US34> option, v1 : (US70 option -> US70 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : leptos_Memo<US34> = x
    let v3 : US70 = US70_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
...
and method140 () : (unit -> leptos_Fragment) =
    closure223()
and closure219 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2, v3 : std_string_String) () : leptos_Fragment =
    ...
    let _v6 = ref v6 
    let v7 : US70 option ref = _v6 
    let v8 : (US70 option -> US70 option ref) = closure220(v7)
    let v9 : unit = ()
    let v10 : (unit -> unit) = closure221(v1, v8)
    let v11 : unit = (fun () -> v10 (); v9) ()
    let v14 : US70 option = _v6.Value 
    let v25 : US70 = US70_1
    let v26 : US70 = v14 |> Option.defaultValue v25 
    let v36 : US45 =
        match v26 with
        | US70_1 -> (* None *)
            US45_1
        | US70_0(v30) -> (* Some *)
            let v31 : string = $"$0()"
            let v32 : US34 = Fable.Core.RustInterop.emitRustExpr v30 v31 
            US45_0(v32)
    let v43 : US34 =
        match v36 with
        | US45_0(v37) -> (* Some *)
    ...
    let v81 : leptos_View =
        ...
        | US34_0(v44) -> (* Some *)
            ...
            if v45 then
                let v46 : string = "$0"
                let v47 : (unit -> string) = closure222()
                ...
                let v55 : (unit -> leptos_Fragment) = method140()
                let v56 : string = ""
                ...
                let v63 : (unit -> leptos_Fragment) = method132(v55)
...
and closure225 () (v0 : leptos_HtmlElement<leptos_html_Button>) : leptos_View =
    let v1 : string = "leptos::IntoView::into_view($0)"
    let v2 : leptos_View = Fable.Core.RustInterop.emitRustExpr v0 v1 
    v2
and closure217 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) struct (v3 : int32, v4 : leptos_ReadSignal<std_string_String>) : leptos_Fragment =
    let v5 : string = $"leptos::SignalGet::get(&$0)"
    let v6 : std_string_String = Fable.Core.RustInterop.emitRustExpr v4 v5 
    let v7 : std_string_String = method138(v6)
    let v8 : (unit -> unit) = closure218(v0, v1, v2, v3, v6)
    ...
    let v29 : (leptos_HtmlElement<leptos_html_Button> -> leptos_View) = closure225()
...
and method137 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) : (struct (int32 * leptos_ReadSignal<std_string_String>) -> leptos_Fragment) =
    closure217(v0, v1, v2)
and closure206 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) () : leptos_Fragment =
    let v3 : US68 option = None
    let _v3 = ref v3 
    let v4 : US68 option ref = _v3 
    let v5 : (US68 option -> US68 option ref) = closure207(v4)
    let v6 : unit = ()
    let v7 : (unit -> unit) = closure208(v0, v5)
    ...
    if v43 then
        ...
        let v45 : (unit -> leptos_Fragment) = method128()
        let v46 : string = ""
        let v47 : string = " " + v44 + v46 + ""
        let v48 : (unit -> leptos_Fragment) = method132(v45)
        let v49 : (unit -> leptos_Fragment) = method133(v48)
        let v50 : string = "div"
        ...
        let v62 : US68 option = None
        let _v62 = ref v62 
        let v63 : US68 option ref = _v62 
        let v64 : (US68 option -> US68 option ref) = closure207(v63)
        let v65 : unit = ()
        let v66 : (unit -> unit) = closure208(v0, v64)
        let v67 : unit = (fun () -> v66 (); v65) ()
        let v70 : US68 option = _v62.Value 
        let v81 : US68 = US68_1
        let v82 : US68 = v70 |> Option.defaultValue v81 
        match v82 with
        | US68_1 -> (* None *)
            ...
            v112
        | US68_0(v86) -> (* Some *)
            let v87 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> = method135(v86)
            let v88 : (struct (int32 * leptos_ReadSignal<std_string_String>) -> int32) = method136()
            let v89 : (struct (int32 * leptos_ReadSignal<std_string_String>) -> leptos_Fragment) = method137(v0, v1, v2)
...
and method127 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) : (unit -> leptos_Fragment) =
    closure206(v0, v1, v2)
and closure205 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) () : leptos_Fragment =
...
and method126 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) : (unit -> leptos_Fragment) =
    closure205(v0, v1, v2)
and closure226 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "Func0::new(move || $0())"
    let v2 : Func0<leptos_Fragment> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "leptos::IntoView::into_view(move || $0())"
    let v4 : leptos_View = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and method142 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure226(v0)
and closure228 () () : string =
    let v0 : string = "[align-self:flex-start]"
    v0
and closure229 () () : bool =
    false
and closure230 (v0 : leptos_View) () : leptos_Fragment =
...
and method144 (v0 : leptos_View) : (unit -> leptos_Fragment) =
    closure230(v0)
and closure232 () () : string =
    let v0 : string = "py-[4px]"
    v0
and closure233 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) () : Ref<Lifetime<StaticLifetime, Str>> =
    let v3 : string = ""
    let v4 : string = "r#\"" + v3 + "\"#"
    let v5 : Ref<Lifetime<StaticLifetime, Str>> = Fable.Core.RustInterop.emitRustExpr () v4 
    v5
and closure236 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) () : string =
    let v3 : US70 option = None
    let _v3 = ref v3 
    let v4 : US70 option ref = _v3 
    let v5 : (US70 option -> US70 option ref) = closure220(v4)
    let v6 : unit = ()
    let v7 : (unit -> unit) = closure221(v1, v5)
    let v8 : unit = (fun () -> v7 (); v6) ()
    let v11 : US70 option = _v3.Value 
    let v22 : US70 = US70_1
    let v23 : US70 = v11 |> Option.defaultValue v22 
    let v33 : US45 =
        match v23 with
        | US70_1 -> (* None *)
            US45_1
        | US70_0(v27) -> (* Some *)
            let v28 : string = $"$0()"
            let v29 : US34 = Fable.Core.RustInterop.emitRustExpr v27 v28 
            US45_0(v29)
    let v40 : US34 =
        match v33 with
        | US45_0(v34) -> (* Some *)
...
and method148 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) : (unit -> string) =
    closure236(v0, v1, v2)
and closure237 (v0 : (unit -> string)) () : leptos_Fragment =
    let v1 : string = v0 ()
    let v2 : string = "&*$0"
...
and method149 (v0 : (unit -> string)) : (unit -> leptos_Fragment) =
    closure237(v0)
and closure235 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) () : leptos_Fragment =
...
and method150 () : (unit -> leptos_Fragment) =
    closure238()
and closure234 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) () : leptos_Fragment =
...
and method146 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2) : (unit -> leptos_Fragment) =
    closure234(v0, v1, v2)
and closure241 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    v0 ()
and method152 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure241(v0)
and closure231 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2, v3 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v4 : string = "$0"
    let v5 : (unit -> string) = closure232()
    let v6 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v5 v4 
    let v7 : string = "$0"
    let v8 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure233(v0, v1, v2)
...
and closure227 (v0 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>> option, v1 : leptos_Memo<US34> option, v2 : Heap2, v3 : leptos_View, v4 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v5 : string = "$0"
    let v6 : (unit -> string) = closure228()
    let v7 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v6 v5 
    let v8 : string = "$0"
    let v9 : (unit -> bool) = closure229()
...
and closure204 (v0 : Heap2, v1 : leptos_Memo<US34>, v2 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>>) () : leptos_Fragment =
    let v3 : string = "&*$0"
...
and method154 (v0 : Heap2) : (unit -> int32) =
    closure243(v0)
and closure244 (v0 : Heap2) (v1 : std_string_String) : unit =
    let v2 : leptos_RwSignal<Heap1> = v0.l0
    let v3 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v4 : Heap1 = Fable.Core.RustInterop.emitRustExpr v2 v3 
    let v5 : leptos_RwSignal<Heap0> = v4.l3
...
and closure245 () () : string =
    let v0 : string = ""
    v0
and closure242 (v0 : Heap2) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : string = "Max"
...
and method153 (v0 : Heap2) : (unit -> leptos_Fragment) =
    closure242(v0)
and closure247 (v0 : leptos_Action<Heap6, Result<US60, std_string_String>>) () : bool =
...
and method157 (v0 : Func0<bool>) : Func0<bool> =
    v0
and closure248 (v0 : Heap2, v1 : leptos_Action<Heap6, Result<US60, std_string_String>>) () : unit =
    let v2 : leptos_RwSignal<Heap1> = v0.l0
    let v3 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v4 : Heap1 = Fable.Core.RustInterop.emitRustExpr v2 v3 
    let v5 : leptos_RwSignal<Heap0> = v4.l3
...
and method163 () : (unit -> leptos_Fragment) =
    closure255()
and closure256 () (v0 : leptos_HtmlElement<leptos_svg_Rect>) : leptos_View =
    let v1 : string = "leptos::IntoView::into_view($0)"
    let v2 : leptos_View = Fable.Core.RustInterop.emitRustExpr v0 v1 
    v2
and closure251 () () : leptos_Fragment =
    ...
    let v63 : (leptos_HtmlElement<leptos_svg_Rect> -> leptos_View) = closure256()
...
and method159 () : (unit -> leptos_Fragment) =
    closure251()
and closure249 (v0 : Func0<bool>) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : string = "Roll"
    let v3 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v2 v1 
    let v4 : string = "String::from($0)"
    ...
    let v48 : leptos_View =
        if v11 then
            let v12 : string = "$0"
            let v13 : (unit -> string) = closure250()
            let v14 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v13 v12 
...
and method158 (v0 : Func0<bool>) : (unit -> leptos_Fragment) =
    closure249(v0)
and closure258 (v0 : string) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and method165 (v0 : string) : (unit -> leptos_Fragment) =
    closure258(v0)
and closure257 (v0 : string) () : leptos_Fragment =
...
and method164 (v0 : string) : (unit -> leptos_Fragment) =
    closure257(v0)
and closure246 (v0 : Heap2, v1 : leptos_Action<Heap6, Result<US60, std_string_String>>, v2 : leptos_Memo<string option>) () : leptos_Fragment =
    let v3 : string = "Func0::new(move || $0())"
    let v4 : (unit -> bool) = closure247(v1)
    let v5 : Func0<bool> = Fable.Core.RustInterop.emitRustExpr v4 v3 
    let v6 : Func0<bool> = method157(v5)
    let v7 : (unit -> unit) = closure248(v0, v1)
    ...
    let _v28 = ref v28 
    let v29 : US34 option ref = _v28 
    let v30 : (US34 option -> US34 option ref) = closure112(v29)
    let v31 : unit = ()
    let v32 : (unit -> unit) = closure113(v27, v30)
    let v33 : unit = (fun () -> v32 (); v31) ()
    let v36 : US34 option = _v28.Value 
    let v47 : US34 = US34_1
    let v48 : US34 = v36 |> Option.defaultValue v47 
    let v69 : leptos_View =
        match v48 with
        | US34_0(v52) -> (* Some *)
            let v53 : string = "class=\"flex flex-1 items-center [gap:4px] [padding:5px]\""
            let v54 : (unit -> leptos_Fragment) = method164(v52)
            let v55 : string = " " + v53 + v13 + ""
            let v56 : (unit -> leptos_Fragment) = method132(v54)
            let v57 : (unit -> leptos_Fragment) = method133(v56)
            let v58 : string = "div"
        ...
        | _ ->
            let v65 : (leptos_View []) = [||]
            let v66 : (leptos_View []) = method122(v65)
...
and method156 (v0 : Heap2, v1 : leptos_Action<Heap6, Result<US60, std_string_String>>, v2 : leptos_Memo<string option>) : (unit -> leptos_Fragment) =
    closure246(v0, v1, v2)
and closure203 (v0 : Heap2, v1 : leptos_Action<Heap6, Result<US60, std_string_String>>, v2 : leptos_Memo<string option>, v3 : leptos_Memo<US34>, v4 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>>) () : leptos_Fragment =
...
and closure259 () (v0 : leptos_HtmlElement<leptos_html_Div>) : leptos_View =
    ...
    let v2 : leptos_View = Fable.Core.RustInterop.emitRustExpr v0 v1 
    v2
and closure202 (v0 : Heap2, v1 : leptos_Action<Heap6, Result<US60, std_string_String>>, v2 : leptos_Memo<string option>, v3 : leptos_Memo<US34>, v4 : leptos_Memo<Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>>) () : leptos_Fragment =
    ...
    let v19 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v20 : (leptos_HtmlElement<leptos_html_Div> -> leptos_View) = closure259()
...
and closure264 () () : string =
    ...
    v0
and closure265 () () : Ref<Lifetime<StaticLifetime, Str>> =
    let v0 : string = ""
    let v1 : string = "r#\"" + v0 + "\"#"
...
and closure263 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "$0"
    let v2 : (unit -> string) = closure264()
    let v3 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v2 v1 
    let v4 : string = "$0"
    let v5 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure265()
...
and method167 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure263(v0)
and closure260 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
    let v6 : (unit -> bool) = closure262()
...
and method172 () : (unit -> leptos_Fragment) =
    closure270()
and closure273 () struct (v0 : std_string_String, v1 : std_string_String option) : struct (string * US34) =
    ...
    let v6 : (US15 option -> US15 option ref) = closure37(v5)
    let v7 : unit = ()
    let v8 : (unit -> unit) = closure38(v1, v6)
    ...
    let v34 : US34 =
        ...
        | US15_0(v28) -> (* Some *)
            ...
            US34_0(v30)
    struct (v3, v34)
and closure274 () struct (v0 : string, v1 : US34) : bool =
...
and method176 (v0 : Vec<struct (string * US34)>) : Vec<struct (string * US34)> =
    v0
and closure272 () struct (v0 : string, v1 : unativeint, v2 : Heap5) : bool =
    ...
    let v6 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v7 : (struct (std_string_String * std_string_String option) -> struct (string * US34)) = closure273()
...
and method187 (v0 : int64) : int64 =
    v0
and closure285 (v0 : US71 option ref) (v1 : US71 option) : US71 option ref =
    v0.Value <- v1 
    v0
and closure286 (v0 : chrono_DateTime<chrono_Utc> option, v1 : (US71 option -> US71 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
    let v2 : chrono_DateTime<chrono_Utc> = x
    let v3 : US71 = US71_0(v2)
    v3 
    )
    |> fun x -> x () |> Some
    ) () ) | None -> None
...
and closure284 (v0 : Heap5) () : leptos_Fragment =
    ...
    let v10 : US71 option = None
    let _v10 = ref v10 
    let v11 : US71 option ref = _v10 
    let v12 : (US71 option -> US71 option ref) = closure285(v11)
    let v13 : unit = ()
    let v14 : (unit -> unit) = closure286(v9, v12)
    let v15 : unit = (fun () -> v14 (); v13) ()
    let v18 : US71 option = _v10.Value 
    let v29 : US71 = US71_1
    let v30 : US71 = v18 |> Option.defaultValue v29 
    let v49 : US34 =
        match v30 with
        | US71_1 -> (* None *)
            US34_1
...
and method191 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure290(v0)
and closure291 (v0 : Heap5, v1 : Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>) () : leptos_Fragment =
    let v2 : bool = v0.l9
    let v5 : string =
        if v2 then
            let v3 : string = "Ok"
    ...
    let v7 : (std_string_String -> US66) = closure190()
    ...
    let v44 : US62 =
        ...
        | US66_0(v9) -> (* Ok *)
            ...
            let _v10 = ref v10 
            let v11 : US60 option ref = _v10 
            let v12 : (US60 option -> US60 option ref) = closure191(v11)
            let v13 : unit = ()
            let v14 : (unit -> unit) = closure192(v9, v12)
            let v15 : unit = (fun () -> v14 (); v13) ()
            let v21 : US60 option = _v10.Value 
            let v35 : US60 = US60_1
            let v36 : US60 = v21 |> Option.defaultValue v35 
            US62_0(v36)
    let v164 : US72 =
        match v44 with
        | US62_1(v159) -> (* Error *)
        ...
        | US62_0(v45) -> (* Ok *)
            match v45 with
            | US60_0(v46, v47, v48, v49) -> (* Some *)
                let v50 : US67 option = None
                let _v50 = ref v50 
                let v51 : US67 option ref = _v50 
                let v52 : (US67 option -> US67 option ref) = closure193(v51)
                let v53 : unit = ()
                let v54 : (unit -> unit) = closure194(v48, v52)
                let v55 : unit = (fun () -> v54 (); v53) ()
                let v63 : US67 option = _v50.Value 
                let v79 : US67 = US67_1
                let v80 : US67 = v63 |> Option.defaultValue v79 
                match v80 with
                | US67_1 -> (* None *)
                    ...
                    US72_0(v147)
                | US67_0(v84, v85, v86, v87, v88, v89) -> (* Some *)
                    let v90 : US67 option = None
                    let _v90 = ref v90 
                    let v91 : US67 option ref = _v90 
                    let v92 : (US67 option -> US67 option ref) = closure193(v91)
                    let v93 : unit = ()
                    let v94 : (unit -> unit) = closure194(v48, v92)
                    let v95 : unit = (fun () -> v94 (); v93) ()
                    let v103 : US67 option = _v90.Value 
                    let v119 : US67 = US67_1
                    let v120 : US67 = v103 |> Option.defaultValue v119 
                    let v133 : US34 =
                        match v120 with
                        | US67_0(v124, v125, v126, v127, v128, v129) -> (* Some *)
...
and method193 (v0 : Heap5, v1 : Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>) : (unit -> leptos_Fragment) =
    closure291(v0, v1)
and closure283 (v0 : Heap5, v1 : Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>) () : leptos_Fragment =
...
and method185 (v0 : Heap5, v1 : Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>) : (unit -> leptos_Fragment) =
    closure283(v0, v1)
and closure282 (v0 : Vec<Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>>) struct (v1 : string, v2 : unativeint, v3 : Heap5) : leptos_View =
    let v4 : string = "fable_library_rust::NativeArray_::array_from($0)"
    let v5 : (Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String> []) = Fable.Core.RustInterop.emitRustExpr v0 v4 
    ...
    let v21 : leptos_View = Fable.Core.RustInterop.emitRustExpr v19 v20 
    v21
and closure293 (v0 : leptos_Fragment) () : leptos_Fragment =
    v0
and method195 (v0 : leptos_Fragment) : (unit -> leptos_Fragment) =
    closure293(v0)
and closure294 (v0 : leptos_Fragment) () : leptos_Fragment =
    v0
and method196 (v0 : leptos_Fragment) : (unit -> leptos_Fragment) =
    closure294(v0)
and closure292 (v0 : leptos_Fragment, v1 : leptos_Fragment) () : leptos_Fragment =
...
and method197 () : (unit -> leptos_Fragment) =
    closure295()
and closure269 (v0 : leptos_Memo<Vec<Result<struct (std_string_String * struct ((struct (std_string_String * (std_collections_HashMap<std_string_String, struct (std_string_String * std_string_String option * float option * std_string_String option)> []) * std_string_String * (std_string_String []) * (std_string_String []) * std_string_String * std_string_String * std_string_String * std_string_String) []) * (struct (std_string_String * std_string_String * std_string_String * uint64 * (std_string_String []) * (struct (std_string_String * std_string_String * std_string_String) []) * uint8 * (std_string_String []) * std_collections_HashMap<std_string_String, std_string_String> * std_string_String option * (struct (std_string_String * std_string_String) [])) [])) option * struct (std_string_String * std_string_String * struct (std_string_String option * std_string_String option) option * int32 * std_string_String * std_string_String) option * std_string_String option) option, std_string_String>>>, v1 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>, v2 : leptos_Memo<Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>>) () : leptos_Fragment =
    let v3 : string = $"$0()"
    ...
    let v136 : leptos_View =
        if v8 then
            ...
            let v24 : ((struct (string * unativeint * Heap5) []) option -> US56) = closure145()
            let v25 : (std_string_String -> US56) = closure146()
            ...
            let v56 : US49 =
                ...
                | US56_0(v27) -> (* Ok *)
                    ...
                    let _v28 = ref v28 
                    let v29 : US50 option ref = _v28 
                    let v30 : (US50 option -> US50 option ref) = closure147(v29)
                    let v31 : unit = ()
                    let v32 : (unit -> unit) = closure148(v27, v30)
                    let v33 : unit = (fun () -> v32 (); v31) ()
                    let v36 : US50 option = _v28.Value 
                    let v47 : US50 = US50_1
                    let v48 : US50 = v36 |> Option.defaultValue v47 
                    US49_0(v48)
            match v56 with
            | US49_1(v118) -> (* Error *)
                ...
                let v122 : (unit -> leptos_Fragment) = method164(v120)
                let v123 : string = ""
                let v124 : string = " " + v121 + v123 + ""
                let v125 : (unit -> leptos_Fragment) = method132(v122)
                let v126 : (unit -> leptos_Fragment) = method133(v125)
                let v127 : string = "div"
            ...
            | US49_0(v57) -> (* Ok *)
                ...
                | US50_0(v58) -> (* Some *)
                    ...
                    let v61 : (struct (string * unativeint * Heap5) -> bool) = method174()
                    let v62 : Vec<struct (string * unativeint * Heap5)> = method177(v60)
                    ...
                    let v65 : (unit -> leptos_Fragment) = method178()
                    let v66 : (unit -> leptos_Fragment) = method132(v65)
                    let v67 : (unit -> leptos_Fragment) = method133(v66)
                    let v68 : string = "tr"
                    let v69 : string = ""
                    ...
                    let v84 : (struct (string * unativeint * Heap5) -> leptos_View) = closure282(v82)
                    ...
                    let v93 : (unit -> leptos_Fragment) = method194(v80, v91)
                ...
                | _ ->
                    ...
                    let v105 : (unit -> leptos_Fragment) = method197()
                    let v106 : string = ""
                    let v107 : string = " " + v104 + v106 + ""
                    let v108 : (unit -> leptos_Fragment) = method132(v105)
...
and closure300 () () : string =
    let v0 : string = "py-[7px]"
    v0
and closure301 () () : Ref<Lifetime<StaticLifetime, Str>> =
    let v0 : string = ""
    let v1 : string = "r#\"" + v0 + "\"#"
    let v2 : Ref<Lifetime<StaticLifetime, Str>> = Fable.Core.RustInterop.emitRustExpr () v1 
    v2
...
and method201 () : (unit -> leptos_Fragment) =
    closure302()
and closure299 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "$0"
    let v2 : (unit -> string) = closure300()
    let v3 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v2 v1 
    let v4 : string = "$0"
    let v5 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure301()
    let v6 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = Fable.Core.RustInterop.emitRustExpr v5 v4 
    let v7 : string = "class=move || \"flex flex-1 items-center justify-between px-4 cursor-pointer text-gray-600 hover:text-gray-700 bg-gray-300 hover:bg-gray-200 \".to_owned() + v6(()) + \" \" + &v3(())"
...
and method200 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure299(v0)
and closure298 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
...
and method199 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure298(v0, v1)
and closure307 (v0 : int32) (v1 : (bool * std_string_String)) : (int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>)) =
    let v2 : string = $"leptos::create_signal($0)"
    ...
    v5
and closure306 () (v0 : int32) : ((bool * std_string_String) -> (int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))) =
    closure307(v0)
...
and method205 (v0 : Vec<(bool * std_string_String)>) : Vec<(bool * std_string_String)> =
    v0
and closure305 (v0 : Heap2) () : Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))> =
    let v1 : leptos_RwSignal<Heap1> = v0.l0
    let v2 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v3 : Heap1 = Fable.Core.RustInterop.emitRustExpr v1 v2 
    let v4 : leptos_RwSignal<Heap0> = v3.l3
    ...
    v11
and closure309 () (v0 : (int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))) : struct (int32 * leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>) =
    let (a, b) = v0 
    let v1 : int32 = a
    let struct (v2 : leptos_ReadSignal<(bool * std_string_String)>, v3 : leptos_WriteSignal<(bool * std_string_String)>) = b
    struct (v1, v2, v3)
and closure310 (v0 : int32) struct (v1 : int32, v2 : leptos_ReadSignal<(bool * std_string_String)>, v3 : leptos_WriteSignal<(bool * std_string_String)>) : struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>) =
    struct (v0, v1, v2)
and closure308 (v0 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v1 : leptos_ReadSignal<int32>) () : Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)> =
    let v2 : string = $"leptos::SignalGet::get(&$0)"
    ...
    let v6 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v7 : ((int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>)) -> struct (int32 * leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>)) = closure309()
    ...
    let v9 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v10 : (struct (int32 * leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>) -> struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)) = closure310(v3)
    ...
    v11
and closure311 (v0 : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>>) () : int32 =
    let v1 : string = $"$0()"
...
and method207 (v0 : Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>) : Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))> =
    v0
and closure315 () (v0 : (int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))) : (bool * std_string_String) =
    let (a, b) = v0 
    let v1 : int32 = a
    let struct (v2 : leptos_ReadSignal<(bool * std_string_String)>, v3 : leptos_WriteSignal<(bool * std_string_String)>) = b
    let v10 : string = $"leptos::SignalGet::get(&$0)"
    ...
    v11
and closure314 (v0 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>) (v1 : Heap0) : Heap0 =
    ...
    let v31 : ((int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>)) -> (bool * std_string_String)) = closure315()
...
and closure316 () (v0 : int32) : int32 =
    let v1 : int32 = 1 + v0
    v1
and closure313 (v0 : Heap2, v1 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v2 : leptos_WriteSignal<int32>) () : unit =
    ...
    let v8 : (Heap0 -> Heap0) = closure314(v1)
    ...
    let v11 : (int32 -> int32) = closure316()
    let v12 : bool = Fable.Core.RustInterop.emitRustExpr struct (v2, v11) v10 
    ()
and closure312 (v0 : Heap2, v1 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v2 : leptos_WriteSignal<int32>) () : unit =
    let v3 : string = "true; leptos::batch(move || $0());"
    let v4 : (unit -> unit) = closure313(v0, v1, v2)
...
and method208 () : (unit -> leptos_Fragment) =
    closure318()
and closure319 () () : std_string_String =
    let v0 : string = "&*$0"
    ...
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
    v4
and closure320 (v0 : leptos_HtmlElement<leptos_svg_Svg>) () : leptos_Fragment =
    let v1 : string = "leptos::IntoView::into_view($0)"
    let v2 : leptos_View = Fable.Core.RustInterop.emitRustExpr v0 v1 
...
and method212 (v0 : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>>) : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>> =
    v0
and closure323 () struct (v0 : int32, v1 : int32, v2 : leptos_ReadSignal<(bool * std_string_String)>) : struct (int32 * int32) =
    struct (v0, v1)
and method213 () : (struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>) -> struct (int32 * int32)) =
    closure323()
and method216 (v0 : int32) : int32 =
    v0
and closure326 (v0 : int32) () : std_string_String =
...
and method219 (v0 : bool) : bool =
    ...
    v1
and closure330 (v0 : int32, v1 : int32) (v2 : (bool * std_string_String)) : (bool * std_string_String) =
    let v3 : bool = v1 = v0
    ...
    if v4 then
        ...
        v12
and closure329 (v0 : int32) (v1 : int32) : ((bool * std_string_String) -> (bool * std_string_String)) =
    closure330(v0, v1)
and method218 (v0 : int32) : (int32 -> ((bool * std_string_String) -> (bool * std_string_String))) =
    closure329(v0)
and closure328 (v0 : Heap2, v1 : int32) (v2 : leptos_ev_Event) : unit =
    let v3 : leptos_RwSignal<Heap1> = v0.l0
    let v4 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v5 : Heap1 = Fable.Core.RustInterop.emitRustExpr v3 v4 
    let v6 : leptos_RwSignal<Heap0> = v5.l3
    ...
    ()
and closure331 (v0 : leptos_ReadSignal<(bool * std_string_String)>) () : bool =
    let v1 : string = $"leptos::SignalGet::get(&$0)"
...
and method224 () : (unit -> leptos_Fragment) =
    closure334()
and closure335 () (v0 : leptos_HtmlElement<leptos_svg_Svg>) : leptos_View =
    let v1 : string = "leptos::IntoView::into_view($0)"
    let v2 : leptos_View = Fable.Core.RustInterop.emitRustExpr v0 v1 
    v2
and closure332 () () : leptos_Fragment =
    ...
    let v40 : (leptos_HtmlElement<leptos_svg_Svg> -> leptos_View) = closure335()
...
and method225 () : (unit -> leptos_Fragment) =
    closure336()
and closure327 (v0 : int32, v1 : leptos_ReadSignal<(bool * std_string_String)>, v2 : Heap2) () : leptos_Fragment =
    let v3 : (leptos_ev_Event -> unit) = closure328(v2, v0)
...
and method217 (v0 : int32, v1 : leptos_ReadSignal<(bool * std_string_String)>, v2 : Heap2) : (unit -> leptos_Fragment) =
    closure327(v0, v1, v2)
and closure337 (v0 : leptos_ReadSignal<(bool * std_string_String)>) () : std_string_String =
    let v1 : string = $"leptos::SignalGet::get(&$0)"
    let v2 : (bool * std_string_String) = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let (a, b) = v2 
    let v3 : bool = a
...
and method229 (v0 : bool) : bool =
    let v1 : bool = v0 = false
    v1
and closure340 (v0 : int32, v1 : std_string_String, v2 : int32) (v3 : (bool * std_string_String)) : (bool * std_string_String) =
    let v4 : bool = v2 = v0
    ...
    if v5 then
        ...
        v12
and closure339 (v0 : int32, v1 : std_string_String) (v2 : int32) : ((bool * std_string_String) -> (bool * std_string_String)) =
    closure340(v0, v1, v2)
and method228 (v0 : int32, v1 : std_string_String) : (int32 -> ((bool * std_string_String) -> (bool * std_string_String))) =
    closure339(v0, v1)
and closure338 (v0 : Heap2, v1 : int32) (v2 : std_string_String) : unit =
    let v3 : leptos_RwSignal<Heap1> = v0.l0
    let v4 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v5 : Heap1 = Fable.Core.RustInterop.emitRustExpr v3 v4 
    let v6 : leptos_RwSignal<Heap0> = v5.l3
...
and method230 (v0 : Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>) : Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))> =
    v0
and closure346 () (v0 : bool) : bool =
    let v1 : bool = v0 = false
    v1
and method232 () : (bool -> bool) =
    closure346()
and closure345 (v0 : int32) (v1 : (int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))) : bool =
    let (a, b) = v1 
    let v2 : int32 = a
    let struct (v3 : leptos_ReadSignal<(bool * std_string_String)>, v4 : leptos_WriteSignal<(bool * std_string_String)>) = b
    let v11 : bool = v2 = v0
    let v12 : (bool -> bool) = method232()
    v12 v11
and method231 (v0 : int32) : ((int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>)) -> bool) =
    closure345(v0)
and closure344 (v0 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v1 : int32) (v2 : Heap0) : Heap0 =
    ...
    let v18 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v19 : ((int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>)) -> (bool * std_string_String)) = closure315()
...
and closure343 (v0 : Heap2, v1 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v2 : leptos_WriteSignal<int32>, v3 : int32) () : unit =
    ...
    let v9 : (Heap0 -> Heap0) = closure344(v1, v3)
    ...
    let v12 : (int32 -> int32) = closure316()
    let v13 : bool = Fable.Core.RustInterop.emitRustExpr struct (v2, v12) v11 
    ()
and closure342 (v0 : Heap2, v1 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v2 : leptos_WriteSignal<int32>, v3 : int32) () : unit =
    let v4 : string = "true; leptos::batch(move || $0());"
    let v5 : (unit -> unit) = closure343(v0, v1, v2, v3)
...
and method233 () : (unit -> leptos_Fragment) =
    closure348()
and closure349 () () : std_string_String =
    let v0 : string = "&*$0"
    ...
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
    v4
and closure325 (v0 : Heap2, v1 : leptos_Memo<int32>, v2 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v3 : leptos_WriteSignal<int32>, v4 : leptos_ReadSignal<(bool * std_string_String)>, v5 : int32) () : leptos_Fragment =
    let v6 : int32 = method216(v5)
    let v7 : (unit -> std_string_String) = closure326(v6)
    let v8 : string = "let v7 = $0"
    Fable.Core.RustInterop.emitRustExpr v7 v8 
    ...
    let v26 : string = "$0"
    let v27 : (unit -> string) = closure341()
    ...
    let v93 : leptos_View =
        if v44 then
            ...
            let v49 : (unit -> unit) = closure342(v0, v2, v3, v6)
            let v50 : string = "let v49 = $0"
            Fable.Core.RustInterop.emitRustExpr v49 v50 
            let v51 : string = "$0"
            let v52 : (unit -> string) = closure347()
            ...
            let v76 : string = "$0"
            let v77 : (unit -> std_string_String) = closure349()
...
and method215 (v0 : Heap2, v1 : leptos_Memo<int32>, v2 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v3 : leptos_WriteSignal<int32>, v4 : leptos_ReadSignal<(bool * std_string_String)>, v5 : int32) : (unit -> leptos_Fragment) =
    closure325(v0, v1, v2, v3, v4, v5)
and closure324 (v0 : Heap2, v1 : leptos_Memo<int32>, v2 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v3 : leptos_WriteSignal<int32>) struct (v4 : int32, v5 : int32, v6 : leptos_ReadSignal<(bool * std_string_String)>) : leptos_Fragment =
...
and method214 (v0 : Heap2, v1 : leptos_Memo<int32>, v2 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v3 : leptos_WriteSignal<int32>) : (struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>) -> leptos_Fragment) =
    closure324(v0, v1, v2, v3)
and closure322 (v0 : Heap2, v1 : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>>, v2 : leptos_Memo<int32>, v3 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v4 : leptos_WriteSignal<int32>) () : leptos_Fragment =
...
and method211 (v0 : Heap2, v1 : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>>, v2 : leptos_Memo<int32>, v3 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v4 : leptos_WriteSignal<int32>) : (unit -> leptos_Fragment) =
    closure322(v0, v1, v2, v3, v4)
and closure321 (v0 : Heap2, v1 : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>>, v2 : leptos_Memo<int32>, v3 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v4 : leptos_WriteSignal<int32>) () : leptos_Fragment =
...
and method210 (v0 : Heap2, v1 : leptos_Memo<Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>>, v2 : leptos_Memo<int32>, v3 : leptos_Memo<Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>>, v4 : leptos_WriteSignal<int32>) : (unit -> leptos_Fragment) =
    closure321(v0, v1, v2, v3, v4)
and closure352 () () : string =
    let v0 : string = "py-[7px]"
    v0
and closure353 (v0 : leptos_View) () : Ref<Lifetime<StaticLifetime, Str>> =
...
and method238 (v0 : leptos_View) : (unit -> string) =
    closure356()
and closure355 (v0 : leptos_View) () : leptos_Fragment =
...
and method237 (v0 : leptos_View) : (unit -> leptos_Fragment) =
    closure355(v0)
and closure354 (v0 : leptos_View) () : leptos_Fragment =
...
and method236 (v0 : leptos_View) : (unit -> leptos_Fragment) =
    closure354(v0)
and closure351 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure352()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
    let v6 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure353(v0)
...
and method235 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure351(v0, v1)
and closure350 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
...
and method241 () : (unit -> leptos_Fragment) =
    closure359()
and closure361 () () : std_string_String =
    let v0 : string = "&*$0"
    let v1 : string = "dark-mode"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
    v4
and closure364 () (v0 : bool) : bool =
    let v1 : bool = v0 = false
    v1
and closure363 (v0 : Heap2) (v1 : leptos_ev_Event) : unit =
    let v2 : leptos_RwSignal<Heap1> = v0.l0
    let v3 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v4 : Heap1 = Fable.Core.RustInterop.emitRustExpr v2 v3 
    let v5 : leptos_RwSignal<bool> = v4.l0
    let v6 : string = "true; leptos::SignalUpdate::update(&$0, |x| { *x = $1(x.clone()) });"
    let v7 : (bool -> bool) = closure364()
    let v8 : bool = Fable.Core.RustInterop.emitRustExpr struct (v5, v7) v6 
    ()
and closure365 (v0 : Heap2) () : bool =
    let v1 : leptos_RwSignal<Heap1> = v0.l0
    let v2 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v3 : Heap1 = Fable.Core.RustInterop.emitRustExpr v1 v2 
    let v4 : leptos_RwSignal<bool> = v3.l0
...
and method245 () : (unit -> std_string_String) =
    closure361()
and closure362 (v0 : Heap2) () : leptos_Fragment =
    let v1 : (leptos_ev_Event -> unit) = closure363(v0)
...
and method243 (v0 : Heap2) : (unit -> leptos_Fragment) =
    closure362(v0)
and closure360 (v0 : Heap2) () : leptos_Fragment =
    let v1 : (unit -> std_string_String) = closure361()
    let v2 : string = "let v1 = $0"
    Fable.Core.RustInterop.emitRustExpr v1 v2 
...
and method248 () : (unit -> leptos_Fragment) =
    closure371()
and closure373 () () : std_string_String =
    let v0 : string = "&*$0"
    let v1 : string = "debug"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
    v4
and closure375 (v0 : Heap2) (v1 : leptos_ev_Event) : unit =
    let v2 : leptos_RwSignal<Heap1> = v0.l0
    let v3 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v4 : Heap1 = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and method252 () : (unit -> std_string_String) =
    closure373()
and closure374 (v0 : Heap2) () : leptos_Fragment =
    let v1 : (leptos_ev_Event -> unit) = closure375(v0)
    let v2 : string = "let v1 = $0"
    Fable.Core.RustInterop.emitRustExpr v1 v2 
...
and method250 (v0 : Heap2) : (unit -> leptos_Fragment) =
    closure374(v0)
and closure372 (v0 : Heap2) () : leptos_Fragment =
    let v1 : (unit -> std_string_String) = closure373()
    let v2 : string = "let v1 = $0"
    Fable.Core.RustInterop.emitRustExpr v1 v2 
    let v3 : string = "for=move || v1()"
    let v4 : string = "class=\"block relative h-8 w-14 cursor-pointer [-webkit-tap-highlight-color:_transparent]\""
...
and closure377 () () : string =
    let v0 : string = "items-center p-0"
    v0
and closure378 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure370()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "class=\"[font-size:12px] text-gray-400\""
...
and closure358 (v0 : Heap2) () : leptos_Fragment =
    ...
    let v25 : string = "$0"
    let v26 : (unit -> string) = closure377()
    ...
    let v45 : (leptos_HtmlElement<leptos_html_Dl> -> leptos_View) = closure379()
...
and method239 (v0 : Heap2) : (unit -> leptos_Fragment) =
    closure357(v0)
and closure382 () () : string =
    let v0 : string = "py-[7px]"
    v0
and closure383 () () : Ref<Lifetime<StaticLifetime, Str>> =
    let v0 : string = ""
    let v1 : string = "r#\"" + v0 + "\"#"
    let v2 : Ref<Lifetime<StaticLifetime, Str>> = Fable.Core.RustInterop.emitRustExpr () v1 
    v2
...
and method256 () : (unit -> leptos_Fragment) =
    closure384()
and closure381 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "$0"
    let v2 : (unit -> string) = closure382()
    let v3 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v2 v1 
    let v4 : string = "$0"
    let v5 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure383()
    let v6 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = Fable.Core.RustInterop.emitRustExpr v5 v4 
    let v7 : string = "class=move || \"flex flex-1 items-center justify-between px-4 cursor-pointer text-gray-600 hover:text-gray-700 bg-gray-300 hover:bg-gray-200 \".to_owned() + v6(()) + \" \" + &v3(())"
...
and method255 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure381(v0)
and closure380 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
...
and method262 (v0 : Heap2) : Heap2 =
    v0
and closure391 () (v0 : std_string_String) : US73 =
    US73_0(v0)
and closure392 () (v0 : std_string_String) : US73 =
    US73_1(v0)
and closure390 (v0 : Heap2) () : string =
    ...
    let v7 : (std_string_String -> US73) = closure391()
    let v8 : (std_string_String -> US73) = closure392()
    ...
    | US73_0(v10) -> (* Ok *)
        ...
        let v12 : string = Fable.Core.RustInterop.emitRustExpr v10 v11 
        v12
and closure393 () () : string =
    let v0 : string = ""
    v0
and closure394 (v0 : string) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and closure389 () () : leptos_Fragment =
    ...
    let v7 : string = "$0"
    let v8 : (unit -> string) = closure390(v6)
    ...
    let v14 : string = "$0"
    let v15 : (unit -> string) = closure393()
...
and closure395 () () : string =
    let v0 : string = ""
    v0
and closure396 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure370()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "class=\"[font-size:12px] text-gray-400\""
...
and closure387 () () : leptos_Fragment =
    ...
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure395()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
    let v6 : (unit -> string) = closure367()
    let v7 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v6 v5 
    let v8 : string = "$0"
    let v9 : (unit -> string) = closure368()
...
and method259 () : (unit -> leptos_Fragment) =
    closure387()
and closure399 () () : string =
    let v0 : string = "py-[7px]"
    v0
and closure400 () () : Ref<Lifetime<StaticLifetime, Str>> =
    let v0 : string = ""
    let v1 : string = "r#\"" + v0 + "\"#"
    let v2 : Ref<Lifetime<StaticLifetime, Str>> = Fable.Core.RustInterop.emitRustExpr () v1 
    v2
...
and method269 () : (unit -> string) =
    closure403()
and closure402 () () : leptos_Fragment =
...
and method267 () : (unit -> leptos_Fragment) =
    closure401()
and closure398 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "$0"
    let v2 : (unit -> string) = closure399()
    let v3 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v2 v1 
    let v4 : string = "$0"
    let v5 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure400()
    let v6 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = Fable.Core.RustInterop.emitRustExpr v5 v4 
    let v7 : string = "class=move || \"flex flex-1 items-center justify-between px-4 cursor-pointer text-gray-600 hover:text-gray-700 bg-gray-300 hover:bg-gray-200 \".to_owned() + v6(()) + \" \" + &v3(())"
...
and method266 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure398(v0)
and closure397 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
...
and method271 (v0 : Ref<Lifetime<StaticLifetime, Str>>) : Ref<Lifetime<StaticLifetime, Str>> =
    v0
and closure407 (v0 : leptos_ReadSignal<bool>) () : std_string_String =
    let v1 : string = $"leptos::SignalGet::get(&$0)"
    let v2 : bool = Fable.Core.RustInterop.emitRustExpr v0 v1 
...
and method274 () : (unit -> leptos_Fragment) =
    closure410()
and closure411 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "Func0::new(move || $0())"
    let v2 : Func0<leptos_Fragment> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "leptos::IntoView::into_view(move || $0())"
    let v4 : leptos_View = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and method275 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure411(v0)
and closure413 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    v0 ()
and method277 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure413(v0)
and closure414 () () : leptos_Fragment =
    let v0 : (leptos_View []) = [||]
    let v1 : string = "$0.to_vec()"
    let v2 : Vec<leptos_View> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "leptos::Fragment::new($0)"
...
and method278 () : (unit -> leptos_Fragment) =
    closure414()
and closure412 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
...
and method279 () : (unit -> leptos_Fragment) =
    closure415()
and closure417 () () : std_string_String =
    let v0 : string = "&*$0"
    let v1 : string = "table-view"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
...
and closure419 (v0 : Heap2) (v1 : leptos_ev_Event) : unit =
    let v2 : leptos_RwSignal<Heap1> = v0.l0
    let v3 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v4 : Heap1 = Fable.Core.RustInterop.emitRustExpr v2 v3 
    let v5 : leptos_RwSignal<Heap0> = v4.l3
    let v6 : string = "true; leptos::SignalUpdate::update(&$0, |x| { *x = $1(x.clone()) });"
    let v7 : (Heap0 -> Heap0) = closure420()
    let v8 : bool = Fable.Core.RustInterop.emitRustExpr struct (v5, v7) v6 
    ()
and closure421 (v0 : Heap2) () : bool =
    let v1 : leptos_RwSignal<Heap1> = v0.l0
    let v2 : string = $"leptos::SignalGetUntracked::get_untracked(&$0)"
    let v3 : Heap1 = Fable.Core.RustInterop.emitRustExpr v1 v2 
    let v4 : leptos_RwSignal<Heap0> = v3.l3
...
and method283 () : (unit -> std_string_String) =
    closure417()
and closure418 (v0 : Heap2) () : leptos_Fragment =
    let v1 : (leptos_ev_Event -> unit) = closure419(v0)
    let v2 : string = "let v1 = $0"
    Fable.Core.RustInterop.emitRustExpr v1 v2 
...
and method281 (v0 : Heap2) : (unit -> leptos_Fragment) =
    closure418(v0)
and closure416 (v0 : Heap2) () : leptos_Fragment =
    let v1 : (unit -> std_string_String) = closure417()
    let v2 : string = "let v1 = $0"
    Fable.Core.RustInterop.emitRustExpr v1 v2 
    let v3 : string = "for=move || v1()"
    let v4 : string = "class=\"block relative h-8 w-14 cursor-pointer [-webkit-tap-highlight-color:_transparent]\""
...
and closure422 () () : string =
    ...
    v0
and closure423 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure370()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "class=\"[font-size:12px] text-gray-400\""
...
and method284 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure423(v0, v1)
and closure409 (v0 : Heap2) () : leptos_Fragment =
...
and method273 (v0 : Heap2) : (unit -> leptos_Fragment) =
    closure409(v0)
and closure427 (v0 : int64) () : leptos_Fragment =
...
and method289 () : (unit -> leptos_Fragment) =
    closure429()
and closure430 (v0 : string) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and closure435 (v0 : std_string_String, v1 : std_string_String, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : uint32, v7 : (struct (std_string_String * std_string_String option) []), v8 : float, v9 : bool, v10 : float, v11 : (std_string_String [])) () : leptos_Fragment =
    ...
    let v20 : US71 option = None
    let _v20 = ref v20 
    let v21 : US71 option ref = _v20 
    let v22 : (US71 option -> US71 option ref) = closure285(v21)
    let v23 : unit = ()
    let v24 : (unit -> unit) = closure286(v19, v22)
    let v25 : unit = (fun () -> v24 (); v23) ()
    let v28 : US71 option = _v20.Value 
    let v39 : US71 = US71_1
    let v40 : US71 = v28 |> Option.defaultValue v39 
    let v59 : US34 =
        match v40 with
        | US71_1 -> (* None *)
            US34_1
...
and method300 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure448(v0, v1)
and closure449 () () : leptos_Fragment =
    let v0 : string = "&*$0"
...
and method301 () : (unit -> leptos_Fragment) =
    closure449()
and closure452 (v0 : std_string_String) () : leptos_Fragment =
    let v1 : string = "fable_library_rust::String_::fromString($0)"
    let v2 : string = Fable.Core.RustInterop.emitRustExpr v0 v1 
...
and method303 (v0 : std_string_String) : (unit -> leptos_Fragment) =
    closure452(v0)
and closure455 () () : leptos_Fragment =
    let v0 : string = "&*$0"
...
and method306 () : (unit -> leptos_Fragment) =
    closure455()
and closure456 (v0 : std_string_String option) () : leptos_Fragment =
    let v1 : US15 option = None
    let _v1 = ref v1 
    let v2 : US15 option ref = _v1 
    let v3 : (US15 option -> US15 option ref) = closure37(v2)
    let v4 : unit = ()
    let v5 : (unit -> unit) = closure38(v0, v3)
    let v6 : unit = (fun () -> v5 (); v4) ()
...
and method308 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure459(v0, v1)
and closure454 (v0 : std_string_String option) () : leptos_Fragment =
    let v1 : (unit -> leptos_Fragment) = method306()
    let v2 : (unit -> leptos_Fragment) = method307(v0)
    let v3 : string = "$0"
    let v4 : (unit -> string) = closure457()
    let v5 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v4 v3 
    let v6 : string = "$0"
    let v7 : (unit -> string) = closure458()
    let v8 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v7 v6 
    let v9 : string = "$0"
    let v10 : (unit -> string) = closure368()
    let v11 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v10 v9 
...
and method305 (v0 : std_string_String option) : (unit -> leptos_Fragment) =
    closure454(v0)
and closure453 (v0 : std_string_String option) () : leptos_Fragment =
...
and closure462 () () : string =
    let v0 : string = "items-center"
    v0
and closure463 () () : string =
    let v0 : string = ""
    v0
and closure465 () () : string =
    let v0 : string = ""
    v0
and closure464 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure465()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "class=\"[font-size:12px] text-gray-400\""
    let v6 : (unit -> leptos_Fragment) = method247(v0)
    let v7 : string = ""
...
and method309 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure464(v0, v1)
and closure451 () struct (v0 : std_string_String, v1 : std_string_String option) : leptos_View =
    let v2 : (unit -> leptos_Fragment) = method303(v0)
    let v3 : (unit -> leptos_Fragment) = method304(v1)
    let v4 : string = "$0"
    let v5 : (unit -> string) = closure461()
    let v6 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v5 v4 
    let v7 : string = "$0"
    let v8 : (unit -> string) = closure462()
    let v9 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v8 v7 
    let v10 : string = "$0"
    let v11 : (unit -> string) = closure463()
    ...
    let v25 : leptos_View = Fable.Core.RustInterop.emitRustExpr v23 v24 
    v25
and closure450 (v0 : std_string_String, v1 : std_string_String, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : uint32, v7 : (struct (std_string_String * std_string_String option) []), v8 : float, v9 : bool, v10 : float, v11 : (std_string_String [])) () : leptos_Fragment =
    ...
    let v14 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v15 : (struct (std_string_String * std_string_String option) -> leptos_View) = closure451()
...
and closure503 () () : string =
    let v0 : string = ""
    v0
and closure504 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure370()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "class=\"[font-size:12px] text-gray-400\""
...
and method332 () : (unit -> leptos_Fragment) =
    closure505()
and closure507 () () : string =
    let v0 : string = "[max-height:20vh]"
    v0
and closure506 (v0 : std_string_String, v1 : std_string_String, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : uint32, v7 : (struct (std_string_String * std_string_String option) []), v8 : float, v9 : bool, v10 : float, v11 : (std_string_String [])) () : leptos_Fragment =
    let v12 : string = "$0.to_vec()"
    ...
    let v30 : string = "$0"
    let v31 : (unit -> string) = closure507()
    ...
    let v34 : (unit -> leptos_Fragment) = method263(v29)
    let v35 : string = ""
    let v36 : string = " " + v33 + v35 + ""
    let v37 : (unit -> leptos_Fragment) = method132(v34)
    let v38 : (unit -> leptos_Fragment) = method133(v37)
    let v39 : string = "pre"
...
and method333 (v0 : std_string_String, v1 : std_string_String, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : uint32, v7 : (struct (std_string_String * std_string_String option) []), v8 : float, v9 : bool, v10 : float, v11 : (std_string_String [])) : (unit -> leptos_Fragment) =
    closure506(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11)
and closure508 () () : string =
    let v0 : string = "items-center py-[4px]"
    v0
and closure509 () () : string =
    let v0 : string = ""
    v0
and closure510 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure370()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "class=\"[font-size:12px] text-gray-400\""
...
and method334 (v0 : (unit -> leptos_Fragment), v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure510(v0, v1)
and closure428 (v0 : string, v1 : std_string_String, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : std_string_String, v7 : uint32, v8 : (struct (std_string_String * std_string_String option) []), v9 : float, v10 : bool, v11 : float, v12 : (std_string_String [])) () : leptos_Fragment =
    let v13 : (unit -> leptos_Fragment) = method289()
    let v14 : (unit -> leptos_Fragment) = method290(v0)
    let v15 : string = "$0"
    let v16 : (unit -> string) = closure431()
    let v17 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v16 v15 
    let v18 : string = "$0"
    let v19 : (unit -> string) = closure432()
    let v20 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v19 v18 
    let v21 : string = "$0"
    let v22 : (unit -> string) = closure368()
    let v23 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v22 v21 
...
and method288 (v0 : string, v1 : std_string_String, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : std_string_String, v7 : uint32, v8 : (struct (std_string_String * std_string_String option) []), v9 : float, v10 : bool, v11 : float, v12 : (std_string_String [])) : (unit -> leptos_Fragment) =
    closure428(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12)
and closure426 (v0 : string, v1 : int64, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : std_string_String, v7 : std_string_String, v8 : uint32, v9 : (struct (std_string_String * std_string_String option) []), v10 : float, v11 : bool, v12 : float, v13 : (std_string_String [])) () : leptos_Fragment =
...
and method286 (v0 : string, v1 : int64, v2 : std_string_String, v3 : std_string_String, v4 : std_string_String, v5 : std_string_String, v6 : std_string_String, v7 : std_string_String, v8 : uint32, v9 : (struct (std_string_String * std_string_String option) []), v10 : float, v11 : bool, v12 : float, v13 : (std_string_String [])) : (unit -> leptos_Fragment) =
    closure426(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13)
and closure425 () struct (v0 : string, v1 : unativeint, v2 : Heap5) : leptos_View =
    ...
    let v36 : leptos_View = Fable.Core.RustInterop.emitRustExpr v34 v35 
    v36
and closure424 (v0 : (struct (string * unativeint * Heap5) [])) () : leptos_Fragment =
    let v1 : string = "$0.to_vec()"
    let v2 : Vec<struct (string * unativeint * Heap5)> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v4 : (struct (string * unativeint * Heap5) -> leptos_View) = closure425()
...
and method285 (v0 : (struct (string * unativeint * Heap5) [])) : (unit -> leptos_Fragment) =
    closure424(v0)
and closure513 (v0 : string) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and method339 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure516(v0)
and closure518 () struct (v0 : std_string_String, v1 : std_string_String option) : leptos_View =
    let v2 : (unit -> leptos_Fragment) = method303(v0)
    let v3 : (unit -> leptos_Fragment) = method304(v1)
    let v4 : string = "$0"
    let v5 : (unit -> string) = closure461()
...
and closure517 (v0 : Heap5) () : leptos_Fragment =
    ...
    let v4 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v5 : (struct (std_string_String * std_string_String option) -> leptos_View) = closure518()
...
and closure522 (v0 : Heap5) () : leptos_Fragment =
    ...
    if v3 then
        ...
        let v36 : string = "$0"
        let v37 : (unit -> string) = closure523()
        ...
        let v40 : (unit -> leptos_Fragment) = method263(v35)
        let v41 : string = ""
        let v42 : string = " " + v39 + v41 + ""
        let v43 : (unit -> leptos_Fragment) = method132(v40)
        let v44 : (unit -> leptos_Fragment) = method133(v43)
        let v45 : string = "pre"
...
and method344 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure522(v0)
and closure524 (v0 : Heap5) () : leptos_Fragment =
    let v1 : bool = v0.l9
...
and method345 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure524(v0)
and closure525 (v0 : Heap5) () : leptos_Fragment =
...
and method346 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure525(v0)
and closure526 (v0 : Heap5) () : leptos_Fragment =
...
and method347 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure526(v0)
and closure527 (v0 : Heap5) () : leptos_Fragment =
...
and method348 (v0 : Heap5) : (unit -> leptos_Fragment) =
    closure527(v0)
and closure512 (v0 : Heap5, v1 : string) () : leptos_Fragment =
    let v2 : string = "class=\"whitespace-nowrap px-4 py-2 text-gray-700 dark:text-gray-500\""
...
and method335 (v0 : Heap5, v1 : string) : (unit -> leptos_Fragment) =
    closure512(v0, v1)
and closure511 () struct (v0 : string, v1 : unativeint, v2 : Heap5) : leptos_HtmlElement<leptos_html_Tr> =
    ...
    v16
and closure528 () (v0 : leptos_HtmlElement<leptos_html_Tr>) : leptos_View =
    let v1 : string = "leptos::IntoView::into_view($0)"
    let v2 : leptos_View = Fable.Core.RustInterop.emitRustExpr v0 v1 
    v2
...
and method359 (v0 : (struct (string * unativeint * Heap5) []), v1 : int32) : bool =
    ...
    if v3 then
        ...
        false
and closure538 (v0 : (struct (string * unativeint * Heap5) [])) () : leptos_Fragment =
    let v1 : int32 = 0
...
and method358 (v0 : (struct (string * unativeint * Heap5) [])) : (unit -> leptos_Fragment) =
    closure538(v0)
and closure539 () () : leptos_Fragment =
    let v0 : string = "&*$0"
    let v1 : string = "Outcome Status"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
...
and method361 () : (unit -> leptos_Fragment) =
    closure539()
and closure540 () () : leptos_Fragment =
    let v0 : string = "&*$0"
    let v1 : string = "Hash"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
...
and method362 () : (unit -> leptos_Fragment) =
    closure540()
and closure541 () () : leptos_Fragment =
    let v0 : string = "&*$0"
    let v1 : string = "Block Hash"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
...
and method363 () : (unit -> leptos_Fragment) =
    closure541()
and closure542 () () : leptos_Fragment =
    let v0 : string = "&*$0"
    let v1 : string = "Receipt ID"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
...
and method364 () : (unit -> leptos_Fragment) =
    closure542()
and closure529 (v0 : (struct (string * unativeint * Heap5) [])) () : leptos_Fragment =
...
and method349 (v0 : (struct (string * unativeint * Heap5) [])) : (unit -> leptos_Fragment) =
    closure529(v0)
and closure408 (v0 : Heap2, v1 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>, v2 : leptos_Memo<Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>>, v3 : leptos_ReadSignal<bool>) () : leptos_Fragment =
    let v4 : string = $"leptos::SignalGet::get(&$0)"
    let v5 : bool = Fable.Core.RustInterop.emitRustExpr v3 v4 
    let v23 : leptos_View =
        if v5 then
    ...
    let v179 : leptos_View =
        if v29 then
            ...
            let v45 : ((struct (string * unativeint * Heap5) []) option -> US56) = closure145()
            let v46 : (std_string_String -> US56) = closure146()
            ...
            let v77 : US49 =
                ...
                | US56_0(v48) -> (* Ok *)
                    ...
                    let _v49 = ref v49 
                    let v50 : US50 option ref = _v49 
                    let v51 : (US50 option -> US50 option ref) = closure147(v50)
                    let v52 : unit = ()
                    let v53 : (unit -> unit) = closure148(v48, v51)
                    let v54 : unit = (fun () -> v53 (); v52) ()
                    let v57 : US50 option = _v49.Value 
                    let v68 : US50 = US50_1
                    let v69 : US50 = v57 |> Option.defaultValue v68 
                    US49_0(v69)
            match v77 with
            | US49_1(v161) -> (* Error *)
                ...
                let v165 : (unit -> leptos_Fragment) = method164(v163)
                let v166 : string = ""
                let v167 : string = " " + v164 + v166 + ""
                let v168 : (unit -> leptos_Fragment) = method132(v165)
                let v169 : (unit -> leptos_Fragment) = method133(v168)
                let v170 : string = "div"
            ...
            | US49_0(v78) -> (* Ok *)
                ...
                | US50_0(v79) -> (* Some *)
                    ...
                    if v87 then
                        ...
                        let v89 : (unit -> leptos_Fragment) = method285(v79)
                        let v90 : string = ""
                        let v91 : string = " " + v88 + v90 + ""
                        let v92 : (unit -> leptos_Fragment) = method132(v89)
                        let v93 : (unit -> leptos_Fragment) = method133(v92)
                        let v94 : string = "div"
                        ...
                        let v104 : (struct (string * unativeint * Heap5) -> leptos_HtmlElement<leptos_html_Tr>) = closure511()
                        ...
                        let v107 : (leptos_HtmlElement<leptos_html_Tr> -> leptos_View) = closure528()
                        ...
                        let v118 : (unit -> leptos_Fragment) = method349(v79)
                        let v119 : (unit -> leptos_Fragment) = method132(v118)
                        let v120 : (unit -> leptos_Fragment) = method133(v119)
                        let v121 : string = "tr"
                        let v122 : string = ""
                        ...
                        let v135 : (unit -> leptos_Fragment) = method194(v133, v114)
                        let v136 : string = " " + v134 + v122 + ""
                        let v137 : (unit -> leptos_Fragment) = method132(v135)
                        let v138 : (unit -> leptos_Fragment) = method133(v137)
                ...
                | _ ->
                    ...
                    let v148 : (unit -> leptos_Fragment) = method197()
                    let v149 : string = ""
                    let v150 : string = " " + v147 + v149 + ""
                    let v151 : (unit -> leptos_Fragment) = method132(v148)
...
and method272 (v0 : Heap2, v1 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>, v2 : leptos_Memo<Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>>, v3 : leptos_ReadSignal<bool>) : (unit -> leptos_Fragment) =
    closure408(v0, v1, v2, v3)
and closure545 () () : string =
    let v0 : string = "py-[7px]"
    v0
and closure546 (v0 : leptos_View) () : Ref<Lifetime<StaticLifetime, Str>> =
    let v1 : string = "[margin-right:40px]"
    let v2 : string = "r#\"" + v1 + "\"#"
    let v3 : Ref<Lifetime<StaticLifetime, Str>> = Fable.Core.RustInterop.emitRustExpr () v2 
    v3
and closure549 () () : string =
    let v0 : string = "Transactions"
    v0
and method369 (v0 : leptos_View) : (unit -> string) =
    closure549()
and closure548 (v0 : leptos_View) () : leptos_Fragment =
...
and method368 (v0 : leptos_View) : (unit -> leptos_Fragment) =
    closure548(v0)
and closure547 (v0 : leptos_View) () : leptos_Fragment =
    let v1 : string = "class=\"flex items-center gap-2\""
...
and method367 (v0 : leptos_View) : (unit -> leptos_Fragment) =
    closure547(v0)
and closure544 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure545()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
    let v6 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure546(v0)
    let v7 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = Fable.Core.RustInterop.emitRustExpr v6 v5 
    let v8 : string = "class=move || \"flex flex-1 items-center justify-between px-4 cursor-pointer text-gray-600 hover:text-gray-700 bg-gray-300 hover:bg-gray-200 \".to_owned() + v7(()) + \" \" + &v4(())"
...
and method366 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure544(v0, v1)
and closure543 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
...
and method371 () : (unit -> leptos_Fragment) =
    closure551()
and closure553 () () : string =
    let v0 : string = "[max-height:70vh]"
    v0
and closure552 (v0 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>) () : leptos_Fragment =
    let v1 : string = $"$0()"
    let v2 : Result<(struct (string * unativeint * Heap5) []) option, std_string_String> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : unit = ()
    ...
    let v25 : string = _v3 
    let v30 : string = "$0"
    let v31 : (unit -> string) = closure553()
    let v32 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v31 v30 
    let v33 : string = "class=move || \"[padding:1px] [font-size:12px] [line-height:12px] [text-wrap:pretty] \".to_owned() + &v32(())"
    let v34 : (unit -> leptos_Fragment) = method263(v25)
    let v35 : string = ""
    let v36 : string = " " + v33 + v35 + ""
    let v37 : (unit -> leptos_Fragment) = method132(v34)
    let v38 : (unit -> leptos_Fragment) = method133(v37)
...
and method372 (v0 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>) : (unit -> leptos_Fragment) =
    closure552(v0)
and closure550 (v0 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>) () : leptos_Fragment =
    let v1 : (unit -> leptos_Fragment) = method371()
    let v2 : (unit -> leptos_Fragment) = method372(v0)
    let v3 : string = "$0"
    let v4 : (unit -> string) = closure395()
    let v5 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v4 v3 
    let v6 : string = "$0"
    let v7 : (unit -> string) = closure367()
    let v8 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v7 v6 
    ...
    let v27 : (leptos_HtmlElement<leptos_html_Dl> -> leptos_View) = closure379()
...
and method370 (v0 : leptos_Memo<Result<(struct (string * unativeint * Heap5) []) option, std_string_String>>) : (unit -> leptos_Fragment) =
    closure550(v0)
and closure556 () () : string =
    let v0 : string = "py-[7px]"
    v0
and closure557 () () : Ref<Lifetime<StaticLifetime, Str>> =
    let v0 : string = ""
    let v1 : string = "r#\"" + v0 + "\"#"
    let v2 : Ref<Lifetime<StaticLifetime, Str>> = Fable.Core.RustInterop.emitRustExpr () v1 
    v2
and closure560 () () : string =
    let v0 : string = "Debug"
    v0
...
and method376 () : (unit -> leptos_Fragment) =
    closure559()
and closure558 () () : leptos_Fragment =
    let v0 : string = "class=\"flex items-center gap-2\""
...
and method375 () : (unit -> leptos_Fragment) =
    closure558()
and closure555 (v0 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v1 : string = "$0"
    let v2 : (unit -> string) = closure556()
    let v3 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v2 v1 
    let v4 : string = "$0"
    let v5 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure557()
    let v6 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = Fable.Core.RustInterop.emitRustExpr v5 v4 
    let v7 : string = "class=move || \"flex flex-1 items-center justify-between px-4 cursor-pointer text-gray-600 hover:text-gray-700 bg-gray-300 hover:bg-gray-200 \".to_owned() + v6(()) + \" \" + &v3(())"
...
and method374 (v0 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure555(v0)
and closure554 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) () : leptos_Fragment =
    let v2 : string = "$0"
    let v3 : (unit -> string) = closure261()
    let v4 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v3 v2 
    let v5 : string = "$0"
...
and method373 (v0 : leptos_View, v1 : (unit -> leptos_Fragment)) : (unit -> leptos_Fragment) =
    closure554(v0, v1)
and closure561 (v0 : leptos_Fragment) () : leptos_Fragment =
    v0
and method378 (v0 : leptos_Fragment) : (unit -> leptos_Fragment) =
    closure561(v0)
and closure63 (v0 : leptos_ReadSignal<US20>) () : leptos_Fragment =
    let v1 : string = $"leptos::SignalGet::get(&$0)"
    ...
    let v479 : US24 =
        ...
        | US20_1(v3) -> (* Dice *)
            ...
            let v19 : string = "$0"
            let v20 : (unit -> (struct (string * US25 * string * bool * bool) [])) = closure69(v18)
            ...
            let v24 : string = "$0"
            let v25 : (unit -> Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>) = closure71(v10, v18)
            ...
            let v29 : string = "$0"
            let v30 : (unit -> Vec<struct (string * US25 * string * bool * bool)>) = closure74(v28)
            ...
            let v48 : bool = Fable.Core.RustInterop.emitRustExpr v46 v47 
            let v49 : string = "$0"
            let v50 : (unit -> Result<(struct (string * unativeint * Heap5) []) option, std_string_String>) = closure125(v38, v40)
            ...
            let v82 : string = "$0"
            let v83 : (unit -> string option) = closure188(v81)
            ...
            let v87 : string = "$0"
            let v88 : (unit -> US34) = closure195(v10)
            let v89 : (unit -> US34) = Fable.Core.RustInterop.emitRustExpr v88 v87 
            let v90 : string = "leptos::create_memo(move |_| { v89(()) })"
            let v91 : leptos_Memo<US34> = Fable.Core.RustInterop.emitRustExpr () v90 
            let v92 : string = "$0"
            let v93 : (unit -> Vec<(int32 * struct (leptos_ReadSignal<std_string_String> * leptos_WriteSignal<std_string_String>))>) = closure196(v10)
            ...
            let v97 : string = "$0"
            let v98 : (unit -> Vec<struct (int32 * leptos_ReadSignal<std_string_String>)>) = closure199(v96)
            ...
            let v103 : (leptos_View []) = method122(v102)
            ...
            let v106 : (unit -> leptos_Fragment) = method123(v10, v76, v86, v91, v101)
            let v107 : (unit -> leptos_Fragment) = method142(v106)
            let v108 : string = "class=\"flex flex-col [position:relative]\""
            let v109 : (unit -> leptos_Fragment) = method166(v105, v107)
            let v110 : string = ""
            let v111 : string = " " + v108 + v110 + ""
            let v112 : (unit -> leptos_Fragment) = method132(v109)
            let v113 : (unit -> leptos_Fragment) = method133(v112)
            let v114 : string = "div"
            ...
            let v122 : (leptos_View []) = method122(v121)
            let v123 : string = "leptos::CollectView::collect_view($0.to_vec())"
            let v124 : leptos_View = Fable.Core.RustInterop.emitRustExpr v122 v123 
            let v125 : (unit -> leptos_Fragment) = method171(v65, v53, v28)
            let v126 : (unit -> leptos_Fragment) = method142(v125)
            let v127 : string = "class=\"flex flex-col [position:relative]\""
            let v128 : (unit -> leptos_Fragment) = method199(v124, v126)
            let v129 : string = " " + v127 + v110 + ""
            let v130 : (unit -> leptos_Fragment) = method132(v128)
            let v131 : (unit -> leptos_Fragment) = method133(v130)
        ...
        | US20_4 -> (* Settings *)
            ...
            let v343 : string = "$0"
            let v344 : (unit -> Vec<(int32 * struct (leptos_ReadSignal<(bool * std_string_String)> * leptos_WriteSignal<(bool * std_string_String)>))>) = closure305(v342)
            ...
            let v351 : string = "$0"
            let v352 : (unit -> Vec<struct (int32 * int32 * leptos_ReadSignal<(bool * std_string_String)>)>) = closure308(v347, v349)
            ...
            let v356 : string = "$0"
            let v357 : (unit -> int32) = closure311(v355)
            ...
            let v361 : (unit -> unit) = closure312(v342, v347, v350)
            let v362 : string = "let v361 = $0"
            Fable.Core.RustInterop.emitRustExpr v361 v362 
            let v363 : string = "$0"
            let v364 : (unit -> string) = closure317()
            ...
            let v372 : (unit -> leptos_Fragment) = method208()
            let v373 : string = ""
            ...
            let v380 : (unit -> leptos_Fragment) = method132(v372)
            let v381 : (unit -> leptos_Fragment) = method133(v380)
            let v382 : string = "svg"
            ...
            let v389 : string = "$0"
            let v390 : (unit -> std_string_String) = closure319()
            ...
            let v393 : (unit -> leptos_Fragment) = method209(v386)
            let v394 : string = " " + v392 + v373 + ""
            let v395 : string = " " + v387 + v394 + ""
            let v396 : string = " " + v388 + v395 + ""
            let v397 : (unit -> leptos_Fragment) = method132(v393)
            let v398 : (unit -> leptos_Fragment) = method133(v397)
            ...
            let v410 : (unit -> leptos_Fragment) = method210(v342, v355, v360, v347, v350)
            let v411 : (unit -> leptos_Fragment) = method142(v410)
            let v412 : string = "class=\"flex flex-col [position:relative]\""
            let v413 : (unit -> leptos_Fragment) = method234(v405, v411)
            let v414 : string = " " + v412 + v373 + ""
            let v415 : (unit -> leptos_Fragment) = method132(v413)
            let v416 : (unit -> leptos_Fragment) = method133(v415)
            let v417 : string = "div"
            ...
            let v425 : (leptos_View []) = method122(v424)
            ...
            let v428 : (unit -> leptos_Fragment) = method239(v342)
            let v429 : (unit -> leptos_Fragment) = method142(v428)
            let v430 : string = "class=\"flex flex-col [position:relative]\""
            let v431 : (unit -> leptos_Fragment) = method254(v427, v429)
            let v432 : string = " " + v430 + v373 + ""
            let v433 : (unit -> leptos_Fragment) = method132(v431)
            let v434 : (unit -> leptos_Fragment) = method133(v433)
            ...
            let v468 : leptos_View =
                if v446 then
                    ...
                    let v448 : (leptos_View []) = method122(v447)
                    ...
                    let v451 : (unit -> leptos_Fragment) = method259()
                    let v452 : (unit -> leptos_Fragment) = method142(v451)
                    let v453 : string = "class=\"flex flex-col [position:relative]\""
                    let v454 : (unit -> leptos_Fragment) = method265(v450, v452)
                    let v455 : string = " " + v453 + v373 + ""
                    let v456 : (unit -> leptos_Fragment) = method132(v454)
                    let v457 : (unit -> leptos_Fragment) = method133(v456)
                    ...
                    let v465 : (leptos_View []) = method122(v464)
        ...
        | US20_3 -> (* Transactions *)
            ...
            let v181 : string = "$0"
            let v182 : (unit -> (struct (string * US25 * string * bool * bool) [])) = closure69(v180)
            let v183 : (unit -> (struct (string * US25 * string * bool * bool) [])) = Fable.Core.RustInterop.emitRustExpr v182 v181 
            let v184 : string = "leptos::create_memo(move |_| { v183(()) })"
            let v185 : leptos_Memo<(struct (string * US25 * string * bool * bool) [])> = Fable.Core.RustInterop.emitRustExpr () v184 
            let v186 : string = "$0"
            let v187 : (unit -> Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>) = closure71(v172, v180)
            let v188 : (unit -> Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>) = Fable.Core.RustInterop.emitRustExpr v187 v186 
            let v189 : string = "leptos::create_memo(move |_| { v188(()) })"
            let v190 : leptos_Memo<Vec<struct (string * Vec<struct (string * US25 * string * bool * bool)>)>> = Fable.Core.RustInterop.emitRustExpr () v189 
            let v191 : string = "$0"
            let v192 : (unit -> Vec<struct (string * US25 * string * bool * bool)>) = closure74(v190)
            let v193 : (unit -> Vec<struct (string * US25 * string * bool * bool)>) = Fable.Core.RustInterop.emitRustExpr v192 v191 
            let v194 : string = "leptos::create_memo(move |_| { v193(()) })"
            let v195 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>> = Fable.Core.RustInterop.emitRustExpr () v194 
            let v196 : string = "$0"
            ...
            let v202 : leptos_Memo<Vec<Result<(struct (std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * std_string_String * uint32 * (struct (std_string_String * std_string_String option) []) * float * bool * float * (std_string_String [])) []) option, std_string_String>>> = method62(v195, v201)
            ...
            let v211 : string = "$0"
            let v212 : (unit -> Result<(struct (string * unativeint * Heap5) []) option, std_string_String>) = closure125(v200, v202)
            ...
            let v216 : string = "$0"
            let v217 : (unit -> Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String>) = closure144(v215)
            let v218 : (unit -> Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String>) = Fable.Core.RustInterop.emitRustExpr v217 v216 
            let v219 : string = "leptos::create_memo(move |_| { v218(()) })"
            let v220 : leptos_Memo<Result<(struct (string * US25 * string * bool * bool) []) option, std_string_String>> = Fable.Core.RustInterop.emitRustExpr () v219 
            let v221 : string = "$0"
            let v222 : (unit -> Vec<struct (string * US25 * string * bool * bool)>) = closure152(v220)
            let v223 : (unit -> Vec<struct (string * US25 * string * bool * bool)>) = Fable.Core.RustInterop.emitRustExpr v222 v221 
            let v224 : string = "leptos::create_memo(move |_| { v223(()) })"
            let v225 : leptos_Memo<Vec<struct (string * US25 * string * bool * bool)>> = Fable.Core.RustInterop.emitRustExpr () v224 
            ...
            let v250 : (unit -> leptos_Fragment) = method270()
            let v251 : string = ""
            ...
            let v258 : (unit -> leptos_Fragment) = method132(v250)
            let v259 : (unit -> leptos_Fragment) = method133(v258)
            let v260 : string = "svg"
            ...
            let v267 : string = "$0"
            let v268 : (unit -> std_string_String) = closure407(v237)
            ...
            let v271 : (unit -> leptos_Fragment) = method209(v264)
            let v272 : string = " " + v270 + v251 + ""
            let v273 : string = " " + v265 + v272 + ""
            let v274 : string = " " + v266 + v273 + ""
            let v275 : (unit -> leptos_Fragment) = method132(v271)
            let v276 : (unit -> leptos_Fragment) = method133(v275)
            ...
            let v285 : (leptos_View []) = method122(v284)
            ...
            let v288 : (unit -> leptos_Fragment) = method272(v172, v215, v190, v237)
            let v289 : (unit -> leptos_Fragment) = method142(v288)
            let v290 : string = "class=\"flex flex-col [position:relative]\""
            let v291 : (unit -> leptos_Fragment) = method365(v283, v289)
            let v292 : string = " " + v290 + v251 + ""
            let v293 : (unit -> leptos_Fragment) = method132(v291)
            let v294 : (unit -> leptos_Fragment) = method133(v293)
            let v295 : string = "div"
            ...
            let v329 : leptos_View =
                if v307 then
                    ...
                    let v326 : (leptos_View []) = method122(v325)
    ...
    let v499 : leptos_View =
        ...
        | US24_1 -> (* None *)
            ...
            let v495 : (leptos_View []) = method122(v494)
        ...
        | US24_0(v480) -> (* Some *)
            ...
            let v482 : (unit -> leptos_Fragment) = method378(v480)
            let v483 : string = ""
            let v484 : string = " " + v481 + v483 + ""
            let v485 : (unit -> leptos_Fragment) = method132(v482)
            let v486 : (unit -> leptos_Fragment) = method133(v485)
            let v487 : string = "div"
...
and method50 (v0 : leptos_ReadSignal<US20>) : (unit -> leptos_Fragment) =
    closure63(v0)
and closure564 () () : leptos_Fragment =
    let v0 : string = "&*$0"
    let v1 : string = "Tab"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v1 v0 
    let v3 : string = "String::from($0)"
...
and method381 () : (unit -> leptos_Fragment) =
    closure564()
and closure567 (v0 : leptos_ReadSignal<US20>, v1 : US20) () : bool =
    let v2 : string = $"leptos::SignalGet::get(&$0)"
...
and method383 (v0 : leptos_ReadSignal<US20>, v1 : US20) : (unit -> bool) =
    closure567(v0, v1)
and closure568 (v0 : string) () : leptos_Fragment =
    let v1 : string = "&*$0"
    let v2 : Ref<Str> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "String::from($0)"
    let v4 : std_string_String = Fable.Core.RustInterop.emitRustExpr v2 v3 
...
and method384 (v0 : string) : (unit -> leptos_Fragment) =
    closure568(v0)
and closure566 (v0 : leptos_ReadSignal<US20>) (v1 : US20) : leptos_View =
    let v12 : string =
        match v1 with
        | US20_0 -> (* Blank *)
            let v2 : string = ""
    ...
    let v26 : leptos_View = Fable.Core.RustInterop.emitRustExpr v24 v25 
    v26
and closure565 (v0 : leptos_ReadSignal<US20>) () : leptos_Fragment =
    let v1 : US21 = US21_0
    ...
    let v9 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v10 : (US20 -> leptos_View) = closure566(v0)
...
and method382 (v0 : leptos_ReadSignal<US20>) : (unit -> leptos_Fragment) =
    closure565(v0)
and closure563 (v0 : leptos_ReadSignal<US20>) () : leptos_Fragment =
...
and method380 (v0 : leptos_ReadSignal<US20>) : (unit -> leptos_Fragment) =
    closure563(v0)
and closure573 () () : string =
    let v0 : string = "h-5 w-5"
    v0
and closure575 () () : leptos_Fragment =
    let v0 : (leptos_View []) = [||]
    let v1 : string = "$0.to_vec()"
    let v2 : Vec<leptos_View> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "leptos::Fragment::new($0)"
...
and method389 () : (unit -> leptos_Fragment) =
    closure575()
and closure574 () () : leptos_Fragment =
    let v0 : string = "x=\"3\""
    let v1 : string = "y=\"3\""
...
and method388 () : (unit -> leptos_Fragment) =
    closure574()
and closure576 () () : leptos_Fragment =
    let v0 : string = "stroke-linecap=\"round\""
    let v1 : string = "stroke-linejoin=\"round\""
...
and method390 () : (unit -> leptos_Fragment) =
    closure576()
and closure577 () () : leptos_Fragment =
    let v0 : string = "stroke-linecap=\"round\""
    let v1 : string = "stroke-linejoin=\"round\""
...
and method391 () : (unit -> leptos_Fragment) =
    closure577()
and closure578 (v0 : leptos_Memo<string>, v1 : string) () : std_string_String =
    let v2 : string = $"$0()"
    let v3 : string = Fable.Core.RustInterop.emitRustExpr v0 v2 
    let v4 : string = v3 + "#/" + v1 + ""
    let v5 : string = "&*$0"
    ...
    let v8 : std_string_String = Fable.Core.RustInterop.emitRustExpr v6 v7 
    v8
and closure579 (v0 : leptos_ReadSignal<US20>, v1 : US20) () : bool =
    let v2 : string = $"leptos::SignalGet::get(&$0)"
    let v3 : US20 = Fable.Core.RustInterop.emitRustExpr v0 v2 
    match v3, v1 with
    | US20_0, US20_0 -> (* Blank *)
    ...
    | _ ->
        false
and closure580 (v0 : leptos_ReadSignal<US20>, v1 : US20) () : Ref<Lifetime<StaticLifetime, Str>> =
    let v2 : string = $"leptos::SignalGet::get(&$0)"
    let v3 : US20 = Fable.Core.RustInterop.emitRustExpr v0 v2 
    let v7 : bool =
        match v3, v1 with
    ...
    if v7 then
        ...
        v13
and closure581 (v0 : leptos_Fragment, v1 : string) () : leptos_Fragment =
...
and method392 (v0 : leptos_Fragment, v1 : string) : (unit -> leptos_Fragment) =
    closure581(v0, v1)
and closure572 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) (v2 : US20) : leptos_View =
    let v13 : string =
        match v2 with
        | US20_0 -> (* Blank *)
            let v3 : string = ""
    ...
    let v151 : leptos_Fragment =
        ...
        | US20_1(v14) -> (* Dice *)
            let v15 : string = "$0"
            let v16 : (unit -> string) = closure573()
            let v17 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v16 v15 
        ...
        | US20_2 -> (* Lists *)
            let v46 : string = "$0"
            let v47 : (unit -> string) = closure573()
            let v48 : (unit -> string) = Fable.Core.RustInterop.emitRustExpr v47 v46 
            let v49 : string = "xmlns=\"http://www.w3.org/2000/svg\""
            let v50 : string = "fill=\"none\""
        ...
        | US20_4 -> (* Settings *)
            let v112 : string = "$0"
            let v113 : (unit -> string) = closure573()
        ...
        | US20_3 -> (* Transactions *)
            let v79 : string = "$0"
            let v80 : (unit -> string) = closure573()
    ...
    let v162 : string =
        ...
        | US20_3 -> (* Transactions *)
            ...
            v156
    let v163 : (unit -> std_string_String) = closure578(v1, v13)
    let v164 : string = "let v163 = $0"
    Fable.Core.RustInterop.emitRustExpr v163 v164 
    let v165 : string = "$0"
    let v166 : (unit -> bool) = closure579(v0, v2)
    let v167 : (unit -> bool) = Fable.Core.RustInterop.emitRustExpr v166 v165 
    let v168 : string = "$0"
    let v169 : (unit -> Ref<Lifetime<StaticLifetime, Str>>) = closure580(v0, v2)
    ...
    v187
and closure571 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) () : leptos_Fragment =
    let v2 : US21 = US21_0
    ...
    let v10 : string = "$0.into_iter().map(|x| $1(x.clone())).collect::<Vec<_>>()"
    let v11 : (US20 -> leptos_View) = closure572(v0, v1)
...
and method387 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) : (unit -> leptos_Fragment) =
    closure571(v0, v1)
and closure570 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) () : leptos_Fragment =
...
and method386 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) : (unit -> leptos_Fragment) =
    closure570(v0, v1)
and closure569 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) () : leptos_Fragment =
...
and method385 (v0 : leptos_ReadSignal<US20>, v1 : leptos_Memo<string>) : (unit -> leptos_Fragment) =
    closure569(v0, v1)
and closure562 (v0 : leptos_ReadSignal<US20>) () : leptos_Fragment =
    ...
    let v35 : (leptos_HtmlElement<leptos_html_Div> -> leptos_View) = closure259()
...
and method379 (v0 : leptos_ReadSignal<US20>) : (unit -> leptos_Fragment) =
    closure562(v0)
and closure62 (v0 : leptos_ReadSignal<US20>) () : leptos_Fragment =
...
and method49 (v0 : leptos_ReadSignal<US20>) : (unit -> leptos_Fragment) =
    closure62(v0)
and closure61 (v0 : leptos_ReadSignal<US20>) () : leptos_Fragment =
...
and closure6 () (v0 : int32) : leptos_HtmlElement<leptos_html_Div> =
    ...
    let v16 : string = "$0"
    let v17 : (unit -> unit) = closure28(v7, v15)
    let v18 : (unit -> unit) = Fable.Core.RustInterop.emitRustExpr v17 v16 
    let v19 : string = "true; leptos::create_effect(move |_| { v18(()) })"
    let v20 : bool = Fable.Core.RustInterop.emitRustExpr () v19 
    let v21 : string = "$0"
    let v22 : (unit -> std_collections_HashMap<std_string_String, leptos_RwSignal<bool>>) = closure46(v7)
    ...
    let v30 : (Heap3 -> std_pin_Pin<Box<Dyn<std_future_Future<unit>>>>) = closure47(v11)
...
and method393 () : string =
    let v0 : string = ""
    v0
and closure582 (v0 : (int32 -> leptos_HtmlElement<leptos_html_Div>)) () : leptos_Fragment =
...
and method394 (v0 : (int32 -> leptos_HtmlElement<leptos_html_Div>)) : (unit -> leptos_Fragment) =
    closure582(v0)
and closure583 () () : leptos_Fragment =
    let v0 : (leptos_View []) = [||]
    let v1 : string = "$0.to_vec()"
    let v2 : Vec<leptos_View> = Fable.Core.RustInterop.emitRustExpr v0 v1 
    let v3 : string = "leptos::Fragment::new($0)"
...
and method396 () : string =
    let v0 : string = "/"
    v0
and closure584 (v0 : (int32 -> leptos_HtmlElement<leptos_html_Div>)) () : leptos_Fragment =
...
and method398 () : string =
    let v0 : string = "/*"
    v0
and closure585 (v0 : (int32 -> leptos_HtmlElement<leptos_html_Div>)) () : leptos_Fragment =
...
and method400 () : string =
    let v0 : string = "*"
    v0
and closure586 (v0 : (int32 -> leptos_HtmlElement<leptos_html_Div>)) () : leptos_Fragment =
