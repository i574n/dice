...
mod module_eef1bd43 {
    pub mod Dice_ui {
            ...
            let v62: Array<leptos::View> = Dice_ui::method140(Dice_ui::method139(new_array(&[
                ...
                if v25() == 1_i32 {
                    ...
                    let on_click = v35;
                    {
                        ...
                        let v40: leptos::HtmlElement<leptos::svg::Svg> = leptos::view! { <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5"><path stroke-linecap="round" stroke-linejoin="round" d="M6 6l12 12m0-12L6 18" /></svg> };
                        ...
                        let v56: leptos::HtmlElement<leptos::html::Button> = Dice_ui::method145(
                            leptos::view! { <button  aria-label="Delete" on:click=move |_| on_click() class={move || "inline-flex shrink-0 items-center [justify-content:center] pb-[8px] pt-[9px] pr-[11px] pl-[11px]".to_owned() + v43()}>{v50()}</button> },
                        );
        ...
        pub fn closure116(unitVar: (), v0_1: std::string::String) -> Dice_ui::US21 {
            Dice_ui::US21::US21_1(v0_1)
        }
        pub fn closure117(unitVar: (), v0_1: std::string::String) -> Dice_ui::US21 {
        ...
        pub fn closure54(unitVar: (), unitVar_1: ()) -> leptos::Fragment {
            ...
            leptos::logging::log!("{}", v1);
            {
                ...
                let on_click = v20;
                {
                    ...
                    let v25: leptos::HtmlElement<leptos::svg::Svg> = leptos::view! { <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6"/></svg> };
                    ...
                    let v42: leptos::HtmlElement<leptos::html::Button> = Dice_ui::method145(
                        leptos::view! { <button  aria-label="Add" on:click=move |_| on_click() class={move || "inline-flex shrink-0 items-center [justify-content:center] pb-[8px] pt-[9px] pr-[11px] pl-[11px]".to_owned() + v28()}>{v36()}</button> },
                    );
        ...
        pub fn closure123(unitVar: (), v0_1: string) -> Dice_ui::US22 {
        ...
        pub fn closure128(unitVar: (), v0_1: Dice_ui::US24) -> Dice_ui::US25 {
        ...
        pub fn closure131(unitVar: (), v0_1: Option<LrcPtr<Dice_ui::Heap4>>) -> Dice_ui::US26 {
            Dice_ui::US26::US26_1(v0_1)
        }
        pub fn closure132(unitVar: (), v0_1: LrcPtr<Dice_ui::Heap4>) -> Dice_ui::US24 {
        ...
        pub fn closure135(unitVar: (), v0_1: Result<Option<string>, string>) -> Dice_ui::US28 {
            Dice_ui::US28::US28_1(v0_1)
        }
        pub fn closure136(unitVar: (), v0_1: Option<string>) -> Dice_ui::US23 {
            Dice_ui::US23::US23_1(v0_1)
        }
        pub fn closure137(unitVar: (), v0_1: string) -> Dice_ui::US23 {
        ...
        pub fn closure147(unitVar: (), v0_1: std::string::String) -> Dice_ui::US33 {
        ...
        pub fn closure179(unitVar: (), v0_1: chrono::DateTime<chrono::Utc>) -> Dice_ui::US38 {
