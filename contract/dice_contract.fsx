...
let rec closure0 () () : unit =
    ...
    let v142 : string = "                let lines : String = acc_ref.clone().drain(..acc_ref.len() - 1).collect(); //"
    Fable.Core.RustInterop.emitRustExpr () v142 
    let v143 : string = "                near_sdk::log!(\"{}\", lines); //"
    Fable.Core.RustInterop.emitRustExpr () v143 
    let v144 : string = "                *acc_ref = String::new(); //"
    Fable.Core.RustInterop.emitRustExpr () v144 
    let v145 : string = "            } //"
    Fable.Core.RustInterop.emitRustExpr () v145 
    let v146 : string = "            acc_ref.push_str(&(s.to_string() + \"
\")); //"
    ...
    let v158 : string = "pub fn generate_random_number(&mut self, key: String, proof: String, max: u64) -> u64 { //"
    Fable.Core.RustInterop.emitRustExpr () v158 
    let v159 : string = $"&self.0.1"
    let v160 : Ref<near_sdk_store_vec_Vector<uint8>> = Fable.Core.RustInterop.emitRustExpr () v159 
    let v161 : string = $"v160.iter().map(|x| *x).collect::<Vec<u8>>()"
    let v162 : Vec<uint8> = Fable.Core.RustInterop.emitRustExpr () v161 
    let v163 : string = "    let seed = near_sdk::env::random_seed(); //"
    Fable.Core.RustInterop.emitRustExpr () v163 
    let v164 : string = "    let block_timestamp = near_sdk::env::block_timestamp(); //"
    Fable.Core.RustInterop.emitRustExpr () v164 
    let v165 : string = "    let signer_account_id = near_sdk::env::signer_account_id(); //"
    Fable.Core.RustInterop.emitRustExpr () v165 
    let v166 : string = "    let account_balance = near_sdk::env::account_balance(); //"
    Fable.Core.RustInterop.emitRustExpr () v166 
    let v167 : string = "    let block_height = near_sdk::env::block_height(); //"
    Fable.Core.RustInterop.emitRustExpr () v167 
    let v168 : string = "    let epoch_height = near_sdk::env::epoch_height(); //"
    Fable.Core.RustInterop.emitRustExpr () v168 
    let v169 : string = "    let entropy: Vec<u8> = vec![ //"
    Fable.Core.RustInterop.emitRustExpr () v169 
    let v170 : string = "        seed.clone(), //"
    Fable.Core.RustInterop.emitRustExpr () v170 
    let v171 : string = "        v162.clone(), //"
    Fable.Core.RustInterop.emitRustExpr () v171 
    let v172 : string = "        epoch_height.to_le_bytes().to_vec(), //"
    Fable.Core.RustInterop.emitRustExpr () v172 
    let v173 : string = "        block_height.to_le_bytes().to_vec(), //"
    Fable.Core.RustInterop.emitRustExpr () v173 
    let v174 : string = "        block_timestamp.to_le_bytes().to_vec(), //"
    Fable.Core.RustInterop.emitRustExpr () v174 
    let v175 : string = "        account_balance.as_yoctonear().to_le_bytes().to_vec(), //"
    Fable.Core.RustInterop.emitRustExpr () v175 
    let v176 : string = "        signer_account_id.as_bytes().to_vec(), //"
    Fable.Core.RustInterop.emitRustExpr () v176 
    let v177 : string = "        proof.clone().into_bytes(), //"
    Fable.Core.RustInterop.emitRustExpr () v177 
    let v178 : string = "        key.clone().into_bytes(), //"
    Fable.Core.RustInterop.emitRustExpr () v178 
    let v179 : string = "    ].concat(); //"
    Fable.Core.RustInterop.emitRustExpr () v179 
    let v180 : string = "    let entropy_len = entropy.len(); //"
    Fable.Core.RustInterop.emitRustExpr () v180 
    let v181 : string = "    let hash_u8 = near_sdk::env::keccak512(&entropy); //"
    Fable.Core.RustInterop.emitRustExpr () v181 
    let v182 : string = "    self.contribute_seed(hash_u8.clone()); //"
    Fable.Core.RustInterop.emitRustExpr () v182 
    let v183 : string = "    let hash_stream = Util::vec_u8_to_stream(hash_u8.clone()); //"
    Fable.Core.RustInterop.emitRustExpr () v183 
    let v184 : string = "    let rolls_list = Util::stream_u8_to_list(dice_contract_lib::Dice::rotate_numbers(6)( //"
    Fable.Core.RustInterop.emitRustExpr () v184 
    let v185 : string = "        hash_stream.into(), //"
    Fable.Core.RustInterop.emitRustExpr () v185 
    let v186 : string = "    )); //"
    Fable.Core.RustInterop.emitRustExpr () v186 
    let v187 : string = "    { //"
    Fable.Core.RustInterop.emitRustExpr () v187 
    let v188 : string = "        let rolls_list_log = Util::list_u8_to_vec(rolls_list.clone().into()); //"
    Fable.Core.RustInterop.emitRustExpr () v188 
    let v189 : string = "        let signer_account_id_log = signer_account_id.as_str(); //"
    Fable.Core.RustInterop.emitRustExpr () v189 
    let v190 : string = "        near_sdk::log!( //"
    ...
    let v194 : string = "    let logger = Self::get_logger(); //"
    Fable.Core.RustInterop.emitRustExpr () v194 
    let v195 : string = "    let sequential_roll = dice_contract_lib::Dice::create_sequential_roller(Some( //"
    Fable.Core.RustInterop.emitRustExpr () v195 
    let v196 : string = "        logger.clone(), //"
    Fable.Core.RustInterop.emitRustExpr () v196 
    let v197 : string = "    ))(rolls_list.into()); //"
    Fable.Core.RustInterop.emitRustExpr () v197 
    let v198 : string = "    let result = dice_contract_lib::Dice::roll_progressively(Some(logger.clone()))( //"
    Fable.Core.RustInterop.emitRustExpr () v198 
    let v199 : string = "        sequential_roll, //"
    Fable.Core.RustInterop.emitRustExpr () v199 
    let v200 : string = "    )(true)(max); //"
    Fable.Core.RustInterop.emitRustExpr () v200 
    let v201 : string = "    logger(\"\".into()); //"
    Fable.Core.RustInterop.emitRustExpr () v201 
    let v202 : string = "    result as u64 //"
