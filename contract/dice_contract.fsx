...
and method27 (v0 : uint64, v1 : std_string_String, v2 : std_string_String, v3 : uint64, v4 : uint64, v5 : uint64, v6 : string, v7 : std_string_String, v8 : std_string_String, v9 : string, v10 : string, v11 : unativeint, v12 : string, v13 : string, v14 : string) : string =
...
#if !FABLE_COMPILER_RUST && !FABLE_COMPILER_TYPESCRIPT && !FABLE_COMPILER_PYTHON
    let v97 : string = $"%A{v1}"
    let _run_target_args'_v78 = v97 
    #endif
#else
    let v100 : string = $"%A{v1}"
    let _run_target_args'_v78 = v100 
    #endif
    let v103 : string = _run_target_args'_v78 
    ...
    let _run_target_args'_v141 = v160 
    #endif
#else
    let v163 : string = $"%A{v2}"
    let _run_target_args'_v141 = v163 
    #endif
    let v166 : string = _run_target_args'_v141 
    ...
    let _run_target_args'_v336 = v349 
    #endif
#if FABLE_COMPILER_PYTHON
    ...
    let _run_target_args'_v336 = v358 
    #endif
    let v361 : string = _run_target_args'_v336 
    ...
    let _run_target_args'_v399 = v412 
    #endif
#if FABLE_COMPILER_PYTHON
    ...
    let _run_target_args'_v399 = v418 
    #endif
#else
    let v421 : string = $"%A{v8}"
    let _run_target_args'_v399 = v421 
    #endif
    let v424 : string = _run_target_args'_v399 
    ...
    let _run_target_args'_v528 = v547 
    #endif
#else
    let v550 : string = $"%A{v11}"
    let _run_target_args'_v528 = v550 
    #endif
    let v553 : string = _run_target_args'_v528 
...
and closure0 () () : unit =
    ...
    let v365 : string = "fable_library_rust::NativeArray_::array_from($0.clone())"
    ...
    let v556 : string = "fable_library_rust::NativeArray_::array_from($0.clone())"
