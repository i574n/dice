...
if (!$fast -and !$SkipNotebook) {
    { . apps/spiral/dist/Supervisor$(_exe) --execute-command "workspace/target/release/spiral_builder$(_exe) dib --path ../dice/contract/$projectName.dib --retries $($fast -or !$env:CI ? 1 : 3)" } | Invoke-Block -Location ../../polyglot
}
