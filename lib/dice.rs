...
mod module_a51efde0 {
    pub mod Dice {
        ...
        pub fn closure4(
            v0_1: LrcPtr<MutCell<Option<Dice::US0>>>,
            v1_1: Option<Dice::US0>,
        ) -> LrcPtr<MutCell<Option<Dice::US0>>> {
            v0_1.set(v1_1);
            v0_1
        }
        pub fn closure5(
            v0_1: Option<Func1<string, ()>>,
            v1_1: Func1<Option<Dice::US0>, LrcPtr<MutCell<Option<Dice::US0>>>>,
            unitVar: (),
        ) {
            {
                let value: LrcPtr<MutCell<Option<Dice::US0>>> = v1_1(match &v0_1 {
                    None => None::<Dice::US0>,
                    Some(v0_1_0_0) => {
            ...
            match v0_1.as_ref() {
                ...
                Dice::UH1::UH1_1(v0_1_1_0, v0_1_1_1) => {
                    ...
                    LrcPtr::new(Dice::UH0::UH0_0(
                        ...
                        Func0::new({
                            let v4_1 = v4_1.clone();
                            move || Dice::closure7(v4_1.clone(), ())
                        }),
                    ))
                }
            }
        }
        pub fn closure8(v0_1: LrcPtr<Dice::UH0>, unitVar: ()) -> LrcPtr<Dice::UH0> {
            v0_1
        }
        pub fn closure9(
        ...
        pub fn method4(
            ...
            Func0::new({
                let v0_1 = v0_1.clone();
                let v3_1 = v3_1.clone();
                move || Dice::closure9(v0_1.clone(), v3_1.clone(), ())
            })
        }
        ...
        pub fn closure6(v0_1: Dice::US0, v1_1: LrcPtr<Dice::UH1>) -> Func0<u8> {
            match &v0_1 {
        ...
        pub fn closure3(
            ...
            let v6: () = {
                Dice::closure5(
                    ...
                    Func1::new({
                        let _v1 = _v1.clone();
                        move |v: Option<Dice::US0>| Dice::closure4(_v1.clone(), v)
                    }),
                    (),
                );
                ()
        ...
        pub fn closure14(v0_1: Dice::US0, v1_1: Func0<u8>, v2_1: bool, v3_1: u64) -> u64 {
            Dice::method8(
                v0_1.clone(),
                v1_1,
                v2_1,
        ...
        pub fn closure13(v0_1: Dice::US0, v1_1: Func0<u8>, v2_1: bool) -> Func1<u64, u64> {
            Func1::new({
                let v0_1 = v0_1.clone();
                let v1_1 = v1_1.clone();
                let v2_1 = v2_1.clone();
                move |v: u64| Dice::closure14(v0_1.clone(), v1_1.clone(), v2_1, v)
            })
        }
        pub fn closure12(v0_1: Dice::US0, v1_1: Func0<u8>) -> Func1<bool, Func1<u64, u64>> {
            Func1::new({
                let v0_1 = v0_1.clone();
                let v1_1 = v1_1.clone();
                move |v: bool| Dice::closure13(v0_1.clone(), v1_1.clone(), v)
            })
        }
        pub fn closure11(
            unitVar: (),
        ...
        pub fn closure81(
            ...
            let v8: () = {
                Dice::closure5(
                    ...
                    Func1::new({
                        let _v3 = _v3.clone();
                        move |v: Option<Dice::US0>| Dice::closure4(_v3.clone(), v)
                    }),
                    (),
                );
                ()
        ...
        pub fn closure80(
            ...
            Func1::new({
                let v0_1 = v0_1.clone();
                let v1_1 = v1_1.clone();
                move |v: LrcPtr<Dice::UH1>| Dice::closure81(v0_1.clone(), v1_1, v)
            })
        }
        pub fn closure79(
            unitVar: (),
            ...
            Func1::new({
                let v0_1 = v0_1.clone();
                move |v: u64| Dice::closure80(v0_1.clone(), v)
            })
        }
            ...
            match v0_1.as_ref() {
                ...
                Dice::UH1::UH1_1(v0_1_1_0, v0_1_1_1) => {
                    ...
                    if v3_1 > 1_u8 {
                        ...
                        let v11: () = {
                            Dice::closure83(sprintf!("accumulate_dice_rolls / power: {} / acc: {} / roll: {} / value: {}",
                                                         0_i8, v1_1, v3_1,
                                                         v7), ());
                            ()
                        };
        ...
        pub fn closure82(unitVar: (), v0_1: Array<string>) -> i32 {
            let v4_1: () = {
                Dice::closure83(
                    sprintf!(
                        "calculate_dice_count / max: {} / n: {} / p: {}",
        ...
        ) -> Func1<Option<Func1<string, ()>>, Func1<Func0<u8>, Func1<bool, Func1<u64, u64>>>>
        {
            ...
            > = OnceInit::new();
            v2.get_or_init(|| {
                Func1::new(move |v: Option<Func1<string, ()>>| Dice::closure11((), v))
            })
            .clone()
        }
        ...
        ) -> Func1<Option<Func1<string, ()>>, Func1<u64, Func1<LrcPtr<Dice::UH1>, Option<u64>>>>
        {
            ...
            > = OnceInit::new();
            v3.get_or_init(|| {
                Func1::new(move |v: Option<Func1<string, ()>>| Dice::closure79((), v))
            })
            .clone()
        }
        ...
        pub fn v4() -> Func1<Array<string>, i32> {
            ...
            v4.get_or_init(|| Func1::new(move |v: Array<string>| Dice::closure82((), v)))
                .clone()
        }
