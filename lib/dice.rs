...
mod module_1d76f080 {
    pub mod Dice {
        ...
        pub fn method9(v0_1: string) -> string {
            let v2_1: string = Dice::method10(v0_1);
            let v4_1: Result<std::string::String, std::env::VarError> = std::env::var(&*v2_1);
            let v6: bool = true;
            let _result_map_ = v4_1.map(|x| {
                //;
        ...
        pub fn method13(
            ...
            let v20: Dice::US4 = defaultValue(Dice::US4::US4_1, map(Dice::method14(), v5));
