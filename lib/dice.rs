            ...
            '_method14: loop {
                break '_method14 (if v1_1.get().clone() < 24_i8 {
                    ...
                    if let Dice::US5::US5_0(v18_0_0, v18_0_1) = &v18 {
                                        ...
                                        }
                                        {
                                            ...
                                            }
                                            {
                                                ...
                                                let _v77: MutCell<Option<u8>> =
                                                    MutCell::new(None::<u8>);
                                                {
                                                    let x_12: u8 = rand::Rng::gen_range(
                                                        &mut rand::thread_rng(),
                                                        1..7,
                                                    );
                                                    _v77.set(Some(x_12))
                                                }
                                                {
                                                    ...
                                                    let _v88: MutCell<Option<u8>> =
                                                        MutCell::new(None::<u8>);
                                                    {
                                                        let x_14: u8 = rand::Rng::gen_range(
                                                            &mut rand::thread_rng(),
                                                            1..7,
                                                        );
                                                        _v88.set(Some(x_14))
                                                    }
                                                    {
                                                        ...
                                                        let _v99: MutCell<Option<u8>> =
                                                            MutCell::new(None::<u8>);
                                                        {
                                                            let x_16: u8 = rand::Rng::gen_range(
                                                                &mut rand::thread_rng(),
                                                                1..7,
                                                            );
                                                            _v99.set(Some(x_16))
                                                        }
                                                        {
                                                            ...
                                                            let _v110: MutCell<Option<u8>> =
                                                                MutCell::new(None::<u8>);
                                                            {
                                                                let x_18: u8 = rand::Rng::gen_range(
                                                                    &mut rand::thread_rng(),
                                                                    1..7,
                                                                );
                                                                _v110.set(Some(x_18))
                        ...
                        {
                            let x_48: u8 = rand::Rng::gen_range(&mut rand::thread_rng(), 1..7);
                            _v302.set(Some(x_48))
                        }
                        {
                            ...
                            {
                                let x_50: u8 = rand::Rng::gen_range(&mut rand::thread_rng(), 1..7);
                                _v313.set(Some(x_50))
                            }
                            {
                                    ...
                                    }
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            let _v357: MutCell<Option<u8>> =
                                                MutCell::new(None::<u8>);
                                            {
                                                let x_58: u8 = rand::Rng::gen_range(
                                                    &mut rand::thread_rng(),
                                                    1..7,
                                                );
                                                _v357.set(Some(x_58))
                                            }
                                            {
                                                ...
                                                let _v368: MutCell<Option<u8>> =
                                                    MutCell::new(None::<u8>);
                                                {
                                                    let x_60: u8 = rand::Rng::gen_range(
                                                        &mut rand::thread_rng(),
                                                        1..7,
                                                    );
                                                    _v368.set(Some(x_60))
                                                }
                                                {
                                                    ...
                                                    let _v379: MutCell<Option<u8>> =
                                                        MutCell::new(None::<u8>);
                                                    {
                                                        let x_62: u8 = rand::Rng::gen_range(
                                                            &mut rand::thread_rng(),
                                                            1..7,
                                                        );
                                                        _v379.set(Some(x_62))
                                                    }
                                                    {
                                                        ...
                                                        let _v390: MutCell<Option<u8>> =
                                                            MutCell::new(None::<u8>);
                                                        {
                                                            let x_64: u8 = rand::Rng::gen_range(
                                                                &mut rand::thread_rng(),
                                                                1..7,
                                                            );
                                                            _v390.set(Some(x_64))
                                                        }
                                                        {
                                                            ...
                                                            let _v401: MutCell<Option<u8>> =
                                                                MutCell::new(None::<u8>);
                                                            {
                                                                let x_66: u8 = rand::Rng::gen_range(
                                                                    &mut rand::thread_rng(),
                                                                    1..7,
                                                                );
                                                                _v401.set(Some(x_66))
