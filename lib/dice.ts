...
export function method14(v0_1_mut: UH1_$union, v1_1_mut: int8): int64 {
    ...
    while (true) {
        ...
        if (v1_1 < 24) {
            ...
            const v15: US5_$union = method15(v0_1, 0n);
            if (v15.tag === /* US5_1 */ 1) {
                const v17: UH1_$union = v15.fields[1];
                const v16: int64 = v15.fields[0];
                if (compare(v16, 9223372036854775807n) <= 0) {
                    return v16;
                }
                else {
