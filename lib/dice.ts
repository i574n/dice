...
export function method15(v0_1_mut: UH1_$union, v1_1_mut: int8): int64 {
    ...
    while (true) {
        ...
        if (v1_1 < 24) {
            ...
            const v17: US5_$union = method16(v0_1, 0n);
            if (v17.tag === /* US5_0 */ 0) {
