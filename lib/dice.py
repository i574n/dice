...
def closure0(unit_var: None, v0_1: int64) -> Callable[[UH0], UH0]:
    def _arrow443(v: UH0, unit_var: Any=unit_var, v0_1: Any=v0_1) -> UH0:
...
def method4(v0_1: UH0, v1_1: Callable[[], UH0]) -> Callable[[], UH0]:
    ...
    def _arrow444(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> UH0:
...
def method8(__unit: None=None) -> tuple[US3, US4]:
    ...
    def _arrow446(__unit: None=None) -> US3:
    ...
    return (US3(0, v6.fields[0]) if (v6.tag == 0) else _arrow446(), US4(1) if (method9("AUTOMATION") != "True") else US4(0, from_value(ticks_1(now()), False)))
...
def method6(v0_1: US2) -> bool:
    ...
    if pattern_input[2].l0 == False:
        ...
        return find(v0_1, of_seq(to_enumerable([(US2(0), 0), (US2(1), 1), (US2(2), 2), (US2(3), 3), (US2(4), 4)]), ObjectExpr447())) >= find(v35, of_seq(to_enumerable([(US2(0), 0), (US2(1), 1), (US2(2), 2), (US2(3), 3), (US2(4), 4)]), ObjectExpr448()))
...
def closure3(unit_var: None, v0_1: UH1) -> Callable[[], uint8]:
    ...
    v12: Mut2 = Mut2(US1(1))
    def _arrow450(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> uint8:
...
def closure19(v0_1: Callable[[], uint8], v1_1: bool) -> Callable[[uint64], uint64]:
    def _arrow451(v: uint64, v0_1: Any=v0_1, v1_1: Any=v1_1) -> uint64:
...
def closure18(unit_var: None, v0_1: Callable[[], uint8]) -> Callable[[bool, uint64], uint64]:
    def _arrow452(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[uint64], uint64]:
...
def closure89(unit_var: None, v0_1: uint64) -> Callable[[UH1], uint64 | None]:
    def _arrow453(v: UH1, unit_var: Any=unit_var, v0_1: Any=v0_1) -> uint64 | None:
...
def _arrow454(v: int64) -> Callable[[UH0], UH0]:
    return closure0(None, v)


v0: Callable[[int64, UH0], UH0] = _arrow454

def rotate_numbers(x: int64) -> Callable[[UH0], UH0]:
    return v0(x)


def _arrow455(v: UH1) -> Callable[[], uint8]:
    return closure3(None, v)


v1: Callable[[UH1, None], uint8] = _arrow455

def create_sequential_roller(x: UH1) -> Callable[[], uint8]:
    return v1(x)


def _arrow456(v: Callable[[], uint8]) -> Callable[[bool, uint64], uint64]:
    return closure18(None, v)


v2: Callable[[Callable[[], uint8], bool, uint64], uint64] = _arrow456

def roll_progressively(x: Callable[[], uint8]) -> Callable[[bool, uint64], uint64]:
    return v2(x)


def _arrow457(v: uint64) -> Callable[[UH1], uint64 | None]:
    return closure89(None, v)


v3: Callable[[uint64, UH1], uint64 | None] = _arrow457

def roll_within_bounds(x: uint64) -> Callable[[UH1], uint64 | None]:
    return v3(x)


def _arrow458(v: Array[str]) -> int:
    return closure91(None, v)


v4: Callable[[Array[str]], int] = _arrow458
